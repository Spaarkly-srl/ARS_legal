...
*  **ARShades Virtual Try-On** (“ARShades VTO”, “VTO”, “Web VTO”, “VTO App”, “Applications and Services”);
*  **ARShades VTO Explorer** (“VTO Explorer”), as a module or feature that can be integrated into ARShades web, mobile, catalogue, e-commerce, mirror, showroom or in-store experiences;
*  **AR PD Meter**;
*  **ARShades Mirror** (“Mirror”);
*  **ARShades Gateway** (“Gateway”, “Standalone Application”);
*  **ARShades Campaign Catalogue** (“Campaign Catalogue”), as a public web-based product catalogue integrating ARShades experiences.
...
*  **Personal Data**: any information relating to an identifiable natural person, including IP address, email and other data voluntarily provided by the User.
*  **Session Data**: information collected during a user session, such as interaction timestamps, pages viewed and usage statistics. It is retained for up to **14 months** before anonymisation.
*  **Device Data**: technical information about the User’s device, including **device type, operating system, browser version and preferred language**. It is used for service optimisation and security.
*  **Geolocation Data**: subject to the User’s consent, ARShades may collect the approximate location based on **IP address** or, in standalone applications, the **precise GPS location**, in order to provide location-based services. Users may disable this feature at any time.
*  **Data Controller**: Spaarkly s.r.l., which determines the purposes and means of the processing of personal data.
*  **Processing**: any operation carried out on personal data, including **collection, storage, anonymisation and erasure**.
*  **Cookies and tracking technologies**: essential cookies necessary for the functioning of the service and optional analytics tools, where enabled by the User. No marketing cookies are used.
*  **Data Subject Rights**: Users may **access, rectify, erase or restrict** the processing of their data as provided under the GDPR, the CCPA and similar laws. Requests may be sent to **privacy@spaarkly.com**.
*  **International data transfers**: where personal data is transferred outside the **European Economic Area (EEA)**, Spaarkly ensures compliance through **Standard Contractual Clauses (SCCs)** or equivalent safeguards.
*  **ARShades VTO**: a **virtual try-on (VTO)** solution that allows users to see how eyewear fits their face in **real-time augmented reality (AR)**. It works on **web and mobile devices** without storing biometric data.
*  **ARShades VTO Explorer**: a photographic virtual try-on and augmented-catalogue module that allows Users to generate realistic, personalised previews of multiple eyewear products from a limited number of images captured during the session. VTO Explorer can be integrated into ARShades web, mobile, catalogue, mirror or other in-store experiences. The captured images are processed locally on the User’s device or on the device used for the experience and are not automatically uploaded to Spaarkly’s servers. Where VTO Explorer is used on a device installed in a point of sale, showroom, event venue or other public place, and the User chooses to obtain, download or share the final photos on their own device, only the final photos selected by the User may be temporarily uploaded to Spaarkly’s servers solely to make them available to the User, and are deleted as described in this Policy.
*  **AR PD Meter**: a **pupillary distance (PD)** measurement tool that estimates the distance between the User’s pupils by means of **AR and facial-landmark detection**. Camera images and video streams are not retained, are not used for biometric identification and are not used to create facial templates. To calculate the pupillary distance, AR PD Meter may temporarily transmit derived technical data—such as facial landmarks, face orientation, device technical information and the parameters required for the calculation—to the ARShades backend located in the European Union. Such data is used solely to return the measurement result and is discarded after processing. Where AR PD Meter is used within ARShades Mirror (for example, in support of the VTO Explorer experience in Mirror Showroom), such derived technical data is processed by the device’s local backend, without transmission to cloud servers, and deleted after processing.
*  **ARShades Mirror**: a retail virtual try-on experience available through **in-store digital mirrors and kiosks**, allowing users to browse virtual eyewear catalogues and try eyewear on in AR without requiring the storage of personal data.
*  **ARShades Gateway**: a **standalone** AR platform that provides, among other things, a **virtual try-on** experience. It may optionally **use geolocation, subject to consent**, to personalise recommendations.
*  **ARShades Campaign Catalogue**: a **public web-based** product catalogue, accessible through a dedicated URL, which showcases a brand’s eyewear products and allows Users to launch ARShades experiences such as VTO, 3D Viewer and VTO Explorer. The catalogue page does not write cookies, local storage or other identifiers to the User’s device; its use is measured in aggregated form as described in the section “Public catalogue usage-measurement data (Campaign Catalogue)”.
...
*  **Provision of the VTO Services**: enabling the User to virtually try on eyewear frames, test shapes and sizes and use tools such as pupillary-distance measurement (**legal basis: performance of a contract or of pre-contractual measures requested by the User, pursuant to Article 6(1)(b) GDPR**).
*  **Service improvement, analytics, security and fraud prevention**: improving the quality, usability, analytical understanding and security of our Services, generating anonymous statistics on the use and performance of ARShades experiences—including the aggregated measurement of the use of public Campaign Catalogue pages—preventing unlawful use and fraud and ensuring the integrity of networks and systems (**legal basis: legitimate interest, Article 6(1)(f) GDPR**).
*  **Compliance with legal obligations**: complying with legal obligations or with orders of competent authorities relating to data retention, security and other regulatory requirements (**legal basis: legal obligation, Article 6(1)(c) GDPR**).
*  **Consent, where applicable**: where consent is required—for example, for camera access or for any optional analytics tools, where available—the processing will be based on consent (Article 6(1)(a) GDPR), which may be withdrawn at any time without affecting the lawfulness of processing carried out before withdrawal.
...
*  **Provision of the VTO Services**: enabling the User to virtually try on eyewear frames, test shapes and sizes and use tools such as pupillary-distance measurement (legal basis: performance of a contract or of pre-contractual measures requested by the data subject, pursuant to Article 6(1)(b) GDPR).
*  **Service improvement, analytics, security and fraud prevention**: improving the quality, usability, analytical understanding and security of our Services, generating anonymous statistics on the use and performance of ARShades experiences, preventing unlawful use and fraud and ensuring the integrity of networks and systems (legal basis: legitimate interest, Article 6(1)(f) GDPR).
*  **Legal obligations**: complying with legal obligations or with orders of competent authorities relating to data retention, security and other regulatory requirements (legal basis: legal obligation, Article 6(1)(c) GDPR).
*  **Consent, where applicable**: where consent is required—for example, for camera access, for capturing the images necessary to use the VTO Explorer module, or for the temporary storage of the final photos selected by the User for download or sharing through features such as “Shoot & Share” or equivalent download functions—the processing will be based on consent (Article 6(1)(a) GDPR), which may be withdrawn at any time without affecting the lawfulness of processing carried out before withdrawal.
...
* operates on anonymous mathematical points common to all faces;
* does not use the measurements to identify specific persons, nor are the measurements, on their own, capable of identifying them;
* does not use or store data for facial-recognition purposes;
* processes the Virtual Try-On facial data locally on the User’s device, with no server-side storage;
* for AR PD Meter, temporarily uses derived technical data on the ARShades backend solely to calculate and return the PD result, discarding it after processing.
...
* operating system;
* preferred language;
* brands and products viewed;
* access dates and times;
* anonymous statistics on interactions with the VTO app, for example whether the User wears eyeglasses.
...
*  **Precise geolocation**: subject to explicit consent, specific standalone ARShades applications may collect precise geolocation coordinates from the device in order to provide location-based services or recommendations.
*  **Approximate location**: in the absence of explicit consent to precise location, we may infer an approximate location based on the IP address.

The collection of geolocation data in standalone applications is:

*  **optional**: location permissions may be refused without affecting the core VTO features;
*  **consent-based**: precise geolocation is collected only subject to explicit consent;
*  **purpose-limited**: used only to provide relevant eyewear recommendations or location-based services;
*  **subject to the same retention policy**: anonymised within 14 months together with the other technical data.

#### Managing geolocation consent
...
* remembered locally by the browser for future visits to the same application;
* set so as to ask each time;
* granted temporarily for the current session only.
...
* The images captured for virtual try-on, personalisation, catalogue generation, facial fitting, segmentation, product placement and rendering are processed locally on the device without automatic transfer to Spaarkly’s servers.
* In VTO Mirror versions that include the **VTO Explorer** module, such as **Mirror Showroom**, the images captured during the personalisation phase are used locally to generate augmented-catalogue previews and are not uploaded to Spaarkly’s servers.
* Only where the User actively chooses to obtain, download or share final photos depicting them wearing the selected eyewear from a device installed in a point of sale, showroom, event venue or other public place may such selected final photos be temporarily uploaded to Spaarkly’s servers solely to make them available to the User on their own device.
* The point-of-sale owner has no direct access to the data or images generated by Users, as access to the software is restricted exclusively to ARShades.
* ARShades undertakes not to access User data except where necessary for specific technical-maintenance activities, and always without viewing or processing the captured images.
* Spaarkly does not disclose User data to third parties for the latter’s own purposes. For hosting and service delivery, Spaarkly may rely on qualified cloud-infrastructure providers, with servers located in the European Union, appointed as data processors pursuant to Article 28 GDPR and bound by appropriate data-processing agreements. Processing activities are carried out exclusively by authorised Spaarkly personnel and by such providers, within the limits of the instructions given.

### Automatic deletion and security measures

* The final photos temporarily uploaded through **VTO Mirror**, **VTO Explorer**, “Shoot & Share” or equivalent download/sharing features from devices installed in points of sale, showrooms, event venues or other public places may be deleted immediately from our servers by Users after being downloaded to their own device, where this option is available. If Users do not manually delete their photos, our system automatically removes them after **24 hours** by means of a dedicated script, without manual intervention.
* Temporarily stored data is **encrypted at rest and in transit** to ensure its security.
* All access to ARShades devices for technical maintenance is recorded in an **access log** in accordance with **Article 5(1)(f) GDPR**.
* The software is configured to restrict access to the data exclusively to **authorised ARShades personnel**.

### Role of ARShades and of the point of sale

*  **ARShades remains the sole data controller** for the data generated through VTO Mirror.
* The **point of sale does not process User data**, as it has no access to the data generated or to the management of the software.

## 6\. DATA COLLECTION AND RETENTION PERIOD

* **Facial-measurement data** is collected locally on the User’s device for the Virtual Try-On and retained only for as long as necessary to provide the ARShades VTO services. For AR PD Meter, the derived technical data required to calculate the pupillary distance may be temporarily transmitted to the ARShades backend located in the EU, used solely to return the measurement result and discarded after processing.
* **Session and device data** is stored on Spaarkly’s servers, located within the EU. **IP addresses are deleted and fully dissociated from all other data within 14 months**. Only aggregated and anonymised data is retained for statistical analysis.
* **Public catalogue usage-measurement data (Campaign Catalogue)** is deleted after the daily statistical aggregation, as a rule within 48 hours of collection; thereafter, only aggregated and anonymous statistics are retained.
* The retention period for personal data may be extended in exceptional cases, for example to comply with legal obligations or for fraud-prevention purposes.

## 7\. COOKIE POLICY

ARShades uses only **strictly necessary cookies**, which are essential for the functioning of our services. Such cookies:

* enable **core website functionality**, such as session management and security;
*  **do not** track users across different websites;
*  **are not** used for analytics, marketing or third-party tracking.
...
|---|---|---|
|<b>visited</b>|90 days|Identifies whether the User has already used the service.|
|<b>consent</b>|120 minutes|Identifies whether the User has given consent to the Privacy Policy and the Terms and Conditions for the use of ARShades.|
|<b>lang</b>|90 days|Stores and remembers the User’s preferred language across browser sessions.|
...
*  **firewalls**;
*  **secure servers**;
*  **access-management systems** to prevent unauthorised access to systems and data.
...
*  **assess the level of risk** pursuant to **Article 33 GDPR**. We will assess any potential breach in accordance with Article 33 GDPR and will notify the competent **supervisory authority** within **72 hours** where required by applicable law;
*  **owing to the absence of personal contact data**, be **unable to notify individual users directly**. Where required, we will instead issue a **public notice** through our official website or other channels;
*  **mitigate and resolve** the incident as quickly as possible, implementing, where necessary, additional safeguards.
...
* To request confirmation as to whether or not their personal data is being processed.
* To obtain access to the relevant information, such as the purposes, the categories of data processed, the recipients or categories of recipients, the retention period, etc.
...
* To request the erasure of personal data where:
  * the data is no longer necessary in relation to the purposes for which it was collected;
  * consent is withdrawn, where the processing is based on consent;
  * the data has been processed unlawfully.

### Right to restriction of processing

* To request the restriction of processing where:
  * the accuracy of the data is contested;
  * the processing is unlawful but you oppose erasure;
  * the data is required for the establishment, exercise or defence of legal claims, even if the controller no longer needs it;
  * you have objected to the processing, pending verification of the legitimate grounds.

### Right to data portability

* To receive your personal data in a structured, commonly used and machine-readable format.
* To request its direct transmission to another controller, where technically feasible.
...
* view the current status of their consent;
...
* the Italian **Garante per la Protezione dei Dati Personali**: **[www.garanteprivacy.it](http://www.garanteprivacy.it)**;
* another **competent supervisory authority** in your country of residence.
...
*  **additional or different rights** compared with those described in the main Policy;
*  **the manner of exercising such rights**, including local contacts, procedures and response times;
*  **any additional consent requirements**;
*  **specific data-retention requirements**;
*  **local data-breach notification obligations**;
*  **data-transfer rules**, including standard contractual clauses and local requirements.
...
### Index of regional and national Addenda
 ...
 1. [European Union / European Economic Area / United Kingdom](#a-united-kingdom-uk-gdpr--european-union-and-european-economic-area-eu-eea)
 2. [Switzerland](#b-switzerland-fadp--federal-act-on-data-protection)
 3. [United States](#c-united-states--us-addendum)
 4. [Canada](#d-canada-pipeda--personal-information-protection-and-electronic-documents-act)
 5. [Australia and New Zealand](#e-australia-and-new-zealand)
 6. [Asia-Pacific Region](#f-asia-pacific-region)
 7. [Brazil and Latin America](#g-brazil-and-latin-america)
...
10. [South Africa](#j-south-africa-popia--protection-of-personal-information-act)
11. [India](#k-india-dpdp--digital-personal-data-protection-act)
12. [Middle East](#l-middle-east-united-arab-emirates--dubai--saudi-arabia--other-countries)
13. [Other Countries](#m-other-countries)
...
*  **EU/EEA users**: the **data-protection authority** of their respective Member State.
*  **UK users**: the **Information Commissioner’s Office (ICO)** ([https://ico.org.uk/](https://ico.org.uk/)).
...
*  **Standard Contractual Clauses (SCCs)** of the European Commission for transfers from the EU/EEA;
*  **ICO-approved SCCs** for transfers from the United Kingdom;
*  **additional safeguards where necessary**, in line with the guidance of the European Data Protection Board (EDPB) and the ICO.
...
*  **access** their personal data processed by Spaarkly;
*  **request the correction** or deletion of inaccurate or unnecessary data;
...
* the **data subjects**, where required by Swiss law.

### International data transfers

The personal data of Swiss users is **not transferred outside Switzerland**, unless:

* the destination country is deemed by the Swiss authorities to have an **adequate level of protection**;
* **Standard Contractual Clauses (SCCs)** approved by the European Commission are implemented for transfers to the EU/EEA;
* other **safeguards compliant with the Swiss FADP** are adopted to protect the transferred data.
...
*  **Texas**: **Capture or Use of Biometric Identifier Act (CUBI)** and **Texas Data Privacy and Security Act (TDPSA)**;
...
*  **know** which categories of personal data we collect;
*  **understand** the purposes of the processing;
*  **request the deletion** of their personal data, subject to the exceptions permitted by law;
*  **opt out of the sale or sharing** of their data, where applicable;
...
* **opt-out** rights with respect to targeted advertising or the sale of personal data, where applicable. Although ARShades does not carry out such activities, residents of Montana and Oregon may nonetheless request confirmation by contacting Spaarkly.

#### 3\. Illinois (BIPA), Texas (CUBI), Washington (RCW 19.375)

*  **Spaarkly does not collect biometric data** as defined by these laws.
* ARShades processes only **mathematical facial-landmark points** for virtual try-on purposes and, through AR PD Meter, for pupillary-distance calculation, which:
  *  **cannot be used to uniquely identify** a person;
  * for the Virtual Try-On, are **processed locally on the User’s device** and never stored;
  * for **AR PD Meter**, may be transmitted temporarily, as derived technical data not used to identify the User and not capable, on their own, of identifying the User, to the ARShades backend located in the European Union, used solely to return the measurement result and **discarded after processing**, without ever being stored;
  *  **do not create a persistent identifier** linked to an individual.

#### 4\. Other U.S. States

* Some States **do not yet have** general privacy laws.
* In such cases, **Spaarkly** follows the **general principles described in this Privacy Policy** and complies with any applicable state law.

### How to exercise rights

U.S. residents may contact us at **[privacy@spaarkly.com](mailto:privacy@spaarkly.com)**, specifying their State of residence.
...
#### Notice and consent specific to States with biometric legislation
...
* any facial-measurement data is processed in real time and is never retained beyond the immediate session;
* the derived technical data temporarily transmitted to the ARShades backend for AR PD Meter is used solely to return the measurement result and discarded after processing;
* session and device data is anonymised and dissociated within 14 months.
...
*  the **facial data** used for the Virtual Try-On is processed **locally on the device** and is not stored; for **AR PD Meter**, derived technical data, not used to identify the User and not capable, on their own, of identifying the User, may be transmitted temporarily to the ARShades backend located in the European Union, used solely to return the measurement result and discarded after processing;
*  **no biometric or uniquely identifying data is collected**, nor names, contact details or user profiles;
*  the **session and device data** (including the IP address) is stored on **servers located in the European Union** and anonymised within 14 months; any final photos requested by the User from in-store devices are deleted within 24 hours. This may involve a transfer of such data to the EU, with the safeguards described in the “International transfers” section of this Addendum.
...
*  **right of access**: to request a copy of their personal data and information on its use;
*  **right to rectification**: to request the correction of inaccurate or incomplete data;
*  **right to withdraw consent**: to withdraw previously given consent at any time;
*  **right to challenge compliance**: to challenge an organisation’s compliance with the PIPEDA principles;
*  **right to recourse**: to lodge a complaint with the competent data-protection authority.
...
*  the **Office of the Privacy Commissioner of Canada (OPC)** (https://www.priv.gc.ca/en/);
* the provincial privacy commissioners in **British Columbia, Alberta or Quebec**, where applicable.

### Data retention and security measures

PIPEDA requires that personal data be **retained only for as long as necessary** for the intended purpose.

*  **Spaarkly ensures that session and device data is anonymised within 14 months**, in accordance with best practices.
* Robust **technical and organisational measures** are adopted to prevent unauthorised access, data leaks or misuse.

### Data-breach notification obligations

* In the event of a **data breach that presents a real risk of significant harm**, Spaarkly will notify:
  * the **Office of the Privacy Commissioner of Canada (OPC)**;
  * the provincial privacy commissioners, where required by provincial law;
  * where legally required, a **public notice** will be published on Spaarkly’s website or through other appropriate channels.
...
* ensuring compliance with PIPEDA’s **Accountability principle** in relation to international transfers;
* implementing **Standard Contractual Clauses (SCCs)** or other legally recognised transfer mechanisms, where necessary;
* providing clear and accessible information on potential cross-border transfers and the risks involved.
...
*  **Australia**: **Privacy Act 1988 (Cth)**, including the **Australian Privacy Principles (APPs)**, and the **Privacy Amendment (Notifiable Data Breaches) Act 2017**;
*  **New Zealand**: **Privacy Act 2020**, including the **Information Privacy Principles (IPPs)**, regulated by the **Office of the Privacy Commissioner (OPC)**.
...
*  **right of access**: to request access to their personal data held by an organisation;
*  **right to correction**: to request the correction of inaccurate, out-of-date, incomplete or misleading data;
*  **right to object**: to object to certain types of processing, in particular direct marketing in Australia and processing likely to cause significant harm, distress or prejudice in New Zealand;
*  **right to complain**: to lodge a complaint with the competent privacy authority where they believe their rights have been infringed;
*  **right to remedies**: to obtain remedies for privacy breaches, including correction, apology or compensation, where applicable.
...
*  the **Office of the Privacy Commissioner (OPC) of New Zealand** (https://www.privacy.org.nz/).
...
*  **Spaarkly ensures that session and device data is anonymised within 14 months**, in accordance with best practices.
* Robust **technical and organisational measures** are adopted to prevent unauthorised access, data leaks or misuse, in accordance with APP 11 in Australia and IPP 5 in New Zealand.

### Data-breach notification obligations

* In the event of a **data breach likely to result in serious harm** to data subjects, Spaarkly will notify:
  * the **Office of the Australian Information Commissioner (OAIC)** under the **Notifiable Data Breaches (NDB)** scheme, completing the incident assessment within 30 days and notifying as soon as reasonably practicable;
  * the **Office of the Privacy Commissioner (OPC) of New Zealand** as soon as possible, in accordance with the mandatory notification requirements of the Privacy Act 2020.
*  **As Spaarkly does not collect users’ contact information, individual notifications cannot be sent directly**. Where legally required, Spaarkly will publish a **public notice** on its website or through other appropriate channels.
...
* ensuring compliance with **APP 8** and with **Section 16C of the Australian Privacy Act** on cross-border disclosures;
* implementing the appropriate safeguards required by **IPP 12 of the New Zealand Privacy Act 2020** for overseas transfers;
* providing users with clear information on potential cross-border transfers and maintaining accountability in relation to data protection.
...
*  **Singapore**: **Personal Data Protection Act (PDPA)** of 2012, as amended in 2020, enforced by the **Personal Data Protection Commission (PDPC)**;
*  **Malaysia**: **Personal Data Protection Act (PDPA)** of 2010, enforced by the **Personal Data Protection Department (JPDP)**;
*  **Philippines**: **Data Privacy Act (DPA)** of 2012, enforced by the **National Privacy Commission (NPC)**;
*  **Indonesia**: **Personal Data Protection Law (PDP Law)** of 2022, modelled on the GDPR;
*  **Thailand**: **Personal Data Protection Act (PDPA)** of 2019, enforced by the **Personal Data Protection Committee (PDPC)**;
*  **South Korea**: **Personal Information Protection Act (PIPA)**, enforced by the **Personal Information Protection Commission (PIPC)**;
* other jurisdictions with emerging data-protection frameworks.
...
*  **right of access**: to request information on the collection, use and disclosure of personal data;
...
*  **right to data portability**: to request the transfer of data to another organisation, in jurisdictions such as Singapore and the Philippines;
*  **right to erasure**: to request the deletion of personal data under specific conditions, depending on the jurisdiction;
*  **right to object**: to object to processing for direct marketing or other purposes, depending on the jurisdiction.
...
*  the **Personal Data Protection Commission (PDPC) of Singapore** (https://www.pdpc.gov.sg/);
*  the **Personal Data Protection Department (JPDP) of Malaysia** (https://www.pdp.gov.my/);
*  the **National Privacy Commission (NPC) of the Philippines** (https://privacy.gov.ph/);
*  the **Personal Data Protection Committee (PDPC) of Thailand**;
*  the **Personal Information Protection Commission (PIPC) of South Korea**;
* other competent national authorities, where applicable.
...
*  **Spaarkly ensures that session and device data is anonymised within 14 months**, in accordance with best practices.
* Robust **technical and organisational measures** are adopted to prevent unauthorised access, data leaks or misuse, including encryption, access controls and periodic security assessments.

### Data-breach notification obligations

* In the event of a **data breach likely to cause harm to individuals**, Spaarkly will notify:
  * the **competent data-protection authority**, in accordance with local requirements:
    *  **Singapore**: within 3 days for notifiable breaches;
    *  **Philippines**: within 72 hours;
    *  **Thailand**: without undue delay, within 72 hours;
    *  **South Korea**: without delay;
    * other jurisdictions in accordance with their respective timeframes.
*  **As Spaarkly does not collect users’ contact information, individual notifications cannot be sent directly**. Where legally required, Spaarkly will publish a **public notice** on its website or through other appropriate channels.
...
* ensuring compliance with specific transfer provisions, such as:
  * the **transfer-limitation obligation** of Singapore’s PDPA and its related requirements for overseas transfers;
  * the Philippines DPA’s rules on cross-border data sharing;
  * Malaysia’s PDPA prohibition on transfers to certain countries;
  * South Korea’s PIPA requirements for overseas transfers;
* implementing legally recognised transfer mechanisms, such as consent, contractual safeguards, binding corporate rules or certification mechanisms;
* providing users with clear information on potential cross-border transfers and maintaining accountability in relation to data protection.
...
*  **Brazil**: **Lei Geral de Proteção de Dados (LGPD)** of 2018, enforced by the **Autoridade Nacional de Proteção de Dados (ANPD)**;
*  **Mexico**: **Ley Federal de Protección de Datos Personales en Posesión de los Particulares (LFPDPPP)** of 2010, enforced by the **Instituto Nacional de Transparencia, Acceso a la Información y Protección de Datos Personales (INAI)**;
*  **Argentina**: **Personal Data Protection Act (PDPA)**, Law No. 25.326, enforced by the **Agencia de Acceso a la Información Pública (AAIP)**;
*  **Colombia**: **Law 1581 of 2012** on the general data-protection regime, enforced by the **Superintendencia de Industria y Comercio (SIC)**;
*  **Chile**: **Law No. 19.628 on the Protection of Private Life**, with ongoing regulatory reforms;
*  **Uruguay**: **Law No. 18.331 on Personal Data Protection and Habeas Data Action**, enforced by the **Unidad Reguladora y de Control de Datos Personales (URCDP)**;
* other jurisdictions with emerging data-protection frameworks.
...
*  **right of confirmation and access** (**ARCO rights**): to confirm the existence of processing and access personal data;
*  **right to rectification** (**ARCO rights**): to correct inaccurate, incomplete or out-of-date data;
*  **right to cancellation** (**ARCO rights**): to request the deletion of unnecessary or excessive data;
*  **right to object** (**ARCO rights**): to object to unlawful or non-consensual processing;
*  **right to information**: to receive clear information on processing activities;
*  **right to data portability**: to request the transfer of data to another service provider, in particular under the Brazilian LGPD;
*  **right to withdraw consent**: to withdraw previously given consent at any time;
*  **right to review of automated decisions**: to request the review of decisions taken solely by automated processing under the LGPD.
...
*  the **National Data Protection Authority of Brazil (ANPD)** (https://www.gov.br/anpd/);
*  the **Instituto Nacional de Transparencia, Acceso a la Información y Protección de Datos Personales (INAI) of Mexico** (https://home.inai.org.mx/);
*  the **Agencia de Acceso a la Información Pública (AAIP) of Argentina** (https://www.argentina.gob.ar/aaip);
*  the **Superintendencia de Industria y Comercio (SIC) of Colombia** (https://www.sic.gov.co/);
* other competent national authorities, where applicable.
...
*  **Spaarkly ensures that session and device data is anonymised within 14 months**, in accordance with best practices.
* Robust **technical and organisational measures** are adopted to prevent unauthorised access, data leaks or misuse, as required by Latin American laws, such as Article 46 of the Brazilian LGPD and Article 19 of the Mexican LFPDPPP.

### Data-breach notification obligations

* In the event of a **data breach that may cause risk or harm to data subjects**, Spaarkly will notify:
  * the **competent data-protection authority**, in accordance with local requirements:
    *  **Brazil**: notification to the ANPD within 3 business days of becoming aware of the incident, pursuant to Resolução CD/ANPD No. 15/2024;
    *  **Mexico**: prompt notification to data subjects following confirmation of the breach;
    * other jurisdictions in accordance with their respective requirements.
*  **As Spaarkly does not collect users’ contact information, individual notifications cannot be sent directly**. Where legally required, Spaarkly will publish a **public notice** on its website or through other appropriate channels.
...
* ensuring compliance with specific transfer provisions, such as:
  * the requirements of the **Brazilian LGPD** for international transfers (Articles 33-36);
  * the principles of the **Mexican LFPDPPP** for cross-border data sharing;
  * the Argentine **adequate-level** requirement under the PDPA;
  * the requirements of the **Colombian SIC** for cross-border transfers;
* implementing legally recognised transfer mechanisms, such as:
  * standard contractual clauses;
  * binding corporate rules;
  * certification mechanisms;
  * specific consent to the transfer;
  * adequacy decisions;
* providing users with clear information on potential cross-border transfers and maintaining accountability in relation to data protection.
...
*  **right of disclosure** (*Kaiji*): to request the disclosure of personal data held by a business operator;
*  **right to correction** (*Seigō*): to request the correction, addition or deletion of inaccurate personal data;
*  **right to cessation of use/deletion** (*Riyō Teishi / Sakujo*): to request the cessation of use or the deletion of personal data processed in breach of the law or beyond the specified purpose;
*  **right to cessation of disclosure to third parties** (*Daisansha Teikyō no Teishi*): to request the operator to cease the disclosure of personal data to third parties;
*  **right to an explanation** (*Setsumei*): to receive an explanation of the processing activities relating to personal data;
*  **right to complain** (*Kujō*): to lodge a complaint with the operator or the PPC.
...
*  the **Personal Information Protection Commission (PPC) of Japan** (https://www.ppc.go.jp/en/).
...
*  **Spaarkly ensures that session and device data is anonymised within 14 months**, in accordance with best practices.
*  **Spaarkly implements comprehensive security measures** as required by Article 23 of the APPI, including:
...
* In the event of a **loss of personal data or other security incident** (*Jōhō Rōei Jiko*), Spaarkly will:
  * make a **prompt report to the PPC** pursuant to Article 26 of the APPI, where the breach reaches the notification threshold;
  * include in the notification the details of the incident, the types of data involved, the cause and the corrective measures;
  * where legally required, publish a **public notice** on Spaarkly’s website or through other appropriate channels, as **direct individual notifications are not possible** in the absence of collected contact data.
...
* ensuring compliance with Article 28 of the APPI on international transfers, which requires:
  * the individual’s prior consent for transfers to third parties in foreign countries; or
  * assurance that the third party is located in a country with equivalent standards of data protection; or
  * assurance that the third party maintains equivalent standards through contractual arrangements or other means;
* implementing appropriate transfer mechanisms, such as:
  * standard contractual clauses;
  * binding corporate rules;
  * recognised certifications;
* providing users with clear information on potential cross-border transfers in accordance with the APPI requirements.
...
*  the **facial data** used for the Virtual Try-On is processed **locally on the device** and is not stored; for **AR PD Meter**, derived technical data, not used to identify the User and not capable, on their own, of identifying the User, may be transmitted temporarily to the ARShades backend located in the European Union, used solely to return the measurement result and discarded after processing;
*  **no collection of biometric or sensitive data**: Spaarkly does not collect biometric identifiers, real names, contact details or other data that uniquely identifies the user;
*  the **session and device data** (including the IP address) is stored on **servers located in the European Union** and anonymised within 14 months.
...
*  **right to rectification**: to request the correction of inaccurate or incomplete data;
*  **right to erasure**: to request the deletion of personal data under specific conditions;
*  **right to restrict or object to processing**: to object to certain processing activities;
*  **right to withdraw consent**: to withdraw previously given consent at any time.

In addition, the **PIPL recognises rights that go beyond the GDPR**, including:

*  **right to “know and decide”**: users have explicit control over how their data is used;
*  **right to an explanation of automated decisions**: users may request an explanation of how automated systems, such as AI-based recommendations, affect them.
...
* the **competent Chinese regulatory authorities**, where required by the **PIPL**;
* where legally required, a **public notice** will be published on Spaarkly’s website or through other appropriate channels.
...
*  **carrying out a security assessment** under the CAC rules, where required;
*  **implementing CAC-approved Standard Contractual Clauses (SCCs)** or other approved mechanisms;
*  **obtaining the user’s explicit consent** for any cross-border transfers, where deemed necessary.
...
*  **right of access**: to request a copy of their personal data;
*  **right to rectification**: to request the correction of inaccurate or incomplete data;
*  **right to erasure**: to request the deletion of personal data in specific cases;
*  **right to restrict or object to processing**: to object to certain processing activities;
*  **right to withdraw consent**: to withdraw previously given consent at any time.

Users may exercise their rights by contacting **privacy@spaarkly.com**. If not satisfied with Spaarkly’s response, they may apply to the **Information Regulator of South Africa** ([https://inforegulator.org.za/](https://inforegulator.org.za/)).

### Data retention and security measures

POPIA requires that personal data be **retained only for as long as necessary** for the intended purpose.

*  **Spaarkly ensures that session and device data is anonymised within 14 months**.
* Robust **technical and organisational measures** are adopted to prevent unauthorised access, data leaks or misuse.
...
* the **Information Regulator of South Africa**, where required by **POPIA**;
* where legally required, a **public notice** will be published on Spaarkly’s website or through other appropriate channels.
...
*  **ensuring that any data transfer complies with Section 72 of POPIA**, which requires adequate protection;
*  **implementing Standard Contractual Clauses (SCCs)** or other legally recognised transfer mechanisms, where necessary;
*  **obtaining the user’s explicit consent** for any cross-border transfers, should this become a legal requirement.
...
*  **right of access**: to request a summary of the personal data processed;
*  **right to rectification**: to request the correction of inaccurate or incomplete data;
*  **right to erasure**: to request the deletion of personal data under specific conditions;
*  **right to restrict or object to processing**: to object to certain processing activities;
*  **right to nominate a representative**: to designate another person to exercise their rights in the event of death or incapacity.
...
*  **Spaarkly ensures that session and device data is anonymised within 14 months**, in line with best practices.
* Robust **technical and organisational measures** are adopted to prevent unauthorised access, data leaks or misuse.

### Data-breach notification obligations

* In the event of a **personal-data breach**, Spaarkly will notify:
  * the **Data Protection Board of India** and, as required by the **DPDP**, the affected data subjects;
  * as it does not hold Users’ contact data, communication to data subjects will be carried out by means of a **public notice** on Spaarkly’s website and, where possible, through an in-service notice, as the most effective means available.
...
*  **ensuring compliance with the DPDP requirements on data localisation and transfer**;
*  **implementing legally recognised transfer mechanisms**, such as government-approved contractual clauses;
*  **obtaining the user’s explicit consent** for any cross-border transfers, should this become a legal requirement.
...
*  the **UAE Data Office**;
*  the **DIFC Commissioner of Data Protection** (https://www.difc.ae/business/regulations/data-protection/);
*  the **Saudi Data & Artificial Intelligence Authority (SDAIA)**, the competent authority under the Saudi Personal Data Protection Law (PDPL).
...
* In the event of a **data breach that may cause significant harm**, Spaarkly will notify:
  * the **competent Middle East data-protection authority**, where required by local law;
  * where legally required, a **public notice** will be published on Spaarkly’s website or through other appropriate channels.
*  **As Spaarkly does not collect users’ contact information, individual notifications cannot be sent**.
...
*  **ensuring compliance with local data-protection laws on international transfers**;
*  **implementing legally recognised transfer mechanisms**, such as Standard Contractual Clauses (SCCs) or government-approved frameworks;
*  **obtaining the user’s explicit consent** for any cross-border transfers, should this become a legal requirement.
...
* Spaarkly ensures that session and device data is anonymised within **14 months**, in line with best practices.
* Rigorous technical and organisational measures are adopted to prevent unauthorised access, data leaks or misuse.

### Data-Breach Notification Obligations

In the event of a data breach that may cause significant harm, Spaarkly will notify:

* The competent data-protection authority, where required by local law.
* Where legally required, it will publish a public notice on its website or through other appropriate channels.
...
* Ensuring compliance with **local data-protection laws relating to international transfers**.
* Implementing **legally recognised transfer mechanisms**, such as **Standard Contractual Clauses (SCCs)** or government-approved frameworks.
* Obtaining users’ **explicit consent** for any cross-border transfers, should this become a legal requirement.

...
*  **ARShades Virtual Try-On** („ARShades VTO", „VTO", „Web VTO", „VTO App", „Anwendungen und Dienste");
*  **ARShades VTO Explorer** („VTO Explorer"), als Modul oder Funktion, das in ARShades-Erlebnisse im Web, auf Mobilgeräten, im Katalog, im E-Commerce, im Mirror, im Showroom oder in der Verkaufsstelle integriert werden kann;
*  **AR PD Meter**;
*  **ARShades Mirror** („Mirror");
*  **ARShades Gateway** („Gateway", „Standalone-Anwendung");
*  **ARShades Campaign Catalogue** („Campaign Catalogue"), als öffentlicher webbasierter Produktkatalog, der ARShades-Erlebnisse integriert.
...
*  **Personenbezogene Daten**: alle Informationen, die sich auf eine identifizierbare natürliche Person beziehen, einschließlich IP-Adresse, E-Mail und anderer vom Nutzer freiwillig bereitgestellter Daten.
*  **Sitzungsdaten**: Informationen, die während einer Nutzersitzung erhoben werden, wie Interaktions-Zeitstempel, aufgerufene Seiten und Nutzungsstatistiken. Sie werden bis zu **14 Monate** vor ihrer Anonymisierung aufbewahrt.
*  **Gerätedaten**: technische Informationen über das Gerät des Nutzers, einschließlich **Gerätetyp, Betriebssystem, Browserversion und bevorzugter Sprache**. Sie werden zur Optimierung und Sicherheit des Dienstes verwendet.
*  **Geolokalisierungsdaten**: Vorbehaltlich der Einwilligung des Nutzers kann ARShades den ungefähren Standort auf Grundlage der **IP-Adresse** oder, bei Standalone-Anwendungen, den **genauen GPS-Standort** erheben, um standortbezogene Dienste bereitzustellen. Die Nutzer können diese Funktion jederzeit deaktivieren.
*  **Verantwortlicher**: die Spaarkly s.r.l., die über die Zwecke und Mittel der Verarbeitung personenbezogener Daten entscheidet.
*  **Verarbeitung**: jeder mit personenbezogenen Daten durchgeführte Vorgang, einschließlich **Erhebung, Speicherung, Anonymisierung und Löschung**.
*  **Cookies und Tracking-Technologien**: für den Betrieb des Dienstes erforderliche essenzielle Cookies sowie optionale Analyse-Werkzeuge, sofern vom Nutzer aktiviert. Marketing-Cookies werden nicht verwendet.
*  **Rechte der betroffenen Person**: Die Nutzer können nach Maßgabe der DSGVO, des CCPA und vergleichbarer Vorschriften **auf ihre Daten zugreifen** sowie deren Berichtigung, Löschung oder Einschränkung der Verarbeitung verlangen. Anfragen können an **privacy@spaarkly.com** gerichtet werden.
*  **Internationale Datenübermittlungen**: Werden personenbezogene Daten außerhalb des **Europäischen Wirtschaftsraums (EWR)** übermittelt, gewährleistet Spaarkly die Rechtmäßigkeit durch **Standardvertragsklauseln (SCC)** oder gleichwertige Garantien.
*  **ARShades VTO**: eine **Virtual-Try-On-(VTO-)Lösung**, die es den Nutzern ermöglicht, in **Augmented Reality (AR) in Echtzeit** zu visualisieren, wie eine Brille zum Gesicht passt. Sie funktioniert auf **Web- und Mobilgeräten** ohne Speicherung biometrischer Daten.
*  **ARShades VTO Explorer**: ein Modul für fotobasiertes Virtual Try-On und einen augmentierten Katalog, das es den Nutzern ermöglicht, aus einer begrenzten Anzahl während der Sitzung erfasster Bilder realistische und personalisierte Vorschauen mehrerer Eyewear-Produkte zu erzeugen. VTO Explorer kann in ARShades-Lösungen im Web, auf Mobilgeräten, in Katalogen, im Mirror oder in andere In-Store-Erlebnisse integriert werden. Die erfassten Bilder werden lokal auf dem Gerät des Nutzers oder auf dem für das Erlebnis verwendeten Gerät verarbeitet und nicht automatisch auf die Server von Spaarkly hochgeladen. Wird VTO Explorer auf einem in einer Verkaufsstelle, einem Showroom, an einem Veranstaltungsort oder an einem sonstigen öffentlichen Ort installierten Gerät verwendet und entscheidet sich der Nutzer, die fertigen Fotos auf sein eigenes Gerät zu erhalten, herunterzuladen oder zu teilen, so dürfen ausschließlich die vom Nutzer ausgewählten fertigen Fotos vorübergehend auf die Server von Spaarkly hochgeladen werden, und zwar allein zu dem Zweck, sie dem Nutzer zur Verfügung zu stellen; sie werden nach Maßgabe der vorliegenden Erklärung gelöscht.
*  **AR PD Meter**: ein Werkzeug zur Messung der **Pupillendistanz (PD)**, das den Abstand zwischen den Pupillen des Nutzers mittels **AR und Erkennung von Gesichtslandmarken** schätzt. Die Bilder und Videoströme der Kamera werden nicht gespeichert, nicht zur biometrischen Identifizierung verwendet und nicht zur Erstellung von Gesichtstemplates genutzt. Zur Berechnung der Pupillendistanz kann AR PD Meter vorübergehend abgeleitete technische Daten wie Gesichtslandmarken, Gesichtsausrichtung, technische Geräteinformationen und die für die Berechnung erforderlichen Parameter an das in der Europäischen Union befindliche ARShades-Backend übermitteln. Diese Daten werden ausschließlich zur Rückgabe des Messergebnisses verwendet und nach der Verarbeitung verworfen. Wird AR PD Meter im Rahmen von ARShades Mirror verwendet (etwa zur Unterstützung des VTO-Explorer-Erlebnisses im Mirror Showroom), so werden diese abgeleiteten technischen Daten vom lokalen Backend des Geräts verarbeitet, ohne Übermittlung an Cloud-Server, und nach der Verarbeitung gelöscht.
*  **ARShades Mirror**: ein Virtual-Try-On-Erlebnis für den Einzelhandel, das über **digitale Spiegel und In-Store-Kioske** verfügbar ist und es den Nutzern ermöglicht, virtuelle Eyewear-Kataloge zu durchstöbern und Brillen in AR anzuprobieren, ohne dass eine Speicherung personenbezogener Daten erforderlich ist.
*  **ARShades Gateway**: eine **eigenständige (Standalone-)** AR-Plattform, die unter anderem ein **Virtual-Try-On**-Erlebnis bietet. Sie kann optional **vorbehaltlich der Einwilligung die Geolokalisierung nutzen**, um Empfehlungen zu personalisieren.
*  **ARShades Campaign Catalogue**: ein **öffentlicher webbasierter** Produktkatalog, der über eine eigene URL zugänglich ist, die Eyewear-Produkte einer Marke präsentiert und es ermöglicht, ARShades-Erlebnisse wie VTO, 3D Viewer und VTO Explorer zu starten. Die Katalogseite schreibt weder Cookies noch Local Storage noch sonstige Kennungen auf das Gerät des Nutzers; ihre Nutzung wird in aggregierter Form gemessen, wie im Abschnitt „Daten zur Nutzungsmessung der öffentlichen Kataloge" beschrieben.
...
*  **Bereitstellung der VTO-Dienste**: dem Nutzer das virtuelle Anprobieren von Eyewear-Fassungen, das Erproben von Formen und Größen sowie die Nutzung von Werkzeugen wie der Messung der Pupillendistanz zu ermöglichen (**Rechtsgrundlage: Erfüllung eines Vertrags oder Durchführung vorvertraglicher Maßnahmen auf Anfrage des Nutzers gemäß Art. 6 Abs. 1 lit. b DSGVO**).
*  **Verbesserung des Dienstes, Analytics, Sicherheit und Betrugsprävention**: die Qualität, Benutzerfreundlichkeit, analytische Auswertung und Sicherheit unserer Dienste zu verbessern, anonyme Statistiken über Nutzung und Leistung der ARShades-Erlebnisse zu erstellen – einschließlich der aggregierten Messung der Nutzung der öffentlichen Seiten der Campaign Catalogues –, missbräuchliche Nutzung und Betrug zu verhindern sowie die Integrität der Netze und Systeme zu gewährleisten (**Rechtsgrundlage: berechtigtes Interesse, Art. 6 Abs. 1 lit. f DSGVO**).
*  **Erfüllung rechtlicher Verpflichtungen**: gesetzlichen Verpflichtungen oder Anordnungen zuständiger Behörden im Bereich der Datenspeicherung, Sicherheit und sonstiger regulatorischer Anforderungen nachzukommen (**Rechtsgrundlage: rechtliche Verpflichtung, Art. 6 Abs. 1 lit. c DSGVO**).
*  **Einwilligung, soweit anwendbar**: Soweit eine Einwilligung erforderlich ist, etwa für den Kamerazugriff oder für etwaige optionale Analyse-Werkzeuge, sofern verfügbar, beruht die Verarbeitung auf der Einwilligung (Art. 6 Abs. 1 lit. a DSGVO), die jederzeit widerrufen werden kann, ohne dass die Rechtmäßigkeit der bis zum Widerruf erfolgten Verarbeitung berührt wird.
...
*  **Bereitstellung der VTO-Dienste**: dem Nutzer das virtuelle Anprobieren von Eyewear-Fassungen, das Erproben von Formen und Größen sowie die Nutzung von Werkzeugen wie der Messung der Pupillendistanz zu ermöglichen (Rechtsgrundlage: Erfüllung eines Vertrags oder Durchführung vorvertraglicher Maßnahmen auf Anfrage der betroffenen Person gemäß Art. 6 Abs. 1 lit. b DSGVO).
*  **Verbesserung des Dienstes, Analytics, Sicherheit und Betrugsprävention**: die Qualität, Benutzerfreundlichkeit, analytische Auswertung und Sicherheit unserer Dienste zu verbessern, anonyme Statistiken über Nutzung und Leistung der ARShades-Erlebnisse zu erstellen, missbräuchliche Nutzung und Betrug zu verhindern sowie die Integrität der Netze und Systeme zu gewährleisten (Rechtsgrundlage: berechtigtes Interesse, Art. 6 Abs. 1 lit. f DSGVO).
*  **Rechtliche Verpflichtungen**: gesetzlichen Verpflichtungen oder Anordnungen der zuständigen Behörden im Bereich der Datenspeicherung, Sicherheit und sonstiger regulatorischer Anforderungen nachzukommen (Rechtsgrundlage: rechtliche Verpflichtung, Art. 6 Abs. 1 lit. c DSGVO).
*  **Einwilligung, soweit anwendbar**: Soweit eine Einwilligung erforderlich ist, etwa für den Kamerazugriff, für die Erfassung der zur Nutzung des Moduls VTO Explorer erforderlichen Bilder oder für die vorübergehende Speicherung der vom Nutzer ausgewählten fertigen Fotos zum Herunterladen oder Teilen über Funktionen wie „Shoot & Share" oder gleichwertige Download-Funktionen, beruht die Verarbeitung auf der Einwilligung (Art. 6 Abs. 1 lit. a DSGVO), die jederzeit widerrufen werden kann, ohne dass die Rechtmäßigkeit der bis zum Widerruf erfolgten Verarbeitung berührt wird.
...
* Breite und Höhe der Stirn;
* Länge und Breite der Nase;
* Höhe der Wangenknochen;
* Gesichtsbreite auf Höhe der Wangenknochen;
* Gesichtsbreite auf Höhe des Mundes;
* Länge des Kinns;
* Gesamtlänge des Gesichts.
...
* Betriebssystem;
* bevorzugte Sprache;
* angesehene Marken und Produkte;
* Zugriffsdaten und -uhrzeiten;
* anonyme Statistiken über die Interaktionen mit der VTO-App, etwa ob der Nutzer eine Brille trägt.
...
*  **Genaue Geolokalisierung**: Vorbehaltlich der ausdrücklichen Einwilligung können bestimmte ARShades-Standalone-Anwendungen genaue Geolokalisierungskoordinaten vom Gerät erheben, um standortbezogene Dienste oder Empfehlungen bereitzustellen.
*  **Ungefährer Standort**: Fehlt eine ausdrückliche Einwilligung zum genauen Standort, können wir einen ungefähren Standort auf Grundlage der IP-Adresse ableiten.

Die Erhebung von Geolokalisierungsdaten bei Standalone-Anwendungen ist:

*  **fakultativ**: Die Standortberechtigungen können verweigert werden, ohne dass die zentralen VTO-Funktionen beeinträchtigt werden;
*  **einwilligungsbasiert**: Die genaue Geolokalisierung wird nur nach vorheriger ausdrücklicher Einwilligung erhoben;
*  **zweckgebunden**: Sie wird nur verwendet, um einschlägige Eyewear-Empfehlungen oder standortbezogene Dienste bereitzustellen;
*  **derselben Aufbewahrungsregelung unterworfen**: Sie wird zusammen mit den übrigen technischen Daten innerhalb von 14 Monaten anonymisiert.
...
* vom Browser für künftige Besuche derselben Anwendung lokal gespeichert werden;
* so eingestellt werden, dass jedes Mal nachgefragt wird;
* nur für die aktuelle Sitzung vorübergehend erteilt werden.
...
* Die für Virtual Try-On, Personalisierung, Katalogerzeugung, Gesichtsanpassung, Segmentierung, Produktpositionierung und Rendering erfassten Bilder werden lokal auf dem Gerät verarbeitet, ohne automatische Übermittlung an die Server von Spaarkly.
* Bei den VTO-Mirror-Versionen, die das Modul **VTO Explorer** enthalten, wie **Mirror Showroom**, werden die während der Personalisierungsphase erfassten Bilder lokal verwendet, um Vorschauen des augmentierten Katalogs zu erzeugen, und werden nicht auf die Server von Spaarkly hochgeladen.
* Nur wenn der Nutzer sich aktiv entscheidet, fertige Fotos, die ihn mit der ausgewählten Brille zeigen, von einem in einer Verkaufsstelle, einem Showroom, an einem Veranstaltungsort oder an einem sonstigen öffentlichen Ort installierten Gerät zu erhalten, herunterzuladen oder zu teilen, dürfen diese ausgewählten fertigen Fotos vorübergehend auf die Server von Spaarkly hochgeladen werden, und zwar allein zu dem Zweck, sie dem Nutzer auf seinem eigenen Gerät zur Verfügung zu stellen.
* Der Inhaber der Verkaufsstelle hat keinen unmittelbaren Zugriff auf die von den Nutzern erzeugten Daten oder Bilder, da der Zugriff auf die Software ausschließlich ARShades vorbehalten ist.
* ARShades verpflichtet sich, nicht auf die Daten des Nutzers zuzugreifen, es sei denn, dies ist für bestimmte technische Wartungstätigkeiten erforderlich, wobei die erfassten Bilder in keinem Fall angezeigt oder verarbeitet werden.
* Spaarkly gibt die Daten der Nutzer nicht zu deren eigenen Zwecken an Dritte weiter. Für das Hosting und die Erbringung der Dienste kann Spaarkly qualifizierte Anbieter von Cloud-Infrastruktur mit Servern in der Europäischen Union heranziehen, die als Auftragsverarbeiter gemäß Art. 28 DSGVO benannt und durch entsprechende Auftragsverarbeitungsvereinbarungen gebunden sind. Die Verarbeitungstätigkeiten werden ausschließlich durch autorisiertes Personal von Spaarkly und durch diese Anbieter im Rahmen der erteilten Weisungen durchgeführt.

### Automatische Löschung und Sicherheitsmaßnahmen

* Die vorübergehend über **VTO Mirror**, **VTO Explorer**, „Shoot & Share" oder gleichwertige Download-/Teilen-Funktionen von Geräten hochgeladenen fertigen Fotos, die in Verkaufsstellen, Showrooms, an Veranstaltungsorten oder an sonstigen öffentlichen Orten installiert sind, können von den Nutzern unmittelbar nach dem Herunterladen auf ihr eigenes Gerät von unseren Servern gelöscht werden, sofern diese Option verfügbar ist. Löschen die Nutzer ihre Fotos nicht manuell, entfernt unser System sie nach **24 Stunden** automatisch mittels eines eigens dafür vorgesehenen Skripts, ohne manuelles Eingreifen.
* Die vorübergehend gespeicherten Daten werden zur Gewährleistung ihrer Sicherheit **im Ruhezustand und bei der Übertragung verschlüsselt**.
* Alle Zugriffe auf die ARShades-Geräte zu Zwecken der technischen Wartung werden in einem **Zugriffsprotokoll** erfasst, in Übereinstimmung mit **Art. 5 Abs. 1 lit. f DSGVO**.
* Die Software ist so konfiguriert, dass der Zugriff auf die Daten ausschließlich dem **autorisierten ARShades-Personal** vorbehalten ist.

### Rolle von ARShades und der Verkaufsstelle

*  **ARShades bleibt der alleinige Verantwortliche** für die über den VTO Mirror erzeugten Daten.
* Die **Verkaufsstelle verarbeitet die Daten der Nutzer nicht**, da sie weder Zugriff auf die erzeugten Daten noch auf die Verwaltung der Software hat.

## 6\. DATENERHEBUNG UND AUFBEWAHRUNGSDAUER

* Die **Daten der Gesichtsvermessung** werden für das Virtual Try-On lokal auf dem Gerät des Nutzers erhoben und nur so lange aufbewahrt, wie es für die Erbringung der ARShades-VTO-Dienste erforderlich ist. Beim AR PD Meter können die zur Berechnung der Pupillendistanz erforderlichen abgeleiteten technischen Daten vorübergehend an das in der EU befindliche ARShades-Backend übermittelt, allein zur Rückgabe des Messergebnisses verwendet und nach der Verarbeitung verworfen werden.
* Die **Sitzungs- und Gerätedaten** werden auf den in der EU befindlichen Servern von Spaarkly aufbewahrt. Die **IP-Adressen werden innerhalb von 14 Monaten gelöscht und vollständig von allen übrigen Daten getrennt**. Zu statistischen Analysezwecken werden ausschließlich aggregierte und anonymisierte Daten aufbewahrt.
* Die **Daten zur Nutzungsmessung der öffentlichen Kataloge (Campaign Catalogue)** werden nach der täglichen statistischen Aggregation gelöscht, in der Regel innerhalb von 48 Stunden nach der Erhebung; anschließend werden ausschließlich aggregierte und anonyme Statistiken aufbewahrt.
* Die Aufbewahrungsdauer der personenbezogenen Daten kann in Ausnahmefällen verlängert werden, etwa zur Erfüllung gesetzlicher Verpflichtungen oder zu Zwecken der Betrugsprävention.
...
* ermöglichen **grundlegende Funktionen der Website**, wie Sitzungsverwaltung und Sicherheit;
* verfolgen die Nutzer **nicht** über verschiedene Websites hinweg;
* werden **nicht** für Analytics, Marketing oder Tracking durch Dritte verwendet.
...
|---|---|---|
|<b>visited</b>|90 Tage|Erkennt, ob der Nutzer den Dienst bereits genutzt hat.|
|<b>consent</b>|120 Minuten|Erkennt, ob der Nutzer die Einwilligung in die Datenschutzerklärung und die Allgemeinen Geschäftsbedingungen für die Nutzung von ARShades erteilt hat.|
|<b>lang</b>|90 Tage|Speichert die vom Nutzer bevorzugte Sprache und ruft sie über die Browser-Sitzungen hinweg ab.|
...
*  **Firewalls**;
*  **sichere Server**;
*  **Zugriffsverwaltungssysteme** zur Verhinderung unbefugter Zugriffe auf Systeme und Daten.
...
*  **das Risikoniveau** gemäß **Art. 33 DSGVO** bewerten. Wir werden jede potenzielle Verletzung in Übereinstimmung mit Art. 33 DSGVO bewerten und die zuständige **Aufsichtsbehörde** innerhalb von **72 Stunden** benachrichtigen, soweit dies nach anwendbarem Recht erforderlich ist;
*  **aufgrund des Fehlens personenbezogener Kontaktdaten** nicht **in der Lage sein, die einzelnen Nutzer unmittelbar zu benachrichtigen**. Soweit erforderlich, geben wir stattdessen eine **öffentliche Bekanntmachung** über unsere offizielle Website oder andere Kanäle heraus;
*  den Vorfall schnellstmöglich **eindämmen und beheben** und dabei, soweit erforderlich, zusätzliche Schutzmaßnahmen umsetzen.
...
* Bestätigung zu verlangen, ob personenbezogene Daten verarbeitet werden oder nicht.
* Zugang zu den einschlägigen Informationen zu erhalten, etwa zu den Zwecken, den Kategorien der verarbeiteten Daten, den Empfängern oder Kategorien von Empfängern, der Aufbewahrungsdauer usw.
...
* Die Löschung der personenbezogenen Daten zu verlangen, wenn:
  * die Daten für die Zwecke, für die sie erhoben wurden, nicht mehr erforderlich sind;
  * die Einwilligung widerrufen wird, sofern die Verarbeitung auf der Einwilligung beruht;
...
* Die Einschränkung der Verarbeitung zu verlangen, wenn:
  ...
  * die Verarbeitung unrechtmäßig ist, der Löschung jedoch widersprochen wird;
  * die Daten zur Geltendmachung, Ausübung oder Verteidigung eines Rechtsanspruchs erforderlich sind, auch wenn der Verantwortliche sie nicht mehr benötigt;
  * der Verarbeitung widersprochen wird, solange die Prüfung der berechtigten Gründe andauert.

### Recht auf Datenübertragbarkeit

* Die eigenen personenbezogenen Daten in einem strukturierten, gängigen und maschinenlesbaren Format zu erhalten.
* Die unmittelbare Übermittlung an einen anderen Verantwortlichen zu verlangen, soweit technisch machbar.

### Widerspruchsrecht

* Der auf dem **berechtigten Interesse** beruhenden Verarbeitung zu widersprechen.

### Recht auf Widerruf der Einwilligung

* Die Einwilligung **jederzeit** zu widerrufen, wenn die Verarbeitung auf der Einwilligung beruht.
...
* den aktuellen Status seiner Einwilligung einsehen;
* auf unsere vollständige Datenschutzerklärung zugreifen;
...
* dem italienischen **Garante per la Protezione dei Dati Personali**: **[www.garanteprivacy.it](http://www.garanteprivacy.it)**;
* einer anderen **zuständigen Aufsichtsbehörde** in Ihrem Wohnsitzland.
...
* Aktualisierungen der **Technologie**;
* neue **rechtliche Anforderungen**;
* interne Änderungen der **Richtlinien**.
...
*  **zusätzliche oder abweichende Rechte** gegenüber den in der Hauptrichtlinie beschriebenen;
*  **die Modalitäten der Ausübung dieser Rechte**, einschließlich lokaler Kontaktstellen, Verfahren und Antwortfristen;
*  **etwaige zusätzliche Einwilligungsanforderungen**;
*  **besondere Anforderungen an die Datenspeicherung**;
*  **lokale Meldepflichten im Fall einer Datenschutzverletzung**;
*  **Regeln für Datenübermittlungen**, einschließlich Standardvertragsklauseln und lokaler Anforderungen.
...
### Verzeichnis der regionalen und nationalen Addenda
 ...
 1. [Europäische Union / Europäischer Wirtschaftsraum / Vereinigtes Königreich](#a-vereinigtes-königreich-uk-gdpr--europäische-union-und-europäischer-wirtschaftsraum-eu-ewr)
 2. [Schweiz](#b-schweiz-fadp--federal-act-on-data-protection)
 3. [Vereinigte Staaten](#c-vereinigte-staaten--addendum-usa)
 4. [Kanada](#d-kanada-pipeda--personal-information-protection-and-electronic-documents-act)
 5. [Australien und Neuseeland](#e-australien-und-neuseeland)
 6. [Region Asien-Pazifik](#f-region-asien-pazifik)
 7. [Brasilien und Lateinamerika](#g-brasilien-und-lateinamerika)
 8. [Japan](#h-japan-appi--act-on-the-protection-of-personal-information)
 9. [China](#i-china-pipl--personal-information-protection-law)
10. [Südafrika](#j-südafrika-popia--protection-of-personal-information-act)
11. [Indien](#k-indien-dpdp--digital-personal-data-protection-act)
12. [Naher Osten](#l-naher-osten-vereinigte-arabische-emirate--dubai--saudi-arabien--weitere-länder)
13. [Weitere Länder](#m-weitere-länder)
...
*  **Nutzer in der EU/im EWR**: die **Datenschutz-Aufsichtsbehörde** des jeweiligen Mitgliedstaats.
*  **Nutzer im Vereinigten Königreich**: das **Information Commissioner's Office (ICO)** ([https://ico.org.uk/](https://ico.org.uk/)).
...
*  **Standardvertragsklauseln (SCC)** der Europäischen Kommission für Übermittlungen aus der EU/dem EWR;
*  **von der ICO genehmigte SCC** für Übermittlungen aus dem Vereinigten Königreich;
*  **zusätzliche Garantien, soweit erforderlich**, im Einklang mit den Leitlinien des European Data Protection Board (EDPB) und der ICO.
...
*  auf ihre von Spaarkly verarbeiteten personenbezogenen Daten **zuzugreifen**;
*  die **Berichtigung** oder Löschung unrichtiger oder nicht erforderlicher Daten zu **verlangen**;
*  der **Verarbeitung der Daten** zu Zwecken des **Direktmarketings** zu **widersprechen**.
...
* den **Eidgenössischen Datenschutz- und Öffentlichkeitsbeauftragten (FDPIC)**;
* die **betroffenen Personen**, soweit dies nach schweizerischem Recht erforderlich ist.

### Internationale Datenübermittlungen

Die personenbezogenen Daten schweizerischer Nutzer werden **nicht außerhalb der Schweiz übermittelt**, es sei denn:

* das Bestimmungsland wird von den schweizerischen Behörden als mit einem **angemessenen Schutzniveau** ausgestattet angesehen;
* es werden von der Europäischen Kommission genehmigte **Standardvertragsklauseln (SCC)** für Übermittlungen in die EU/den EWR umgesetzt;
* es werden andere **mit dem schweizerischen FADP konforme Garantien** getroffen, um die übermittelten Daten zu schützen.
...
*  **Texas**: **Capture or Use of Biometric Identifier Act (CUBI)** und **Texas Data Privacy and Security Act (TDPSA)**;
*  **Washington**: Gesetz über den Schutz biometrischer Daten (**RCW 19.375**);
*  **weitere anwendbare einzelstaatliche Datenschutzgesetze**.
...
*  zu **erfahren**, welche Kategorien personenbezogener Daten wir erheben;
*  die Zwecke der Verarbeitung zu **verstehen**;
*  die **Löschung** ihrer personenbezogenen Daten zu **verlangen**, vorbehaltlich der gesetzlich zulässigen Ausnahmen;
*  dem **Verkauf oder der Weitergabe** ihrer Daten zu **widersprechen**, soweit anwendbar;
*  wegen der Ausübung ihrer Datenschutzrechte **keine Benachteiligung** zu erfahren.
...
* **Opt-out**-Rechte in Bezug auf zielgerichtete Werbung oder den Verkauf personenbezogener Daten, soweit anwendbar. Obwohl ARShades solche Tätigkeiten nicht ausübt, können Einwohner von Montana und Oregon gleichwohl eine Bestätigung anfordern, indem sie sich an Spaarkly wenden.

#### 3\. Illinois (BIPA), Texas (CUBI), Washington (RCW 19.375)

*  **Spaarkly erhebt keine biometrischen Daten** im Sinne dieser Gesetze.
...
* Einige Bundesstaaten **verfügen noch nicht** über allgemeine Datenschutzgesetze.
* In diesen Fällen folgt **Spaarkly** den **in der vorliegenden Datenschutzerklärung beschriebenen allgemeinen Grundsätzen** und hält jedes anwendbare einzelstaatliche Recht ein.

### Wie die Rechte ausgeübt werden

Einwohner der USA können sich unter **[privacy@spaarkly.com](mailto:privacy@spaarkly.com)** an uns wenden und dabei ihren Wohnsitzstaat angeben.
...
* werden alle Daten der Gesichtsvermessung in Echtzeit verarbeitet und niemals über die unmittelbare Sitzung hinaus aufbewahrt;
* werden die vorübergehend an das ARShades-Backend für den AR PD Meter übermittelten abgeleiteten technischen Daten allein zur Rückgabe des Messergebnisses verwendet und nach der Verarbeitung verworfen;
* werden die Sitzungs- und Gerätedaten innerhalb von 14 Monaten anonymisiert und getrennt.
...
*  **Auskunftsrecht**: eine Kopie ihrer personenbezogenen Daten sowie Informationen über deren Verwendung zu verlangen;
*  **Recht auf Berichtigung**: die Berichtigung unrichtiger oder unvollständiger Daten zu verlangen;
*  **Recht auf Widerruf der Einwilligung**: eine zuvor erteilte Einwilligung jederzeit zu widerrufen;
*  **Recht, die Einhaltung zu beanstanden**: die Einhaltung der PIPEDA-Grundsätze durch eine Organisation zu beanstanden;
*  **Beschwerderecht**: Beschwerde bei der zuständigen Datenschutzbehörde einzulegen.
...
*  das **Office of the Privacy Commissioner of Canada (OPC)** (https://www.priv.gc.ca/en/);
* die provinziellen Datenschutzbeauftragten in **British Columbia, Alberta oder Québec**, soweit anwendbar.
...
*  **Spaarkly gewährleistet, dass die Sitzungs- und Gerätedaten innerhalb von 14 Monaten anonymisiert werden**, in Übereinstimmung mit den besten Praktiken.
* Es werden robuste **technische und organisatorische Maßnahmen** getroffen, um unbefugte Zugriffe, Datenlecks oder Missbrauch zu verhindern.

### Meldepflichten im Fall einer Datenschutzverletzung

* Im Fall einer **Datenschutzverletzung, die ein reales Risiko eines erheblichen Schadens** darstellt, benachrichtigt Spaarkly:
  * das **Office of the Privacy Commissioner of Canada (OPC)**;
  * die provinziellen Datenschutzbeauftragten, soweit dies nach provinziellem Recht erforderlich ist;
  * soweit gesetzlich vorgeschrieben, wird eine **öffentliche Bekanntmachung** auf der Website von Spaarkly oder über andere geeignete Kanäle veröffentlicht.
...
* die Gewährleistung der Einhaltung des **Rechenschaftsgrundsatzes (Accountability)** des PIPEDA in Bezug auf internationale Übermittlungen;
* die Umsetzung von **Standardvertragsklauseln (SCC)** oder anderen rechtlich anerkannten Übermittlungsmechanismen, soweit erforderlich;
* die Bereitstellung klarer und zugänglicher Informationen über potenzielle grenzüberschreitende Übermittlungen und die damit verbundenen Risiken.
...
*  **Australien**: **Privacy Act 1988 (Cth)**, einschließlich der **Australian Privacy Principles (APPs)**, sowie **Privacy Amendment (Notifiable Data Breaches) Act 2017**;
*  **Neuseeland**: **Privacy Act 2020**, einschließlich der **Information Privacy Principles (IPPs)**, beaufsichtigt durch das **Office of the Privacy Commissioner (OPC)**.
...
*  **Auskunftsrecht**: Zugang zu ihren von einer Organisation gehaltenen personenbezogenen Daten zu verlangen;
*  **Recht auf Berichtigung**: die Berichtigung unrichtiger, nicht aktueller, unvollständiger oder irreführender Daten zu verlangen;
*  **Widerspruchsrecht**: bestimmten Arten der Verarbeitung zu widersprechen, insbesondere dem Direktmarketing in Australien und Verarbeitungen, die geeignet sind, in Neuseeland erheblichen Schaden, Beeinträchtigung oder Nachteil zu verursachen;
*  **Beschwerderecht**: Beschwerde bei der zuständigen Datenschutzbehörde einzulegen, sofern sie ihre Rechte für verletzt halten;
*  **Recht auf Abhilfe**: Abhilfe für Datenschutzverletzungen zu erlangen, einschließlich Berichtigung, Entschuldigung oder Schadensersatz, soweit anwendbar.
...
*  das **Office of the Australian Information Commissioner (OAIC)** (https://www.oaic.gov.au/);
*  das **Office of the Privacy Commissioner (OPC) Neuseelands** (https://www.privacy.org.nz/).
...
*  **Spaarkly gewährleistet, dass die Sitzungs- und Gerätedaten innerhalb von 14 Monaten anonymisiert werden**, in Übereinstimmung mit den besten Praktiken.
* Es werden robuste **technische und organisatorische Maßnahmen** getroffen, um unbefugte Zugriffe, Datenlecks oder Missbrauch zu verhindern, in Übereinstimmung mit APP 11 in Australien und IPP 5 in Neuseeland.

### Meldepflichten im Fall einer Datenschutzverletzung

* Im Fall einer **Datenschutzverletzung, die geeignet ist, einen schwerwiegenden Schaden** für die betroffenen Personen herbeizuführen, benachrichtigt Spaarkly:
  * das **Office of the Australian Information Commissioner (OAIC)** im Rahmen des Regimes der **Notifiable Data Breaches (NDB)**, wobei die Bewertung des Vorfalls innerhalb von 30 Tagen abgeschlossen und die Benachrichtigung vorgenommen wird, sobald dies nach vernünftigem Ermessen praktikabel ist;
  * das **Office of the Privacy Commissioner (OPC) Neuseelands** sobald wie möglich, in Übereinstimmung mit den zwingenden Meldeanforderungen des Privacy Act 2020.
*  **Da Spaarkly keine Kontaktinformationen der Nutzer erhebt, ist der Versand individueller Benachrichtigungen unmittelbar nicht möglich**. Soweit gesetzlich vorgeschrieben, veröffentlicht Spaarkly eine **öffentliche Bekanntmachung** auf ihrer Website oder über andere geeignete Kanäle.
...
* die Gewährleistung der Einhaltung von **APP 8** und der **Section 16C des Australian Privacy Act** im Bereich grenzüberschreitender Offenlegungen;
* die Umsetzung der durch **IPP 12 des New Zealand Privacy Act 2020** verlangten geeigneten Garantien für Übermittlungen ins Ausland;
* die Bereitstellung klarer Informationen für die Nutzer über potenzielle grenzüberschreitende Übermittlungen und die Wahrung der Rechenschaftspflicht im Bereich des Datenschutzes.
...
*  **Singapur**: **Personal Data Protection Act (PDPA)** von 2012, in der Fassung von 2020, durchgesetzt durch die **Personal Data Protection Commission (PDPC)**;
*  **Malaysia**: **Personal Data Protection Act (PDPA)** von 2010, durchgesetzt durch das **Personal Data Protection Department (JPDP)**;
*  **Philippinen**: **Data Privacy Act (DPA)** von 2012, durchgesetzt durch die **National Privacy Commission (NPC)**;
*  **Indonesien**: **Personal Data Protection Law (PDP Law)** von 2022, an der DSGVO ausgerichtet;
*  **Thailand**: **Personal Data Protection Act (PDPA)** von 2019, durchgesetzt durch das **Personal Data Protection Committee (PDPC)**;
*  **Südkorea**: **Personal Information Protection Act (PIPA)**, durchgesetzt durch die **Personal Information Protection Commission (PIPC)**;
* weitere Rechtsordnungen mit sich herausbildenden Regelungsrahmen im Bereich des Datenschutzes.
...
*  **Auskunftsrecht**: Informationen über die Erhebung, Verwendung und Offenlegung der personenbezogenen Daten zu verlangen;
*  **Recht auf Berichtigung**: die Berichtigung unrichtiger oder unvollständiger personenbezogener Daten zu verlangen;
*  **Recht auf Widerruf der Einwilligung**: eine zuvor erteilte Einwilligung zu widerrufen;
*  **Recht auf Datenübertragbarkeit**: die Übermittlung der Daten an eine andere Organisation zu verlangen, in Rechtsordnungen wie Singapur und den Philippinen;
*  **Recht auf Löschung**: die Löschung der personenbezogenen Daten unter bestimmten Bedingungen zu verlangen, je nach Rechtsordnung;
*  **Widerspruchsrecht**: der Verarbeitung zu Zwecken des Direktmarketings oder zu anderen Zwecken zu widersprechen, je nach Rechtsordnung.
...
*  **Personal Data Protection Commission (PDPC) Singapurs** (https://www.pdpc.gov.sg/);
*  **Personal Data Protection Department (JPDP) Malaysias** (https://www.pdp.gov.my/);
*  **National Privacy Commission (NPC) der Philippinen** (https://privacy.gov.ph/);
*  **Personal Data Protection Committee (PDPC) Thailands**;
*  **Personal Information Protection Commission (PIPC) Südkoreas**;
* weitere zuständige nationale Behörden, soweit anwendbar.
...
*  **Spaarkly gewährleistet, dass die Sitzungs- und Gerätedaten innerhalb von 14 Monaten anonymisiert werden**, in Übereinstimmung mit den besten Praktiken.
* Es werden robuste **technische und organisatorische Maßnahmen** getroffen, um unbefugte Zugriffe, Datenlecks oder Missbrauch zu verhindern, einschließlich Verschlüsselung, Zugriffskontrollen und regelmäßiger Sicherheitsbewertungen.

### Meldepflichten im Fall einer Datenschutzverletzung

* Im Fall einer **Datenschutzverletzung, die geeignet ist, den Einzelpersonen Schaden zuzufügen**, benachrichtigt Spaarkly:
  * die **zuständige Datenschutzbehörde** nach Maßgabe der lokalen Anforderungen:
    *  **Singapur**: innerhalb von 3 Tagen bei meldepflichtigen Verletzungen;
    *  **Philippinen**: innerhalb von 72 Stunden;
    *  **Thailand**: ohne ungerechtfertigte Verzögerung, innerhalb von 72 Stunden;
    *  **Südkorea**: ohne Verzögerung;
    * weitere Rechtsordnungen nach den jeweiligen Fristen.
*  **Da Spaarkly keine Kontaktinformationen der Nutzer erhebt, ist der Versand individueller Benachrichtigungen unmittelbar nicht möglich**. Soweit gesetzlich vorgeschrieben, veröffentlicht Spaarkly eine **öffentliche Bekanntmachung** auf ihrer Website oder über andere geeignete Kanäle.
...
* die Gewährleistung der Einhaltung besonderer Übermittlungsbestimmungen, etwa:
  * der **Beschränkungspflicht bei Übermittlungen** des PDPA Singapurs und der damit verbundenen Anforderungen für Übermittlungen ins Ausland;
  * der Regeln des DPA der Philippinen zur grenzüberschreitenden Datenweitergabe;
  * des Verbots des PDPA Malaysias, in bestimmte Länder zu übermitteln;
  * der Anforderungen des PIPA Südkoreas für Übermittlungen ins Ausland;
* die Umsetzung rechtlich anerkannter Übermittlungsmechanismen wie Einwilligung, vertragliche Garantien, verbindliche interne Datenschutzvorschriften oder Zertifizierungsmechanismen;
* die Bereitstellung klarer Informationen für die Nutzer über potenzielle grenzüberschreitende Übermittlungen und die Wahrung der Rechenschaftspflicht im Bereich des Datenschutzes.
...
*  **Brasilien**: **Lei Geral de Proteção de Dados (LGPD)** von 2018, durchgesetzt durch die **Autoridade Nacional de Proteção de Dados (ANPD)**;
*  **Mexiko**: **Ley Federal de Protección de Datos Personales en Posesión de los Particulares (LFPDPPP)** von 2010, durchgesetzt durch das **Instituto Nacional de Transparencia, Acceso a la Información y Protección de Datos Personales (INAI)**;
*  **Argentinien**: **Personal Data Protection Act (PDPA)**, Gesetz Nr. 25.326, durchgesetzt durch die **Agencia de Acceso a la Información Pública (AAIP)**;
*  **Kolumbien**: **Law 1581 of 2012** über die allgemeine Datenschutzregelung, durchgesetzt durch die **Superintendencia de Industria y Comercio (SIC)**;
*  **Chile**: **Law No. 19.628 on the Protection of Private Life**, mit laufenden Gesetzesreformen;
*  **Uruguay**: **Law No. 18.331 on Personal Data Protection and Habeas Data Action**, durchgesetzt durch die **Unidad Reguladora y de Control de Datos Personales (URCDP)**;
* weitere Rechtsordnungen mit sich herausbildenden Regelungsrahmen im Bereich des Datenschutzes.
...
*  **Recht auf Bestätigung und Auskunft** (**ARCO-Rechte**): das Bestehen einer Verarbeitung zu bestätigen und auf die personenbezogenen Daten zuzugreifen;
*  **Recht auf Berichtigung** (**ARCO-Rechte**): unrichtige, unvollständige oder nicht aktuelle Daten zu berichtigen;
*  **Recht auf Löschung** (**ARCO-Rechte**): die Löschung nicht erforderlicher oder übermäßiger Daten zu verlangen;
*  **Widerspruchsrecht** (**ARCO-Rechte**): unrechtmäßigen oder nicht einwilligungsbasierten Verarbeitungen zu widersprechen;
*  **Recht auf Information**: klare Informationen über die Verarbeitungstätigkeiten zu erhalten;
*  **Recht auf Datenübertragbarkeit**: die Übermittlung der Daten an einen anderen Diensteanbieter zu verlangen, insbesondere nach der brasilianischen LGPD;
*  **Recht auf Widerruf der Einwilligung**: eine zuvor erteilte Einwilligung jederzeit zu widerrufen;
*  **Recht auf Überprüfung automatisierter Entscheidungen**: die Überprüfung von Entscheidungen zu verlangen, die ausschließlich mittels automatisierter Verarbeitung getroffen wurden, nach der LGPD.
...
*  **Nationale Datenschutzbehörde Brasiliens (ANPD)** (https://www.gov.br/anpd/);
*  **Instituto Nacional de Transparencia, Acceso a la Información y Protección de Datos Personales (INAI) Mexikos** (https://home.inai.org.mx/);
*  **Agencia de Acceso a la Información Pública (AAIP) Argentiniens** (https://www.argentina.gob.ar/aaip);
*  **Superintendencia de Industria y Comercio (SIC) Kolumbiens** (https://www.sic.gov.co/);
* weitere zuständige nationale Behörden, soweit anwendbar.
...
*  **Spaarkly gewährleistet, dass die Sitzungs- und Gerätedaten innerhalb von 14 Monaten anonymisiert werden**, in Übereinstimmung mit den besten Praktiken.
* Es werden robuste **technische und organisatorische Maßnahmen** getroffen, um unbefugte Zugriffe, Datenlecks oder Missbrauch zu verhindern, wie von den lateinamerikanischen Gesetzen gefordert, etwa Art. 46 der brasilianischen LGPD und Art. 19 der mexikanischen LFPDPPP.

### Meldepflichten im Fall einer Datenschutzverletzung

* Im Fall einer **Datenschutzverletzung, die ein Risiko oder einen Schaden für die betroffenen Personen verursachen kann**, benachrichtigt Spaarkly:
  * die **zuständige Datenschutzbehörde** nach Maßgabe der lokalen Anforderungen:
    *  **Brasilien**: Benachrichtigung der ANPD innerhalb von 3 Werktagen ab Kenntnis des Vorfalls, gemäß der Resolução CD/ANPD Nr. 15/2024;
    *  **Mexiko**: unverzügliche Benachrichtigung der betroffenen Personen nach Bestätigung der Verletzung;
    * weitere Rechtsordnungen nach den jeweiligen Anforderungen.
*  **Da Spaarkly keine Kontaktinformationen der Nutzer erhebt, ist der Versand individueller Benachrichtigungen unmittelbar nicht möglich**. Soweit gesetzlich vorgeschrieben, veröffentlicht Spaarkly eine **öffentliche Bekanntmachung** auf ihrer Website oder über andere geeignete Kanäle.
...
* die Gewährleistung der Einhaltung besonderer Übermittlungsbestimmungen, etwa:
  * der Anforderungen der **brasilianischen LGPD** für internationale Übermittlungen (Artikel 33–36);
  * der Grundsätze der **mexikanischen LFPDPPP** für die grenzüberschreitende Datenweitergabe;
  * des argentinischen Erfordernisses eines **angemessenen Niveaus** nach dem PDPA;
  * der Anforderungen der **kolumbianischen SIC** für grenzüberschreitende Übermittlungen;
* die Umsetzung rechtlich anerkannter Übermittlungsmechanismen, etwa:
  * Standardvertragsklauseln;
  * verbindliche interne Datenschutzvorschriften;
  * Zertifizierungsmechanismen;
  * besondere Einwilligung in die Übermittlung;
...
*  **Recht auf Offenlegung** (*Kaiji*): die Offenlegung der von einem Geschäftsbetreiber gehaltenen personenbezogenen Daten zu verlangen;
*  **Recht auf Berichtigung** (*Seigō*): die Berichtigung, Ergänzung oder Löschung unrichtiger personenbezogener Daten zu verlangen;
*  **Recht auf Aussetzung der Nutzung/Löschung** (*Riyō Teishi / Sakujo*): die Aussetzung der Nutzung oder die Löschung personenbezogener Daten zu verlangen, die unter Verstoß gegen das Gesetz oder über den festgelegten Zweck hinaus verarbeitet werden;
*  **Recht auf Aussetzung der Weitergabe an Dritte** (*Daisansha Teikyō no Teishi*): vom Betreiber zu verlangen, die Weitergabe personenbezogener Daten an Dritte einzustellen;
*  **Recht auf Erläuterung** (*Setsumei*): eine Erläuterung der Verarbeitungstätigkeiten in Bezug auf die personenbezogenen Daten zu erhalten;
*  **Beschwerderecht** (*Kujō*): Beschwerde beim Betreiber oder bei der PPC einzulegen.
...
*  **Personal Information Protection Commission (PPC) Japans** (https://www.ppc.go.jp/en/).
...
*  **Spaarkly gewährleistet, dass die Sitzungs- und Gerätedaten innerhalb von 14 Monaten anonymisiert werden**, in Übereinstimmung mit den besten Praktiken.
*  **Spaarkly setzt umfassende Sicherheitsmaßnahmen um**, wie von Art. 23 APPI gefordert, darunter:
...
* Schulung des Personals im Bereich des Datenschutzes.

### Meldepflichten im Fall einer Datenschutzverletzung

* Im Fall eines **Verlusts personenbezogener Daten oder eines sonstigen Sicherheitsvorfalls** (*Jōhō Rōei Jiko*) wird Spaarkly:
  * eine **unverzügliche Meldung an die PPC** gemäß Art. 26 APPI vornehmen, sofern die Verletzung die Meldeschwelle erreicht;
  * in die Meldung die Einzelheiten des Vorfalls, die Arten der betroffenen Daten, die Ursache und die Abhilfemaßnahmen aufnehmen;
  * soweit gesetzlich vorgeschrieben, eine **öffentliche Bekanntmachung** auf der Website von Spaarkly oder über andere geeignete Kanäle veröffentlichen, da **unmittelbare individuelle Benachrichtigungen nicht möglich sind**, da keine Kontaktdaten erhoben werden.
...
* die Gewährleistung der Einhaltung von Art. 28 APPI im Bereich internationaler Übermittlungen, der Folgendes verlangt:
  * die vorherige Einwilligung der Person für Übermittlungen an Dritte in ausländischen Staaten; oder
  * die Gewährleistung, dass sich der Dritte in einem Land mit gleichwertigen Standards zum Schutz personenbezogener Daten befindet; oder
  * die Gewährleistung, dass der Dritte gleichwertige Standards mittels vertraglicher Vereinbarungen oder anderer Mittel aufrechterhält;
* die Umsetzung geeigneter Übermittlungsmechanismen, etwa:
  * Standardvertragsklauseln;
  * verbindliche interne Datenschutzvorschriften;
  * anerkannte Zertifizierungen;
* die Bereitstellung klarer Informationen für die Nutzer über potenzielle grenzüberschreitende Übermittlungen in Übereinstimmung mit den Anforderungen des APPI.
...
*  **Auskunftsrecht**: eine Kopie ihrer personenbezogenen Daten zu verlangen;
*  **Recht auf Berichtigung**: die Berichtigung unrichtiger oder unvollständiger Daten zu verlangen;
*  **Recht auf Löschung**: die Löschung der personenbezogenen Daten unter bestimmten Bedingungen zu verlangen;
*  **Recht auf Einschränkung oder Widerspruch gegen die Verarbeitung**: bestimmten Verarbeitungstätigkeiten zu widersprechen;
*  **Recht auf Widerruf der Einwilligung**: eine zuvor erteilte Einwilligung jederzeit zu widerrufen.

Darüber hinaus **erkennt das PIPL Rechte an, die über die DSGVO hinausgehen**, darunter:

*  **Recht auf „Kenntnis und Entscheidung"**: Die Nutzer haben ausdrückliche Kontrolle darüber, wie ihre Daten verwendet werden;
*  **Recht auf Erläuterung automatisierter Entscheidungen**: Die Nutzer können eine Erläuterung darüber verlangen, wie automatisierte Systeme, etwa KI-gestützte Empfehlungen, sich auf sie auswirken.
...
* die **zuständigen chinesischen Regulierungsbehörden**, soweit dies nach dem **PIPL** erforderlich ist;
* soweit gesetzlich vorgeschrieben, wird eine **öffentliche Bekanntmachung** auf der Website von Spaarkly oder über andere geeignete Kanäle veröffentlicht.
...
*  die **Durchführung einer Sicherheitsbewertung** nach den CAC-Vorschriften, soweit erforderlich;
*  die **Umsetzung von der CAC genehmigter Standardvertragsklauseln (SCC)** oder anderer genehmigter Mechanismen;
*  die **Einholung der ausdrücklichen Einwilligung des Nutzers** für etwaige grenzüberschreitende Übermittlungen, sofern dies für erforderlich erachtet wird.
...
*  **Auskunftsrecht**: eine Kopie ihrer personenbezogenen Daten zu verlangen;
*  **Recht auf Berichtigung**: die Berichtigung unrichtiger oder unvollständiger Daten zu verlangen;
*  **Recht auf Löschung**: die Löschung der personenbezogenen Daten in bestimmten Fällen zu verlangen;
*  **Recht auf Einschränkung oder Widerspruch gegen die Verarbeitung**: bestimmten Verarbeitungstätigkeiten zu widersprechen;
*  **Recht auf Widerruf der Einwilligung**: eine zuvor erteilte Einwilligung jederzeit zu widerrufen.

Die Nutzer können ihre Rechte ausüben, indem sie sich an **privacy@spaarkly.com** wenden. Sind sie mit der Antwort von Spaarkly nicht zufrieden, können sie sich an den **Information Regulator of South Africa** ([https://inforegulator.org.za/](https://inforegulator.org.za/)) wenden.
...
*  **Spaarkly gewährleistet, dass die Sitzungs- und Gerätedaten innerhalb von 14 Monaten anonymisiert werden**.
* Es werden robuste **technische und organisatorische Maßnahmen** getroffen, um unbefugte Zugriffe, Datenlecks oder Missbrauch zu verhindern.
...
* den **Information Regulator of South Africa**, soweit dies nach dem **POPIA** erforderlich ist;
* soweit gesetzlich vorgeschrieben, wird eine **öffentliche Bekanntmachung** auf der Website von Spaarkly oder über andere geeignete Kanäle veröffentlicht.
...
*  die **Gewährleistung, dass jede Datenübermittlung Section 72 des POPIA entspricht**, die einen angemessenen Schutz verlangt;
*  die **Umsetzung von Standardvertragsklauseln (SCC)** oder anderen rechtlich anerkannten Übermittlungsmechanismen, soweit erforderlich;
*  die **Einholung der ausdrücklichen Einwilligung des Nutzers** für etwaige grenzüberschreitende Übermittlungen, sofern dies zu einer gesetzlichen Anforderung wird.
...
*  **Auskunftsrecht**: eine Zusammenfassung der verarbeiteten personenbezogenen Daten zu verlangen;
*  **Recht auf Berichtigung**: die Berichtigung unrichtiger oder unvollständiger Daten zu verlangen;
*  **Recht auf Löschung**: die Löschung der personenbezogenen Daten unter bestimmten Bedingungen zu verlangen;
*  **Recht auf Einschränkung oder Widerspruch gegen die Verarbeitung**: bestimmten Verarbeitungstätigkeiten zu widersprechen;
*  **Recht, einen Vertreter zu benennen**: eine andere Person zu bestimmen, die die eigenen Rechte im Fall des Todes oder der Geschäftsunfähigkeit ausübt.
...
*  **Spaarkly gewährleistet, dass die Sitzungs- und Gerätedaten innerhalb von 14 Monaten anonymisiert werden**, im Einklang mit den besten Praktiken.
* Es werden robuste **technische und organisatorische Maßnahmen** getroffen, um unbefugte Zugriffe, Datenlecks oder Missbrauch zu verhindern.

### Meldepflichten im Fall einer Datenschutzverletzung

* Im Fall einer **Verletzung des Schutzes personenbezogener Daten** benachrichtigt Spaarkly:
  * das **Data Protection Board of India** sowie, wie vom **DPDP** gefordert, die betroffenen Personen;
  * da keine Kontaktdaten der Nutzer vorliegen, erfolgt die Benachrichtigung der betroffenen Personen mittels **öffentlicher Bekanntmachung** auf der Website von Spaarkly und, soweit möglich, mittels eines Hinweises innerhalb des Dienstes, als dem wirksamsten verfügbaren Mittel.
...
*  die **Gewährleistung der Einhaltung der DPDP-Anforderungen im Bereich der Datenlokalisierung und -übermittlung**;
*  die **Umsetzung rechtlich anerkannter Übermittlungsmechanismen**, etwa von der Regierung genehmigter Vertragsklauseln;
*  die **Einholung der ausdrücklichen Einwilligung des Nutzers** für etwaige grenzüberschreitende Übermittlungen, sofern dies zu einer gesetzlichen Anforderung wird.
...
*  **Vereinigte Arabische Emirate (VAE)**: **Federal Decree-Law No. 45 of 2021 on the Protection of Personal Data**;
...
*  **weitere anwendbare nationale Datenschutzvorschriften**.
...
*  **Recht auf Berichtigung**: die Berichtigung unrichtiger oder unvollständiger Daten zu verlangen;
*  **Recht auf Löschung**: die Löschung der personenbezogenen Daten unter bestimmten Bedingungen zu verlangen;
*  **Widerspruchsrecht**: bestimmten Arten der Verarbeitung zu widersprechen;
*  **Recht auf Widerruf der Einwilligung**: eine zuvor erteilte Einwilligung jederzeit zu widerrufen.
...
*  das **UAE Data Office**;
*  den **DIFC Commissioner of Data Protection** (https://www.difc.ae/business/regulations/data-protection/);
*  die **Saudi Data & Artificial Intelligence Authority (SDAIA)**, die zuständige Behörde nach dem saudischen Personal Data Protection Law (PDPL).
...
* Im Fall einer **Datenschutzverletzung, die erhebliche Schäden verursachen kann**, benachrichtigt Spaarkly:
  * die **zuständige Datenschutzbehörde des Nahen Ostens**, soweit dies nach lokalem Recht erforderlich ist;
  * soweit gesetzlich vorgeschrieben, wird eine **öffentliche Bekanntmachung** auf der Website von Spaarkly oder über andere geeignete Kanäle veröffentlicht.
*  **Da Spaarkly keine Kontaktinformationen der Nutzer erhebt, ist der Versand individueller Benachrichtigungen nicht möglich**.
...
*  die **Gewährleistung der Einhaltung der lokalen Datenschutzgesetze im Bereich internationaler Übermittlungen**;
*  die **Umsetzung rechtlich anerkannter Übermittlungsmechanismen**, etwa Standardvertragsklauseln (SCC) oder von der Regierung genehmigter Rahmenwerke;
*  die **Einholung der ausdrücklichen Einwilligung des Nutzers** für etwaige grenzüberschreitende Übermittlungen, sofern dies zu einer gesetzlichen Anforderung wird.
...
*  **auf ihre personenbezogenen Daten zuzugreifen** und eine Kopie davon zu verlangen;
*  **Berichtigungen** unrichtiger oder unvollständiger Daten zu **verlangen**;
*  die **Löschung** der personenbezogenen Daten unter bestimmten Bedingungen zu **verlangen**;
*  **bestimmten Verarbeitungstätigkeiten zu widersprechen**;
*  die **Einwilligung zu widerrufen**, soweit anwendbar.
...
* Spaarkly gewährleistet, dass die Sitzungs- und Gerätedaten innerhalb von **14 Monaten** anonymisiert werden, im Einklang mit den besten Praktiken.
* Es werden strenge technische und organisatorische Maßnahmen getroffen, um unbefugte Zugriffe, Datenlecks oder Missbrauch zu verhindern.

### Meldepflichten im Fall einer Datenschutzverletzung

Im Fall einer Datenschutzverletzung, die einen erheblichen Schaden verursachen kann, benachrichtigt Spaarkly:

* Die zuständige Datenschutzbehörde, soweit dies nach lokalem Recht erforderlich ist.
* Soweit gesetzlich verpflichtet, veröffentlicht Spaarkly eine öffentliche Bekanntmachung auf ihrer Website oder über andere geeignete Kanäle.
...
* Die Gewährleistung der Einhaltung der **lokalen Datenschutzgesetze im Bereich internationaler Übermittlungen**.
* Die Umsetzung **rechtlich anerkannter Übermittlungsmechanismen**, etwa **Standardvertragsklauseln (SCC)** oder von der Regierung genehmigter Rahmenwerke.
* Die Einholung der **ausdrücklichen Einwilligung der Nutzer** für etwaige grenzüberschreitende Übermittlungen, sofern dies zu einer gesetzlichen Pflicht wird.

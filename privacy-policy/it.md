# INFORMATIVA PRIVACY ARSHADES

*Soluzioni ARShades* </br> *Ultimo aggiornamento: 07 luglio 2026*
...
*  **ARShades Virtual Try-On** (“ARShades VTO”, “VTO”, “Web VTO”, “VTO App”, “Applicazioni e Servizi”);
*  **ARShades VTO Explorer** (“VTO Explorer”), quale modulo o funzionalità integrabile in esperienze ARShades web, mobile, catalogo, e-commerce, mirror, showroom o in-store;
*  **AR PD Meter**;
*  **ARShades Mirror** (“Mirror”);
*  **ARShades Gateway** (“Gateway”, “Applicazione Standalone”).
...
*  **Dati Personali**: qualsiasi informazione relativa a una persona fisica identificabile, inclusi indirizzo IP, email e altri dati forniti volontariamente dall’utente.
*  **Dati di Sessione**: informazioni raccolte durante una sessione utente, quali timestamp di interazione, pagine consultate e statistiche di utilizzo. Sono conservati fino a **14 mesi** prima dell’anonimizzazione.
*  **Dati del Dispositivo**: informazioni tecniche sul dispositivo dell’utente, inclusi **tipo di dispositivo, sistema operativo, versione del browser e lingua preferita**. Sono utilizzati per l’ottimizzazione e la sicurezza del servizio.
*  **Dati di Geolocalizzazione**: previo consenso dell’utente, ARShades può raccogliere la posizione approssimativa basata su **indirizzo IP** oppure, nelle applicazioni standalone, la **posizione GPS precisa**, al fine di fornire servizi basati sulla posizione. Gli utenti possono disabilitare tale funzionalità in qualsiasi momento.
*  **Titolare del trattamento**: Spaarkly s.r.l., che determina le finalità e i mezzi del trattamento dei dati personali.
*  **Trattamento**: qualsiasi operazione effettuata sui dati personali, inclusa **raccolta, conservazione, anonimizzazione e cancellazione**.
*  **Cookie e tecnologie di tracciamento**: cookie essenziali necessari al funzionamento del servizio e strumenti analytics opzionali, se abilitati dall’utente. Non vengono utilizzati cookie di marketing.
*  **Diritti dell’Interessato**: gli Utenti possono **accedere, rettificare, cancellare o limitare** il trattamento dei propri dati secondo quanto previsto dal GDPR, dal CCPA e da normative analoghe. Le richieste possono essere inviate a **privacy@spaarkly.com**.
*  **Trasferimenti internazionali di dati**: qualora dati personali siano trasferiti al di fuori dello **Spazio Economico Europeo (SEE)**, Spaarkly garantisce la conformità mediante **Clausole Contrattuali Standard (SCC)** o garanzie equivalenti.
*  **ARShades VTO**: soluzione di **virtual try-on (VTO)** che consente agli utenti di visualizzare in che modo gli occhiali si adattano al volto in **realtà aumentata (AR) in tempo reale**. Funziona su **dispositivi web e mobile** senza conservare dati biometrici.
*  **ARShades VTO Explorer**: modulo di virtual try-on fotografico e catalogo aumentato che consente agli Utenti di generare anteprime realistiche e personalizzate di più prodotti eyewear a partire da un numero limitato di immagini acquisite durante la sessione. VTO Explorer può essere integrato in soluzioni ARShades web, mobile, cataloghi, mirror o altre esperienze in-store. Le immagini acquisite sono trattate localmente sul dispositivo dell’Utente o sul dispositivo utilizzato per l’esperienza e non sono caricate automaticamente sui server di Spaarkly. Quando VTO Explorer è utilizzato su un dispositivo installato in un punto vendita, showroom, sede di evento o altro luogo pubblico, e l’Utente sceglie di ottenere, scaricare o condividere sul proprio dispositivo le foto finali, solo le foto finali selezionate dall’Utente possono essere temporaneamente caricate sui server di Spaarkly esclusivamente per renderle disponibili all’Utente, e sono cancellate secondo quanto descritto nella presente Informativa.
*  **AR PD Meter**: strumento di misurazione della **distanza pupillare (PD)** che stima la distanza tra le pupille dell’utente mediante **AR e rilevamento di landmark facciali**. Le immagini e i flussi video della fotocamera non sono conservati, non sono utilizzati per identificazione biometrica e non sono usati per creare template facciali. Per calcolare la distanza pupillare, AR PD Meter può trasmettere temporaneamente al backend ARShades, situato nell’Unione Europea, dati tecnici derivati quali landmark facciali, orientamento del volto, informazioni tecniche del dispositivo e parametri necessari al calcolo. Tali dati sono utilizzati esclusivamente per restituire il risultato della misurazione e sono scartati dopo l’elaborazione. Quando AR PD Meter è utilizzato nell’ambito di ARShades Mirror (ad esempio a supporto dell’esperienza VTO Explorer in Mirror Showroom), tali dati tecnici derivati sono elaborati dal backend locale del dispositivo, senza trasmissione a server cloud, e cancellati dopo l’elaborazione.
*  **ARShades Mirror**: esperienza di virtual try-on per il retail disponibile tramite **specchi digitali e chioschi in-store**, che consente agli utenti di navigare cataloghi virtuali eyewear e provare occhiali in AR senza richiedere la conservazione di dati personali.
*  **ARShades Gateway**: piattaforma AR **standalone** che fornisce, tra l’altro, un’esperienza di **virtual try-on**. Può opzionalmente **utilizzare la geolocalizzazione, previo consenso**, per personalizzare le raccomandazioni.

## 1\. FINALITÀ DEL TRATTAMENTO E BASE GIURIDICA

### a) Soluzioni ARShades su dispositivi di proprietà dell’Utente
...
*  **Fornitura dei Servizi VTO**: consentire all’Utente di provare virtualmente montature eyewear, testare forme e dimensioni e utilizzare strumenti quali la misurazione della distanza pupillare (**base giuridica: esecuzione di un contratto o di misure precontrattuali richieste dall’Utente, ai sensi dell’art. 6, par. 1, lett. b) GDPR**).
*  **Miglioramento del servizio, analytics, sicurezza e prevenzione delle frodi**: migliorare la qualità, l’usabilità, la comprensione analitica e la sicurezza dei nostri Servizi, generare statistiche anonime sull’uso e sulle prestazioni delle esperienze ARShades, prevenire usi illeciti e frodi e garantire l’integrità delle reti e dei sistemi (**base giuridica: legittimo interesse, art. 6, par. 1, lett. f) GDPR**).
*  **Adempimento di obblighi legali**: adempiere a obblighi di legge o a ordini di autorità competenti in materia di conservazione dei dati, sicurezza e altri requisiti normativi (**base giuridica: obbligo legale, art. 6, par. 1, lett. c) GDPR**).
*  **Consenso, ove applicabile**: laddove sia richiesto il consenso, ad esempio per l’accesso alla fotocamera o per eventuali strumenti opzionali di analytics, ove disponibili, il trattamento sarà basato sul consenso (art. 6, par. 1, lett. a) GDPR), revocabile in qualsiasi momento senza pregiudicare la liceità del trattamento effettuato prima della revoca.
...
### b) Soluzioni ARShades su dispositivi installati in punti vendita, showroom o luoghi pubblici (VTO Mirror)
...
*  **Fornitura dei Servizi VTO**: consentire all’Utente di provare virtualmente montature eyewear, testare forme e dimensioni e utilizzare strumenti quali la misurazione della distanza pupillare (base giuridica: esecuzione di un contratto o di misure precontrattuali richieste dall’interessato, ai sensi dell’art. 6, par. 1, lett. b) GDPR).
*  **Miglioramento del servizio, analytics, sicurezza e prevenzione delle frodi**: migliorare la qualità, l’usabilità, la comprensione analitica e la sicurezza dei nostri Servizi, generare statistiche anonime sull’uso e sulle prestazioni delle esperienze ARShades, prevenire usi illeciti e frodi e garantire l’integrità delle reti e dei sistemi (base giuridica: legittimo interesse, art. 6, par. 1, lett. f) GDPR).
*  **Obblighi legali**: adempiere a obblighi di legge o a ordini delle autorità competenti in materia di conservazione dei dati, sicurezza e altri requisiti normativi (base giuridica: obbligo legale, art. 6, par. 1, lett. c) GDPR).
*  **Consenso, ove applicabile**: laddove sia richiesto il consenso, ad esempio per l’accesso alla fotocamera, per l’acquisizione delle immagini necessarie all’utilizzo del modulo VTO Explorer o per la conservazione temporanea delle foto finali selezionate dall’Utente per il download o la condivisione tramite funzionalità quali “Shoot & Share” o funzioni equivalenti di download, il trattamento sarà basato sul consenso (art. 6, par. 1, lett. a) GDPR), revocabile in qualsiasi momento senza pregiudicare la liceità del trattamento effettuato prima della revoca.

## 2\. COME FUNZIONA ARSHADES VTO
...
* opera su punti matematici anonimi comuni a tutti i volti;
* non utilizza le misurazioni per identificare specifiche persone, né le misurazioni sono, di per sé, idonee a identificarle;
* non utilizza né conserva dati per finalità di riconoscimento facciale;
* tratta i dati facciali del Virtual Try-On localmente sul dispositivo dell’Utente, senza conservazione lato server;
* per AR PD Meter, utilizza temporaneamente dati tecnici derivati sul backend ARShades solo per calcolare e restituire il risultato PD, scartandoli dopo l’elaborazione.
...
#### Come raccogliamo e gestiamo il consenso
...
### Dati di misurazione facciale

Il sistema calcola in tempo reale le seguenti dimensioni facciali:

* distanza pupillare;
* lunghezza della mandibola;
* larghezza e altezza della fronte;
* lunghezza e larghezza del naso;
* altezza degli zigomi;
* larghezza del volto in corrispondenza degli zigomi;
* larghezza del volto in corrispondenza della bocca;
* lunghezza del mento;
* lunghezza complessiva del volto.
...
### Dati del dispositivo e di sessione
...
* sistema operativo;
* lingua preferita;
* brand e prodotti visualizzati;
* date e orari di accesso;
* statistiche anonime sulle interazioni con l’app VTO, ad esempio se l’Utente indossa occhiali.

Tali dati sono raccolti per migliorare i Servizi, garantire la sicurezza e analizzare l’utilizzo delle nostre soluzioni.

### Immagini facciali o dati biometrici
...
### Foto finali selezionate dall’Utente
...
### Dati di geolocalizzazione nelle applicazioni standalone (ARShades Gateway)
...
*  **Geolocalizzazione precisa**: previo consenso esplicito, specifiche applicazioni standalone ARShades possono raccogliere coordinate precise di geolocalizzazione dal dispositivo per fornire servizi o raccomandazioni basati sulla posizione.
*  **Posizione approssimativa**: in assenza di consenso esplicito alla posizione precisa, possiamo inferire una posizione approssimativa sulla base dell’indirizzo IP.

La raccolta dei dati di geolocalizzazione nelle applicazioni standalone è:

*  **facoltativa**: è possibile rifiutare i permessi di localizzazione senza pregiudicare le funzionalità VTO principali;
*  **basata sul consenso**: la geolocalizzazione precisa è raccolta solo previo consenso esplicito;
*  **limitata alle finalità**: utilizzata solo per fornire raccomandazioni eyewear pertinenti o servizi basati sulla posizione;
*  **soggetta alla stessa politica di conservazione**: anonimizzata entro 14 mesi insieme agli altri dati tecnici.

#### Gestione del consenso alla geolocalizzazione
...
* ricordata localmente dal browser per visite future alla stessa applicazione;
* impostata in modo da chiedere ogni volta;
* concessa temporaneamente solo per la sessione corrente.
...
## 5\. TRATTAMENTO DEI DATI IN ARSHADES VTO MIRROR
...
* Le immagini acquisite per virtual try-on, personalizzazione, generazione del catalogo, adattamento facciale, segmentazione, posizionamento del prodotto e rendering sono trattate localmente sul dispositivo senza trasferimento automatico ai server di Spaarkly.
* Nelle versioni di VTO Mirror che includono il modulo **VTO Explorer**, come **Mirror Showroom**, le immagini acquisite durante la fase di personalizzazione sono utilizzate localmente per generare anteprime del catalogo aumentato e non sono caricate sui server di Spaarkly.
* Solo quando l’Utente sceglie attivamente di ottenere, scaricare o condividere foto finali che lo ritraggono con indosso gli occhiali selezionati da un dispositivo installato in un punto vendita, showroom, sede di evento o altro luogo pubblico, tali foto finali selezionate possono essere temporaneamente caricate sui server di Spaarkly esclusivamente per renderle disponibili all’Utente sul proprio dispositivo.
* Il titolare del punto vendita non ha accesso diretto ai dati o alle immagini generate dagli Utenti, poiché l’accesso al software è limitato esclusivamente ad ARShades.
* ARShades si impegna a non accedere ai dati dell’Utente salvo quando necessario per specifiche attività di manutenzione tecnica, sempre senza visualizzare o trattare le immagini acquisite.
* Spaarkly non comunica i dati degli Utenti a terze parti per finalità proprie di queste ultime. Per l’hosting e l’erogazione dei servizi, Spaarkly può avvalersi di qualificati fornitori di infrastruttura cloud, con server situati nell’Unione Europea, nominati responsabili del trattamento ai sensi dell’art. 28 GDPR e vincolati da appositi accordi sul trattamento dei dati. Le attività di trattamento sono svolte esclusivamente da personale autorizzato di Spaarkly e da tali fornitori, nei limiti delle istruzioni impartite.

### Cancellazione automatica e misure di sicurezza

* Le foto finali temporaneamente caricate tramite **VTO Mirror**, **VTO Explorer**, “Shoot & Share” o funzionalità equivalenti di download/condivisione da dispositivi installati in punti vendita, showroom, sedi di evento o altri luoghi pubblici possono essere cancellate immediatamente dai nostri server dagli Utenti dopo essere state scaricate sul proprio dispositivo, ove tale opzione sia disponibile. Se gli Utenti non cancellano manualmente le proprie foto, il nostro sistema le rimuove automaticamente dopo **24 ore** tramite uno script dedicato, senza intervento manuale.
* I dati temporaneamente conservati sono **cifrati a riposo e in transito** per garantirne la sicurezza.
* Tutti gli accessi ai dispositivi ARShades per manutenzione tecnica sono registrati in un **registro degli accessi** in conformità all’**art. 5, par. 1, lett. f) GDPR**.
* Il software è configurato per limitare l’accesso ai dati esclusivamente al **personale autorizzato ARShades**.

### Ruolo di ARShades e del punto vendita

*  **ARShades rimane l’unico Titolare del trattamento** dei dati generati tramite VTO Mirror.
* Il **punto vendita non tratta i dati degli utenti**, poiché non ha accesso ai dati generati né alla gestione del software.

## 6\. RACCOLTA DEI DATI E PERIODO DI CONSERVAZIONE

* I **dati di misurazione facciale** sono raccolti localmente sul dispositivo dell’Utente per il Virtual Try-On e conservati solo per il tempo necessario a fornire i servizi ARShades VTO. Per AR PD Meter, i dati tecnici derivati necessari al calcolo della distanza pupillare possono essere trasmessi temporaneamente al backend ARShades situato nell’UE, utilizzati solo per restituire il risultato della misurazione e scartati dopo l’elaborazione.
* I **dati di sessione e del dispositivo** sono conservati sui server di Spaarkly, situati all’interno dell’UE. Gli **indirizzi IP sono cancellati e pienamente dissociati da tutti gli altri dati entro 14 mesi**. Solo dati aggregati e anonimizzati sono conservati per analisi statistiche.
* Il periodo di conservazione dei dati personali può essere esteso in casi eccezionali, ad esempio per adempiere a obblighi di legge o per finalità di prevenzione delle frodi.

## 7\. COOKIE POLICY

ARShades utilizza solo **cookie strettamente necessari**, essenziali per il funzionamento dei nostri servizi. Tali cookie:

* abilitano **funzionalità di base del sito**, quali gestione della sessione e sicurezza;
*  **non** tracciano gli utenti su siti web diversi;
*  **non** sono utilizzati per analytics, marketing o tracciamento di terze parti.
...
### Cookie strettamente necessari utilizzati

|Nome cookie|Durata|Finalità|
|---|---|---|
|<b>visited</b>|90 giorni|Identifica se l’Utente ha già utilizzato il servizio.|
|<b>consent</b>|120 minuti|Identifica se l’Utente ha fornito il consenso all’Informativa Privacy e ai Termini e Condizioni per l’utilizzo di ARShades.|
|<b>lang</b>|90 giorni|Memorizza e ricorda la lingua preferita dall’utente tra le sessioni del browser.|

### Tecnologie di conservazione utilizzate
...
## 8\. NATURA DEL CONFERIMENTO DEI DATI E CONSEGUENZE DEL MANCATO CONFERIMENTO
...
*  **firewall**;
*  **server sicuri**;
*  **sistemi di gestione degli accessi** per prevenire accessi non autorizzati a sistemi e dati.
...
### Protocollo in caso di violazione della sicurezza
...
*  **valuterà il livello di rischio** ai sensi dell’**art. 33 GDPR**. Valuteremo ogni potenziale violazione in conformità all’art. 33 GDPR e notificheremo la competente **Autorità di controllo** entro **72 ore** ove richiesto dalla legge applicabile;
*  **a causa dell’assenza di dati personali di contatto**, non siamo **in grado di notificare direttamente i singoli utenti**. Ove richiesto, emetteremo invece un **avviso pubblico** tramite il nostro sito ufficiale o altri canali;
*  **mitigherà e risolverà** l’incidente nel più breve tempo possibile, implementando, ove necessario, ulteriori misure di salvaguardia.
...
* Richiedere conferma che sia o meno in corso un trattamento dei propri dati personali.
* Ottenere accesso alle informazioni pertinenti, quali finalità, categorie di dati trattati, destinatari o categorie di destinatari, periodo di conservazione, ecc.
...
* Richiedere la cancellazione dei dati personali se:
  * i dati non sono più necessari rispetto alle finalità per cui sono stati raccolti;
  * viene revocato il consenso, ove il trattamento sia basato sul consenso;
  * i dati sono stati trattati illecitamente.

### Diritto alla limitazione del trattamento

* Richiedere la limitazione del trattamento se:
  * si contesta l’esattezza dei dati;
  * il trattamento è illecito, ma ci si oppone alla cancellazione;
  * i dati sono necessari per l’accertamento, l’esercizio o la difesa di un diritto in sede giudiziaria, anche se il Titolare non ne ha più bisogno;
  * ci si oppone al trattamento, in attesa della verifica dei motivi legittimi.

### Diritto alla portabilità dei dati

* Ricevere i propri dati personali in un formato strutturato, di uso comune e leggibile da dispositivo automatico.
* Richiedere la trasmissione diretta a un altro Titolare, ove tecnicamente fattibile.
...
* Revocare il consenso **in qualsiasi momento** quando il trattamento è basato sul consenso.

### Interfaccia di gestione del consenso
...
* visualizzare lo stato attuale del proprio consenso;
* accedere alla nostra Informativa Privacy completa;
...
* il **Garante per la Protezione dei Dati Personali** italiano: **[www.garanteprivacy.it](http://www.garanteprivacy.it)**;
* un’altra **autorità di controllo competente** nel Suo Paese di residenza.

## 13\. MODIFICHE ALLA PRESENTE INFORMATIVA PRIVACY
...
## Introduzione agli Addenda Normativi
...
*  **diritti aggiuntivi o differenti** rispetto a quelli descritti nella Policy principale;
*  **modalità di esercizio di tali diritti**, inclusi contatti locali, procedure e tempi di risposta;
*  **eventuali requisiti aggiuntivi di consenso**;
*  **specifici requisiti di conservazione dei dati**;
*  **obblighi locali di notifica in caso di data breach**;
*  **regole sui trasferimenti di dati**, incluse clausole contrattuali standard e requisiti locali.
...
### Indice degli Addenda regionali e nazionali

 1. [Unione Europea / Spazio Economico Europeo / Regno Unito](#a-regno-unito-uk-gdpr--unione-europea-e-spazio-economico-europeo-ue-see)
 2. [Svizzera](#b-svizzera-fadp--federal-act-on-data-protection)
 3. [Stati Uniti](#c-stati-uniti--addendum-usa)
 4. [Canada](#d-canada-pipeda--personal-information-protection-and-electronic-documents-act)
 5. [Australia e Nuova Zelanda](#e-australia-e-nuova-zelanda)
 6. [Regione Asia-Pacifico](#f-regione-asia-pacifico)
 7. [Brasile e America Latina](#g-brasile-e-america-latina)
 8. [Giappone](#h-giappone-appi--act-on-the-protection-of-personal-information)
 9. [Cina](#i-cina-pipl--personal-information-protection-law)
10. [Sudafrica](#j-sudafrica-popia--protection-of-personal-information-act)
11. [India](#k-india-dpdp--digital-personal-data-protection-act)
12. [Medio Oriente](#l-medio-oriente-emirati-arabi-uniti--dubai--arabia-saudita--altri-paesi)
13. [Altri Paesi](#m-altri-paesi)

## A. REGNO UNITO (UK GDPR) / UNIONE EUROPEA E SPAZIO ECONOMICO EUROPEO (UE/SEE)
...
*  **Utenti UE/SEE**: l’**Autorità Garante per la protezione dei dati** del rispettivo Stato membro.
*  **Utenti UK**: l’**Information Commissioner’s Office (ICO)** ([https://ico.org.uk/](https://ico.org.uk/)).
...
*  **Clausole Contrattuali Standard (SCC)** della Commissione Europea per i trasferimenti dall’UE/SEE;
*  **SCC approvate dall’ICO** per i trasferimenti dal Regno Unito;
*  **garanzie aggiuntive ove necessario**, in linea con le linee guida dell’European Data Protection Board (EDPB) e dell’ICO.
...
## B. SVIZZERA (FADP – FEDERAL ACT ON DATA PROTECTION)
...
*  **accedere** ai propri dati personali trattati da Spaarkly;
*  **richiedere la correzione** o la cancellazione di dati inesatti o non necessari;
...
* l’**Incaricato federale della protezione dei dati e della trasparenza (FDPIC)**;
* gli **interessati**, ove richiesto dalla legge svizzera.

### Trasferimenti internazionali di dati

I dati personali degli utenti svizzeri **non sono trasferiti al di fuori della Svizzera**, salvo che:

* il Paese di destinazione sia ritenuto dotato di un **livello adeguato di protezione** dalle autorità svizzere;
* siano implementate **Clausole Contrattuali Standard (SCC)** approvate dalla Commissione Europea per i trasferimenti verso UE/SEE;
* siano adottate altre **garanzie conformi al FADP svizzero** per proteggere i dati trasferiti.

## C. STATI UNITI — ADDENDUM USA
...
*  **Texas**: **Capture or Use of Biometric Identifier Act (CUBI)** e **Texas Data Privacy and Security Act (TDPSA)**;
*  **Washington**: legge sulla privacy biometrica (**RCW 19.375**);
*  **altre leggi statali applicabili in materia di privacy**.
...
### Diritti e normative specifici per Stato

#### 1\. California (CCPA/CPRA)

I residenti in California hanno diritto di:

*  **sapere** quali categorie di dati personali raccogliamo;
*  **comprendere** le finalità del trattamento;
*  **richiedere la cancellazione** dei propri dati personali, con le eccezioni consentite dalla legge;
*  **opporsi alla vendita o condivisione** dei propri dati, ove applicabile;
*  **non subire discriminazioni** per l’esercizio dei propri diritti privacy.

#### 2\. Virginia, Colorado, Connecticut, Utah, Montana e Oregon
...
* diritti di **opt-out** rispetto alla pubblicità mirata o alla vendita di dati personali, ove applicabile. Sebbene ARShades non svolga tali attività, i residenti in Montana e Oregon possono comunque richiedere conferma contattando Spaarkly.

#### 3\. Illinois (BIPA), Texas (CUBI), Washington (RCW 19.375)

*  **Spaarkly non raccoglie dati biometrici** come definiti da tali leggi.
* ARShades tratta esclusivamente **punti matematici di landmark facciali** per finalità di virtual try-on e, tramite AR PD Meter, di calcolo della distanza pupillare, i quali:
  *  **non possono essere utilizzati per identificare univocamente** una persona;
  * per il Virtual Try-On, sono **trattati localmente sul dispositivo dell’utente** e mai conservati;
  * per **AR PD Meter**, possono essere trasmessi temporaneamente, quali dati tecnici derivati non utilizzati per identificare l’Utente e non idonei, di per sé, a identificarlo, al backend ARShades situato nell’Unione Europea, utilizzati esclusivamente per restituire il risultato della misurazione e **scartati dopo l’elaborazione**, senza mai essere conservati;
  *  **non creano un identificativo persistente** collegato a un individuo.

#### 4\. Altri Stati USA

* Alcuni Stati **non dispongono ancora** di leggi privacy generali.
* In tali casi, **Spaarkly** segue i **principi generali descritti nella presente Informativa Privacy** e si conforma a qualsiasi normativa statale applicabile.

### Come esercitare i diritti

I residenti USA possono contattarci all’indirizzo **[privacy@spaarkly.com](mailto:privacy@spaarkly.com)**, specificando lo Stato di residenza.
...
#### Informativa e consenso specifici per gli Stati con normativa biometrica
...
* qualsiasi dato di misurazione facciale è trattato in tempo reale e non è mai conservato oltre la sessione immediata;
* i dati tecnici derivati trasmessi temporaneamente al backend ARShades per AR PD Meter sono utilizzati solo per restituire il risultato della misurazione e scartati dopo l’elaborazione;
* i dati di sessione e del dispositivo sono anonimizzati e dissociati entro 14 mesi.
...
### Regole sui trasferimenti di dati
...
### Rinuncia ad azioni collettive e al processo con giuria
...
### Conformità a PIPEDA e alle leggi provinciali sulla privacy

**Spaarkly opera in Canada e aderisce ai principi PIPEDA**. Il suo **attuale modello di trattamento dei dati** è il seguente:

*  i **dati facciali** utilizzati per il Virtual Try-On sono trattati **localmente sul dispositivo** e non sono conservati; per **AR PD Meter**, dati tecnici derivati, non utilizzati per identificare l’Utente e non idonei, di per sé, a identificarlo, possono essere trasmessi temporaneamente al backend ARShades situato nell’Unione Europea, utilizzati esclusivamente per restituire il risultato della misurazione e scartati dopo l’elaborazione;
*  **non sono raccolti dati biometrici o univocamente identificativi**, né nomi, dati di contatto o profili utente;
*  i **dati di sessione e del dispositivo** (incluso l’indirizzo IP) sono conservati su **server situati nell’Unione Europea** e anonimizzati entro 14 mesi; le eventuali foto finali richieste dall’Utente da dispositivi in-store sono cancellate entro 24 ore. Ciò può comportare un trasferimento di tali dati verso l’UE, con le garanzie descritte nella sezione “Trasferimenti internazionali” del presente Addendum.
...
### Diritti degli utenti ai sensi del PIPEDA

Gli utenti in **Canada** godono di diritti analoghi a quelli previsti dal **GDPR**, tra cui:

*  **diritto di accesso**: richiedere una copia dei propri dati personali e informazioni sul loro utilizzo;
*  **diritto di rettifica**: richiedere la correzione di dati inesatti o incompleti;
*  **diritto di revocare il consenso**: revocare il consenso precedentemente prestato in qualsiasi momento;
*  **diritto di contestare la conformità**: contestare la conformità di un’organizzazione ai principi PIPEDA;
*  **diritto di ricorso**: proporre reclamo all’autorità competente per la protezione dei dati.
...
* commissari provinciali per la privacy in **British Columbia, Alberta o Quebec**, ove applicabile.
...
*  **Spaarkly garantisce che i dati di sessione e del dispositivo siano anonimizzati entro 14 mesi**, in conformità alle migliori prassi.
* Sono adottate solide **misure tecniche e organizzative** per prevenire accessi non autorizzati, fughe di dati o usi impropri.

### Obblighi di notifica in caso di data breach

* In caso di **violazione dei dati che presenti un rischio reale di danno significativo**, Spaarkly notificherà:
  * l’**Office of the Privacy Commissioner of Canada (OPC)**;
  * i commissari provinciali per la privacy, ove richiesto dalla legge provinciale;
  * ove legalmente richiesto, una **comunicazione pubblica** sarà pubblicata sul sito di Spaarkly o tramite altri canali appropriati.
*  **Poiché Spaarkly non raccoglie informazioni di contatto degli utenti, non è possibile inviare notifiche individuali**.

### Trasferimenti internazionali e garanzia di conformità
...
* garantire la conformità al **principio di responsabilizzazione (Accountability)** del PIPEDA in relazione ai trasferimenti internazionali;
* implementare **Clausole Contrattuali Standard (SCC)** o altri meccanismi di trasferimento giuridicamente riconosciuti, ove necessario;
* fornire informazioni chiare e accessibili su potenziali trasferimenti transfrontalieri e sui rischi connessi.
...
## E. AUSTRALIA E NUOVA ZELANDA

Gli utenti in **Australia** e **Nuova Zelanda** sono protetti dalle rispettive leggi generali sulla privacy:

*  **Australia**: **Privacy Act 1988 (Cth)**, inclusi gli **Australian Privacy Principles (APPs)**, e **Privacy Amendment (Notifiable Data Breaches) Act 2017**;
*  **Nuova Zelanda**: **Privacy Act 2020**, inclusi gli **Information Privacy Principles (IPPs)**, regolato dall’**Office of the Privacy Commissioner (OPC)**.

### Conformità alle leggi privacy australiane e neozelandesi
...
### Diritti degli utenti ai sensi delle leggi privacy australiane e neozelandesi

Gli utenti in **Australia e Nuova Zelanda** hanno diritti privacy che includono:

*  **diritto di accesso**: richiedere accesso ai propri dati personali detenuti da un’organizzazione;
*  **diritto di correzione**: richiedere la correzione di dati inesatti, non aggiornati, incompleti o fuorvianti;
*  **diritto di opposizione**: opporsi a determinate tipologie di trattamento, in particolare marketing diretto in Australia e trattamenti suscettibili di causare danni, disagio o pregiudizi significativi in Nuova Zelanda;
*  **diritto di reclamo**: presentare reclamo all’autorità privacy competente qualora ritengano violati i propri diritti;
*  **diritto a rimedi**: ottenere rimedi per violazioni privacy, inclusi correzione, scuse o risarcimento, ove applicabile.
...
*  **Office of the Privacy Commissioner (OPC) della Nuova Zelanda** (https://www.privacy.org.nz/).
...
*  **Spaarkly garantisce che i dati di sessione e del dispositivo siano anonimizzati entro 14 mesi**, in conformità alle migliori prassi.
* Sono adottate solide **misure tecniche e organizzative** per prevenire accessi non autorizzati, fughe di dati o usi impropri, in conformità ad APP 11 in Australia e IPP 5 in Nuova Zelanda.

### Obblighi di notifica in caso di data breach

* In caso di **violazione dei dati idonea a determinare un danno grave** per gli interessati, Spaarkly notificherà:
  * l’**Office of the Australian Information Commissioner (OAIC)** ai sensi del regime **Notifiable Data Breaches (NDB)**, completando la valutazione dell’incidente entro 30 giorni e provvedendo alla notifica non appena ragionevolmente praticabile;
  * l’**Office of the Privacy Commissioner (OPC) della Nuova Zelanda** non appena possibile, in conformità ai requisiti obbligatori di notifica previsti dal Privacy Act 2020.
*  **Poiché Spaarkly non raccoglie informazioni di contatto degli utenti, non è possibile inviare notifiche individuali direttamente**. Ove legalmente richiesto, Spaarkly pubblicherà una **comunicazione pubblica** sul proprio sito web o tramite altri canali appropriati.
...
* garantire la conformità ad **APP 8** e alla **Section 16C dell’Australian Privacy Act** in materia di comunicazioni transfrontaliere;
* implementare le garanzie appropriate richieste da **IPP 12 del New Zealand Privacy Act 2020** per i trasferimenti verso l’estero;
* fornire informazioni chiare agli utenti sui potenziali trasferimenti transfrontalieri e mantenere la responsabilizzazione in materia di protezione dei dati.
...
*  **Singapore**: **Personal Data Protection Act (PDPA)** del 2012, come modificato nel 2020, applicato dalla **Personal Data Protection Commission (PDPC)**;
*  **Malaysia**: **Personal Data Protection Act (PDPA)** del 2010, applicato dal **Personal Data Protection Department (JPDP)**;
*  **Filippine**: **Data Privacy Act (DPA)** del 2012, applicato dalla **National Privacy Commission (NPC)**;
*  **Indonesia**: **Personal Data Protection Law (PDP Law)** del 2022, modellata sul GDPR;
*  **Thailandia**: **Personal Data Protection Act (PDPA)** del 2019, applicato dal **Personal Data Protection Committee (PDPC)**;
*  **Corea del Sud**: **Personal Information Protection Act (PIPA)**, applicato dalla **Personal Information Protection Commission (PIPC)**;
* altre giurisdizioni con quadri normativi emergenti in materia di protezione dei dati.

### Conformità alle leggi sulla protezione dei dati dell’Asia-Pacifico
...
### Diritti degli utenti ai sensi delle leggi privacy dell’Asia-Pacifico
...
*  **diritto di accesso**: richiedere informazioni sulla raccolta, l’uso e la comunicazione dei dati personali;
*  **diritto di correzione**: richiedere la correzione di dati personali inesatti o incompleti;
*  **diritto di revoca del consenso**: revocare il consenso precedentemente prestato;
*  **diritto alla portabilità dei dati**: richiedere il trasferimento dei dati a un’altra organizzazione, in giurisdizioni come Singapore e Filippine;
*  **diritto alla cancellazione**: richiedere la cancellazione dei dati personali in specifiche condizioni, a seconda della giurisdizione;
*  **diritto di opposizione**: opporsi al trattamento per marketing diretto o altre finalità, a seconda della giurisdizione.
...
*  **Personal Data Protection Commission (PDPC) di Singapore** (https://www.pdpc.gov.sg/);
*  **Personal Data Protection Department (JPDP) della Malaysia** (https://www.pdp.gov.my/);
*  **National Privacy Commission (NPC) delle Filippine** (https://privacy.gov.ph/);
*  **Personal Data Protection Committee (PDPC) della Thailandia**;
*  **Personal Information Protection Commission (PIPC) della Corea del Sud**;
* altre autorità nazionali competenti, ove applicabile.
...
*  **Spaarkly garantisce che i dati di sessione e del dispositivo siano anonimizzati entro 14 mesi**, in conformità alle migliori prassi.
* Sono adottate solide **misure tecniche e organizzative** per prevenire accessi non autorizzati, fughe di dati o usi impropri, incluse cifratura, controlli di accesso e valutazioni periodiche della sicurezza.

### Obblighi di notifica in caso di data breach

* In caso di **violazione dei dati idonea a causare danno agli individui**, Spaarkly notificherà:
  * la **competente autorità per la protezione dei dati**, secondo i requisiti locali:
    *  **Singapore**: entro 3 giorni per le violazioni notificabili;
    *  **Filippine**: entro 72 ore;
    *  **Thailandia**: senza ingiustificato ritardo, entro 72 ore;
    *  **Corea del Sud**: senza ritardo;
    * altre giurisdizioni secondo le rispettive tempistiche.
*  **Poiché Spaarkly non raccoglie informazioni di contatto degli utenti, non è possibile inviare notifiche individuali direttamente**. Ove legalmente richiesto, Spaarkly pubblicherà una **comunicazione pubblica** sul proprio sito web o tramite altri canali appropriati.
...
* garantire la conformità a specifiche disposizioni sui trasferimenti, quali:
  * l’**obbligo di limitazione dei trasferimenti** del PDPA di Singapore e i relativi requisiti per trasferimenti all’estero;
  * le regole del DPA delle Filippine sulla condivisione transfrontaliera dei dati;
  * il divieto del PDPA della Malaysia di trasferimento verso determinati Paesi;
  * i requisiti del PIPA della Corea del Sud per i trasferimenti all’estero;
* implementare meccanismi di trasferimento giuridicamente riconosciuti, quali consenso, garanzie contrattuali, norme vincolanti d’impresa o meccanismi di certificazione;
* fornire informazioni chiare agli utenti sui potenziali trasferimenti transfrontalieri e mantenere la responsabilizzazione in materia di protezione dei dati.
...
*  **Brasile**: **Lei Geral de Proteção de Dados (LGPD)** del 2018, applicata dall’**Autoridade Nacional de Proteção de Dados (ANPD)**;
*  **Messico**: **Ley Federal de Protección de Datos Personales en Posesión de los Particulares (LFPDPPP)** del 2010, applicata dall’**Instituto Nacional de Transparencia, Acceso a la Información y Protección de Datos Personales (INAI)**;
*  **Argentina**: **Personal Data Protection Act (PDPA)**, legge n. 25.326, applicata dall’**Agencia de Acceso a la Información Pública (AAIP)**;
*  **Colombia**: **Law 1581 of 2012** sul regime generale di protezione dei dati, applicata dalla **Superintendencia de Industria y Comercio (SIC)**;
*  **Cile**: **Law No. 19.628 on the Protection of Private Life**, con riforme normative in corso;
*  **Uruguay**: **Law No. 18.331 on Personal Data Protection and Habeas Data Action**, applicata dall’**Unidad Reguladora y de Control de Datos Personales (URCDP)**;
* altre giurisdizioni con quadri normativi emergenti in materia di protezione dei dati.

### Conformità alle leggi latinoamericane sulla protezione dei dati
...
### Diritti degli utenti ai sensi delle leggi privacy latinoamericane
...
*  **diritto di conferma e accesso** (**diritti ARCO**): confermare l’esistenza di un trattamento e accedere ai dati personali;
*  **diritto di rettifica** (**diritti ARCO**): correggere dati inesatti, incompleti o non aggiornati;
*  **diritto di cancellazione** (**diritti ARCO**): richiedere la cancellazione di dati non necessari o eccedenti;
*  **diritto di opposizione** (**diritti ARCO**): opporsi a trattamenti illeciti o non consensuali;
*  **diritto all’informazione**: ricevere informazioni chiare sulle attività di trattamento;
*  **diritto alla portabilità dei dati**: richiedere il trasferimento dei dati a un altro fornitore di servizi, in particolare ai sensi della LGPD brasiliana;
*  **diritto di revocare il consenso**: revocare il consenso precedentemente prestato in qualsiasi momento;
*  **diritto alla revisione delle decisioni automatizzate**: richiedere la revisione di decisioni adottate esclusivamente mediante trattamento automatizzato ai sensi della LGPD.
...
*  **Autorità Nazionale per la Protezione dei Dati del Brasile (ANPD)** (https://www.gov.br/anpd/);
*  **Instituto Nacional de Transparencia, Acceso a la Información y Protección de Datos Personales (INAI) del Messico** (https://home.inai.org.mx/);
*  **Agencia de Acceso a la Información Pública (AAIP) dell’Argentina** (https://www.argentina.gob.ar/aaip);
*  **Superintendencia de Industria y Comercio (SIC) della Colombia** (https://www.sic.gov.co/);
* altre autorità nazionali competenti, ove applicabile.
...
*  **Spaarkly garantisce che i dati di sessione e del dispositivo siano anonimizzati entro 14 mesi**, in conformità alle migliori prassi.
* Sono adottate solide **misure tecniche e organizzative** per prevenire accessi non autorizzati, fughe di dati o usi impropri, come richiesto dalle leggi latinoamericane, quali l’art. 46 della LGPD brasiliana e l’art. 19 della LFPDPPP messicana.

### Obblighi di notifica in caso di data breach

* In caso di **violazione dei dati che possa causare rischio o danno agli interessati**, Spaarkly notificherà:
  * la **competente autorità per la protezione dei dati**, secondo i requisiti locali:
    *  **Brasile**: notifica all’ANPD entro 3 giorni lavorativi dalla conoscenza dell’incidente, ai sensi della Resolução CD/ANPD n. 15/2024;
    *  **Messico**: notifica tempestiva agli interessati dopo la conferma della violazione;
    * altre giurisdizioni secondo i rispettivi requisiti.
*  **Poiché Spaarkly non raccoglie informazioni di contatto degli utenti, non è possibile inviare notifiche individuali direttamente**. Ove legalmente richiesto, Spaarkly pubblicherà una **comunicazione pubblica** sul proprio sito web o tramite altri canali appropriati.
...
* garantire la conformità a specifiche disposizioni sui trasferimenti, quali:
  * i requisiti della **LGPD brasiliana** per i trasferimenti internazionali (articoli 33-36);
  * i principi della **LFPDPPP messicana** per la condivisione transfrontaliera dei dati;
  * il requisito argentino di **livello adeguato** ai sensi della PDPA;
  * i requisiti della **SIC colombiana** per i trasferimenti transfrontalieri;
* implementare meccanismi di trasferimento giuridicamente riconosciuti, quali:
  * clausole contrattuali standard;
  * norme vincolanti d’impresa;
  * meccanismi di certificazione;
  * consenso specifico al trasferimento;
...
## H. GIAPPONE (APPI — ACT ON THE PROTECTION OF PERSONAL INFORMATION)
...
### Conformità all’APPI giapponese
...
### Diritti degli utenti ai sensi dell’APPI giapponese

Gli utenti in **Giappone** godono di diritti specifici ai sensi dell’APPI, tra cui:

*  **diritto di divulgazione** (*Kaiji*): richiedere la divulgazione dei dati personali detenuti da un operatore commerciale;
*  **diritto di correzione** (*Seigō*): richiedere la correzione, integrazione o cancellazione di dati personali inesatti;
*  **diritto alla sospensione dell’uso/cancellazione** (*Riyō Teishi / Sakujo*): richiedere la sospensione dell’uso o la cancellazione di dati personali trattati in violazione della legge o oltre la finalità specificata;
*  **diritto alla sospensione della comunicazione a terzi** (*Daisansha Teikyō no Teishi*): richiedere all’operatore di cessare la comunicazione di dati personali a terzi;
*  **diritto a una spiegazione** (*Setsumei*): ricevere una spiegazione delle attività di trattamento relative ai dati personali;
*  **diritto di reclamo** (*Kujō*): presentare reclamo all’operatore o alla PPC.
...
*  **Personal Information Protection Commission (PPC) del Giappone** (https://www.ppc.go.jp/en/).
...
*  **Spaarkly garantisce che i dati di sessione e del dispositivo siano anonimizzati entro 14 mesi**, in conformità alle migliori prassi.
*  **Spaarkly implementa misure di sicurezza complete** come richiesto dall’art. 23 APPI, incluse:
...
* In caso di **perdita di dati personali o altro incidente di sicurezza** (*Jōhō Rōei Jiko*), Spaarkly:
  * effettuerà **segnalazione tempestiva alla PPC** ai sensi dell’art. 26 APPI, ove la violazione raggiunga la soglia di notifica;
  * includerà nella notifica i dettagli dell’incidente, i tipi di dati coinvolti, la causa e le misure correttive;
  * ove legalmente richiesto, pubblicherà una **comunicazione pubblica** sul sito di Spaarkly o tramite altri canali appropriati, poiché **le notifiche individuali dirette non sono possibili** in assenza di dati di contatto raccolti.
...
* garantire la conformità all’art. 28 APPI in materia di trasferimenti internazionali, che richiede:
  * il previo consenso dell’individuo per trasferimenti a terzi in Paesi esteri; oppure
  * la garanzia che il terzo si trovi in un Paese con standard equivalenti di protezione dei dati; oppure
  * la garanzia che il terzo mantenga standard equivalenti tramite accordi contrattuali o altri mezzi;
* implementare meccanismi di trasferimento appropriati, quali:
  * clausole contrattuali standard;
  * norme vincolanti d’impresa;
  * certificazioni riconosciute;
* fornire informazioni chiare agli utenti sui potenziali trasferimenti transfrontalieri in conformità ai requisiti APPI.
...
## I. CINA (PIPL — PERSONAL INFORMATION PROTECTION LAW)
...
### Conformità alla PIPL

**Spaarkly opera in Cina e aderisce ai principi PIPL**. Il suo attuale modello di trattamento è il seguente:

*  i **dati facciali** utilizzati per il Virtual Try-On sono trattati **localmente sul dispositivo** e non sono conservati; per **AR PD Meter**, dati tecnici derivati, non utilizzati per identificare l’Utente e non idonei, di per sé, a identificarlo, possono essere trasmessi temporaneamente al backend ARShades situato nell’Unione Europea, utilizzati esclusivamente per restituire il risultato della misurazione e scartati dopo l’elaborazione;
*  **assenza di raccolta di dati biometrici o sensibili**: Spaarkly non raccoglie identificativi biometrici, nomi reali, dati di contatto o altri dati univocamente identificativi dell’utente;
*  i **dati di sessione e del dispositivo** (incluso l’indirizzo IP) sono conservati su **server situati nell’Unione Europea** e anonimizzati entro 14 mesi.
...
### Diritti degli utenti ai sensi della PIPL

Gli utenti in **Cina** godono di diritti allineati al **GDPR**, tra cui:

*  **diritto di accesso**: richiedere una copia dei propri dati personali;
*  **diritto di rettifica**: richiedere la correzione di dati inesatti o incompleti;
*  **diritto di cancellazione**: richiedere la cancellazione dei dati personali in specifiche condizioni;
*  **diritto di limitare o opporsi al trattamento**: opporsi a determinate attività di trattamento;
*  **diritto di revocare il consenso**: revocare il consenso precedentemente prestato in qualsiasi momento.

Inoltre, la **PIPL riconosce diritti che vanno oltre il GDPR**, tra cui:

*  **diritto di “conoscere e decidere”**: gli utenti hanno controllo esplicito su come i propri dati sono utilizzati;
*  **diritto a una spiegazione delle decisioni automatizzate**: gli utenti possono richiedere una spiegazione su come sistemi automatizzati, quali raccomandazioni basate su AI, incidano su di loro.
...
* le **autorità regolatorie cinesi competenti**, ove richiesto dalla **PIPL**;
* ove legalmente richiesto, una **comunicazione pubblica** sarà pubblicata sul sito di Spaarkly o tramite altri canali appropriati.
...
*  **effettuare una valutazione di sicurezza** ai sensi delle norme CAC, ove richiesta;
*  **implementare Clausole Contrattuali Standard (SCC) approvate dalla CAC** o altri meccanismi approvati;
*  **ottenere il consenso esplicito dell’utente** per eventuali trasferimenti transfrontalieri, se ritenuto necessario.
...
## J. SUDAFRICA (POPIA – PROTECTION OF PERSONAL INFORMATION ACT)
...
### Diritti degli utenti ai sensi del POPIA

Gli utenti in **Sudafrica** godono di diritti simili a quelli previsti dal **GDPR**, tra cui:

*  **diritto di accesso**: richiedere una copia dei propri dati personali;
*  **diritto di rettifica**: richiedere la correzione di dati inesatti o incompleti;
*  **diritto di cancellazione**: richiedere la cancellazione dei dati personali in casi specifici;
*  **diritto di limitare o opporsi al trattamento**: opporsi a determinate attività di trattamento;
*  **diritto di revocare il consenso**: revocare il consenso precedentemente prestato in qualsiasi momento.

Gli utenti possono esercitare i propri diritti contattando **privacy@spaarkly.com**. Se non soddisfatti della risposta di Spaarkly, possono rivolgersi all’**Information Regulator of South Africa** ([https://inforegulator.org.za/](https://inforegulator.org.za/)).

### Conservazione dei dati e misure di sicurezza

Il POPIA richiede che i dati personali siano **conservati solo per il tempo necessario** alla finalità prevista.

*  **Spaarkly garantisce che i dati di sessione e del dispositivo siano anonimizzati entro 14 mesi**.
* Sono adottate solide **misure tecniche e organizzative** per prevenire accessi non autorizzati, fughe di dati o usi impropri.
...
* l’**Information Regulator of South Africa**, ove richiesto dal **POPIA**;
* ove legalmente richiesto, una **comunicazione pubblica** sarà pubblicata sul sito di Spaarkly o tramite altri canali appropriati.
...
*  **garantire che qualsiasi trasferimento di dati sia conforme alla Section 72 del POPIA**, che richiede adeguata protezione;
*  **implementare Clausole Contrattuali Standard (SCC)** o altri meccanismi di trasferimento giuridicamente riconosciuti, ove necessario;
*  **ottenere il consenso esplicito dell’utente** per eventuali trasferimenti transfrontalieri, qualora ciò diventi un requisito legale.
...
### Diritti degli utenti ai sensi del DPDP

Gli utenti in **India** godono di diritti simili a quelli previsti dal **GDPR**, tra cui:

*  **diritto di accesso**: richiedere un riepilogo dei dati personali trattati;
*  **diritto di rettifica**: richiedere la correzione di dati inesatti o incompleti;
*  **diritto alla cancellazione**: richiedere la cancellazione dei dati personali in specifiche condizioni;
*  **diritto di limitare o opporsi al trattamento**: opporsi a determinate attività di trattamento;
*  **diritto di nominare un rappresentante**: designare un’altra persona per esercitare i propri diritti in caso di morte o incapacità.
...
*  **Spaarkly garantisce che i dati di sessione e del dispositivo siano anonimizzati entro 14 mesi**, in linea con le migliori prassi.
* Sono adottate solide **misure tecniche e organizzative** per prevenire accessi non autorizzati, fughe di dati o usi impropri.

### Obblighi di notifica in caso di data breach

* In caso di **violazione dei dati personali**, Spaarkly notificherà:
  * il **Data Protection Board of India** e, come richiesto dal **DPDP**, gli interessati coinvolti;
  * non disponendo di dati di contatto degli Utenti, la comunicazione agli interessati sarà effettuata tramite **comunicazione pubblica** sul sito di Spaarkly e, ove possibile, mediante avviso all’interno del servizio, quale mezzo disponibile più efficace.
...
*  **garantire la conformità ai requisiti DPDP in materia di localizzazione e trasferimento dei dati**;
*  **implementare meccanismi di trasferimento giuridicamente riconosciuti**, quali clausole contrattuali approvate dal governo;
*  **ottenere il consenso esplicito dell’utente** per eventuali trasferimenti transfrontalieri, qualora ciò diventi un requisito legale.
...
## L. MEDIO ORIENTE (EMIRATI ARABI UNITI – Dubai – Arabia Saudita – Altri Paesi)

Gli utenti nel **Medio Oriente** sono protetti da diverse leggi nazionali sulla protezione dei dati, tra cui:

*  **Emirati Arabi Uniti (UAE)**: **Federal Decree-Law No. 45 of 2021 on the Protection of Personal Data**;
...
*  **altre normative nazionali applicabili in materia di privacy**.

### Conformità alle leggi privacy del Medio Oriente
...
### Diritti degli utenti ai sensi delle leggi privacy del Medio Oriente
...
*  **diritto di rettifica**: richiedere la correzione di dati inesatti o incompleti;
*  **diritto alla cancellazione**: richiedere la cancellazione dei dati personali in specifiche condizioni;
*  **diritto di opposizione**: opporsi a determinate tipologie di trattamento;
*  **diritto di revocare il consenso**: revocare il consenso precedentemente prestato in qualsiasi momento.
...
*  la **Saudi Data & Artificial Intelligence Authority (SDAIA)**, autorità competente ai sensi della Personal Data Protection Law (PDPL) saudita.
...
* In caso di **violazione dei dati che possa causare danni significativi**, Spaarkly notificherà:
  * la **competente autorità per la protezione dei dati del Medio Oriente**, ove richiesto dalla legge locale;
  * ove legalmente richiesto, una **comunicazione pubblica** sarà pubblicata sul sito di Spaarkly o tramite altri canali appropriati.
*  **Poiché Spaarkly non raccoglie informazioni di contatto degli utenti, non è possibile inviare notifiche individuali**.
...
*  **garantire la conformità alle leggi locali sulla protezione dei dati in materia di trasferimenti internazionali**;
*  **implementare meccanismi di trasferimento giuridicamente riconosciuti**, quali Clausole Contrattuali Standard (SCC) o framework approvati dal governo;
*  **ottenere il consenso esplicito dell’utente** per eventuali trasferimenti transfrontalieri, qualora ciò diventi un requisito legale.
...
### Conformità agli standard internazionali sulla privacy
...
### Diritti degli utenti in altri Paesi
...
*  **richiedere correzioni** di dati inesatti o incompleti;
*  **richiedere la cancellazione** dei dati personali in specifiche condizioni;
...
* Spaarkly garantisce che i dati di sessione e del dispositivo siano anonimizzati entro **14 mesi**, in linea con le migliori pratiche.
* Sono adottate rigorose misure tecniche e organizzative per prevenire accessi non autorizzati, fughe di dati o usi impropri.
...
* L'autorità per la protezione dei dati competente, se richiesto dalla normativa locale.
* Se obbligata per legge, pubblicherà un avviso pubblico sul proprio sito web o tramite altri canali appropriati.

Poiché Spaarkly **non raccoglie informazioni di contatto degli utenti**, non è possibile inviare notifiche individuali.

### Trasferimenti Internazionali di Dati e Garanzie di Conformità
...
* Garantire il rispetto delle **leggi locali sulla protezione dei dati relative ai trasferimenti internazionali**.
* Implementare **meccanismi di trasferimento legalmente riconosciuti**, come **Clausole Contrattuali Standard (SCCs)** o framework approvati dal governo.
* Ottenere il **consenso esplicito degli utenti** per eventuali trasferimenti transfrontalieri, qualora ciò diventasse un obbligo legale.

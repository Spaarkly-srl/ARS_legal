# POLÍTICA DE PRIVACIDAD DE ARSHADES

*Soluciones ARShades* </br> *Última actualización: 07 de julio de 2026*
...
*  **ARShades Virtual Try-On** (“ARShades VTO”, “VTO”, “Web VTO”, “VTO App”, “Aplicaciones y Servicios”);
*  **ARShades VTO Explorer** (“VTO Explorer”), como módulo o funcionalidad integrable en experiencias ARShades web, móvil, catálogo, comercio electrónico, mirror, showroom o in-store;
*  **AR PD Meter**;
*  **ARShades Mirror** (“Mirror”);
*  **ARShades Gateway** (“Gateway”, “Aplicación Standalone”).
...
*  **Datos Personales**: cualquier información relativa a una persona física identificable, incluidos la dirección IP, el correo electrónico y otros datos facilitados voluntariamente por el usuario.
*  **Datos de Sesión**: información recabada durante una sesión de usuario, tal como marcas de tiempo de interacción, páginas consultadas y estadísticas de uso. Se conservan hasta **14 meses** antes de su anonimización.
*  **Datos del Dispositivo**: información técnica sobre el dispositivo del usuario, incluidos el **tipo de dispositivo, el sistema operativo, la versión del navegador y el idioma preferido**. Se utilizan para la optimización y la seguridad del servicio.
*  **Datos de Geolocalización**: previo consentimiento del usuario, ARShades puede recabar la ubicación aproximada basada en la **dirección IP** o, en las aplicaciones standalone, la **posición GPS precisa**, con el fin de prestar servicios basados en la ubicación. Los usuarios pueden desactivar dicha funcionalidad en cualquier momento.
*  **Responsable del tratamiento**: Spaarkly s.r.l., que determina los fines y los medios del tratamiento de los datos personales.
*  **Tratamiento**: cualquier operación realizada sobre los datos personales, incluidas la **recogida, la conservación, la anonimización y la supresión**.
*  **Cookies y tecnologías de seguimiento**: cookies esenciales necesarias para el funcionamiento del servicio y herramientas de analítica opcionales, cuando el usuario las habilite. No se utilizan cookies de marketing.
*  **Derechos del interesado**: los Usuarios pueden **acceder, rectificar, suprimir o limitar** el tratamiento de sus datos conforme a lo previsto por el RGPD, el CCPA y normativas análogas. Las solicitudes pueden dirigirse a **privacy@spaarkly.com**.
*  **Transferencias internacionales de datos**: en caso de que se transfieran datos personales fuera del **Espacio Económico Europeo (EEE)**, Spaarkly garantiza el cumplimiento normativo mediante **Cláusulas Contractuales Tipo (CCT)** o garantías equivalentes.
*  **ARShades VTO**: solución de **prueba virtual (virtual try-on, VTO)** que permite a los usuarios visualizar cómo se ajustan las gafas al rostro en **realidad aumentada (RA) en tiempo real**. Funciona en **dispositivos web y móviles** sin conservar datos biométricos.
*  **ARShades VTO Explorer**: módulo de prueba virtual fotográfica y catálogo aumentado que permite a los Usuarios generar previsualizaciones realistas y personalizadas de varios productos de eyewear a partir de un número limitado de imágenes captadas durante la sesión. VTO Explorer puede integrarse en soluciones ARShades web, móvil, catálogos, mirror u otras experiencias in-store. Las imágenes captadas se tratan localmente en el dispositivo del Usuario o en el dispositivo utilizado para la experiencia y no se cargan automáticamente en los servidores de Spaarkly. Cuando VTO Explorer se utiliza en un dispositivo instalado en un punto de venta, showroom, sede de un evento u otro lugar público, y el Usuario opta por obtener, descargar o compartir en su propio dispositivo las fotos finales, únicamente las fotos finales seleccionadas por el Usuario podrán cargarse temporalmente en los servidores de Spaarkly con la exclusiva finalidad de ponerlas a disposición del Usuario, y se suprimen según lo descrito en la presente Política.
*  **AR PD Meter**: herramienta de medición de la **distancia pupilar (PD)** que estima la distancia entre las pupilas del usuario mediante **RA y detección de puntos de referencia faciales (landmarks)**. Las imágenes y los flujos de vídeo de la cámara no se conservan, no se utilizan para la identificación biométrica ni para crear plantillas faciales. Para calcular la distancia pupilar, AR PD Meter puede transmitir temporalmente al backend de ARShades, situado en la Unión Europea, datos técnicos derivados tales como puntos de referencia faciales, orientación del rostro, información técnica del dispositivo y parámetros necesarios para el cálculo. Dichos datos se utilizan exclusivamente para devolver el resultado de la medición y se descartan tras su procesamiento. Cuando AR PD Meter se utiliza en el ámbito de ARShades Mirror (por ejemplo, en apoyo de la experiencia VTO Explorer en Mirror Showroom), tales datos técnicos derivados son procesados por el backend local del dispositivo, sin transmisión a servidores en la nube, y se suprimen tras su procesamiento.
*  **ARShades Mirror**: experiencia de prueba virtual para el retail disponible a través de **espejos digitales y quioscos in-store**, que permite a los usuarios navegar por catálogos virtuales de eyewear y probarse gafas en RA sin requerir la conservación de datos personales.
*  **ARShades Gateway**: plataforma de RA **standalone** que ofrece, entre otras cosas, una experiencia de **prueba virtual**. Puede, de forma opcional, **utilizar la geolocalización, previo consentimiento**, para personalizar las recomendaciones.

## 1\. FINES DEL TRATAMIENTO Y BASE JURÍDICA

### a) Soluciones ARShades en dispositivos de propiedad del Usuario
...
*  **Prestación de los Servicios VTO**: permitir al Usuario probarse virtualmente monturas de eyewear, testar formas y tamaños y utilizar herramientas como la medición de la distancia pupilar (**base jurídica: ejecución de un contrato o de medidas precontractuales solicitadas por el Usuario, con arreglo al artículo 6, apartado 1, letra b), del RGPD**).
*  **Mejora del servicio, analítica, seguridad y prevención del fraude**: mejorar la calidad, la usabilidad, la comprensión analítica y la seguridad de nuestros Servicios, generar estadísticas anónimas sobre el uso y el rendimiento de las experiencias ARShades, prevenir usos ilícitos y fraudes y garantizar la integridad de las redes y los sistemas (**base jurídica: interés legítimo, artículo 6, apartado 1, letra f), del RGPD**).
*  **Cumplimiento de obligaciones legales**: cumplir con obligaciones legales o con requerimientos de las autoridades competentes en materia de conservación de datos, seguridad y otros requisitos normativos (**base jurídica: obligación legal, artículo 6, apartado 1, letra c), del RGPD**).
*  **Consentimiento, cuando resulte aplicable**: cuando se requiera el consentimiento, por ejemplo para el acceso a la cámara o para eventuales herramientas opcionales de analítica, cuando estén disponibles, el tratamiento se basará en el consentimiento (artículo 6, apartado 1, letra a), del RGPD), revocable en cualquier momento sin que ello afecte a la licitud del tratamiento efectuado con anterioridad a la revocación.
...
### b) Soluciones ARShades en dispositivos instalados en puntos de venta, showrooms o lugares públicos (VTO Mirror)
...
*  **Prestación de los Servicios VTO**: permitir al Usuario probarse virtualmente monturas de eyewear, testar formas y tamaños y utilizar herramientas como la medición de la distancia pupilar (base jurídica: ejecución de un contrato o de medidas precontractuales solicitadas por el interesado, con arreglo al artículo 6, apartado 1, letra b), del RGPD).
*  **Mejora del servicio, analítica, seguridad y prevención del fraude**: mejorar la calidad, la usabilidad, la comprensión analítica y la seguridad de nuestros Servicios, generar estadísticas anónimas sobre el uso y el rendimiento de las experiencias ARShades, prevenir usos ilícitos y fraudes y garantizar la integridad de las redes y los sistemas (base jurídica: interés legítimo, artículo 6, apartado 1, letra f), del RGPD).
*  **Obligaciones legales**: cumplir con obligaciones legales o con requerimientos de las autoridades competentes en materia de conservación de datos, seguridad y otros requisitos normativos (base jurídica: obligación legal, artículo 6, apartado 1, letra c), del RGPD).
*  **Consentimiento, cuando resulte aplicable**: cuando se requiera el consentimiento, por ejemplo para el acceso a la cámara, para la captación de las imágenes necesarias para el uso del módulo VTO Explorer o para la conservación temporal de las fotos finales seleccionadas por el Usuario para su descarga o para compartirlas mediante funcionalidades como “Shoot & Share” o funciones equivalentes de descarga, el tratamiento se basará en el consentimiento (artículo 6, apartado 1, letra a), del RGPD), revocable en cualquier momento sin que ello afecte a la licitud del tratamiento efectuado con anterioridad a la revocación.

## 2\. CÓMO FUNCIONA ARSHADES VTO
...
* opera sobre puntos matemáticos anónimos comunes a todos los rostros;
* no utiliza las mediciones para identificar a personas concretas, ni las mediciones son, por sí solas, aptas para identificarlas;
* no utiliza ni conserva datos con fines de reconocimiento facial;
* trata los datos faciales del Virtual Try-On localmente en el dispositivo del Usuario, sin conservación del lado del servidor;
* para AR PD Meter, utiliza temporalmente datos técnicos derivados en el backend de ARShades únicamente para calcular y devolver el resultado de la PD, descartándolos tras su procesamiento.
...
#### Cómo recabamos y gestionamos el consentimiento
...
* altura de los pómulos;
* anchura del rostro a la altura de los pómulos;
* anchura del rostro a la altura de la boca;
* longitud del mentón;
* longitud total del rostro.
...
### Datos del dispositivo y de sesión
...
* sistema operativo;
* idioma preferido;
* marcas y productos visualizados;
* fechas y horas de acceso;
* estadísticas anónimas sobre las interacciones con la app VTO, por ejemplo si el Usuario lleva gafas.

Dichos datos se recaban para mejorar los Servicios, garantizar la seguridad y analizar el uso de nuestras soluciones.

### Imágenes faciales o datos biométricos
...
### Fotos finales seleccionadas por el Usuario
...
### Datos de geolocalización en las aplicaciones standalone (ARShades Gateway)
...
*  **Geolocalización precisa**: previo consentimiento explícito, determinadas aplicaciones standalone de ARShades pueden recabar coordenadas precisas de geolocalización del dispositivo para prestar servicios o recomendaciones basados en la ubicación.
*  **Ubicación aproximada**: en ausencia de consentimiento explícito a la ubicación precisa, podemos inferir una ubicación aproximada a partir de la dirección IP.

La recogida de datos de geolocalización en las aplicaciones standalone es:

*  **facultativa**: es posible rechazar los permisos de localización sin que ello afecte a las funcionalidades VTO principales;
*  **basada en el consentimiento**: la geolocalización precisa solo se recaba previo consentimiento explícito;
*  **limitada a los fines**: se utiliza únicamente para ofrecer recomendaciones de eyewear pertinentes o servicios basados en la ubicación;
*  **sujeta a la misma política de conservación**: anonimizada en un plazo de 14 meses junto con los demás datos técnicos.

#### Gestión del consentimiento a la geolocalización
...
* recordada localmente por el navegador para futuras visitas a la misma aplicación;
* configurada para preguntar cada vez;
* concedida temporalmente solo para la sesión en curso.
...
## 5\. TRATAMIENTO DE DATOS EN ARSHADES VTO MIRROR
...
* Las imágenes captadas para la prueba virtual, la personalización, la generación del catálogo, el ajuste facial, la segmentación, el posicionamiento del producto y el renderizado se tratan localmente en el dispositivo, sin transferencia automática a los servidores de Spaarkly.
* En las versiones de VTO Mirror que incorporan el módulo **VTO Explorer**, como **Mirror Showroom**, las imágenes captadas durante la fase de personalización se utilizan localmente para generar previsualizaciones del catálogo aumentado y no se cargan en los servidores de Spaarkly.
* Únicamente cuando el Usuario opta activamente por obtener, descargar o compartir fotos finales que lo retratan con las gafas seleccionadas puestas desde un dispositivo instalado en un punto de venta, showroom, sede de un evento u otro lugar público, dichas fotos finales seleccionadas podrán cargarse temporalmente en los servidores de Spaarkly con la exclusiva finalidad de ponerlas a disposición del Usuario en su propio dispositivo.
* El titular del punto de venta no tiene acceso directo a los datos ni a las imágenes generadas por los Usuarios, dado que el acceso al software está limitado exclusivamente a ARShades.
* ARShades se compromete a no acceder a los datos del Usuario salvo cuando resulte necesario para actividades específicas de mantenimiento técnico, siempre sin visualizar ni tratar las imágenes captadas.
* Spaarkly no comunica los datos de los Usuarios a terceros para fines propios de estos últimos. Para el alojamiento y la prestación de los servicios, Spaarkly puede recurrir a proveedores cualificados de infraestructura en la nube, con servidores situados en la Unión Europea, nombrados encargados del tratamiento con arreglo al artículo 28 del RGPD y vinculados por los correspondientes acuerdos de tratamiento de datos. Las actividades de tratamiento son realizadas exclusivamente por personal autorizado de Spaarkly y por dichos proveedores, dentro de los límites de las instrucciones impartidas.

### Supresión automática y medidas de seguridad

* Las fotos finales cargadas temporalmente a través de **VTO Mirror**, **VTO Explorer**, “Shoot & Share” o funcionalidades equivalentes de descarga/compartición desde dispositivos instalados en puntos de venta, showrooms, sedes de eventos u otros lugares públicos pueden ser suprimidas inmediatamente de nuestros servidores por los Usuarios una vez descargadas en su propio dispositivo, cuando dicha opción esté disponible. Si los Usuarios no suprimen manualmente sus fotos, nuestro sistema las elimina automáticamente transcurridas **24 horas** mediante un script dedicado, sin intervención manual.
* Los datos conservados temporalmente están **cifrados en reposo y en tránsito** para garantizar su seguridad.
* Todos los accesos a los dispositivos ARShades para mantenimiento técnico quedan registrados en un **registro de accesos** conforme al **artículo 5, apartado 1, letra f), del RGPD**.
* El software está configurado para limitar el acceso a los datos exclusivamente al **personal autorizado de ARShades**.

### Función de ARShades y del punto de venta

*  **ARShades sigue siendo el único responsable del tratamiento** de los datos generados a través de VTO Mirror.
* El **punto de venta no trata los datos de los usuarios**, dado que no tiene acceso a los datos generados ni a la gestión del software.

## 6\. RECOGIDA DE DATOS Y PERÍODO DE CONSERVACIÓN

* Los **datos de medición facial** se recaban localmente en el dispositivo del Usuario para el Virtual Try-On y se conservan únicamente durante el tiempo necesario para prestar los servicios ARShades VTO. En el caso de AR PD Meter, los datos técnicos derivados necesarios para el cálculo de la distancia pupilar pueden transmitirse temporalmente al backend de ARShades situado en la UE, se utilizan únicamente para devolver el resultado de la medición y se descartan tras su procesamiento.
* Los **datos de sesión y del dispositivo** se conservan en los servidores de Spaarkly, situados dentro de la UE. Las **direcciones IP se suprimen y se disocian por completo de todos los demás datos en un plazo de 14 meses**. Únicamente se conservan datos agregados y anonimizados para análisis estadísticos.
* El período de conservación de los datos personales puede ampliarse en casos excepcionales, por ejemplo para cumplir con obligaciones legales o con fines de prevención del fraude.
...
* habilitan **funcionalidades básicas del sitio**, tales como la gestión de la sesión y la seguridad;
*  **no** rastrean a los usuarios a través de sitios web distintos;
*  **no** se utilizan para analítica, marketing o seguimiento por terceros.
...
### Cookies estrictamente necesarias utilizadas

|Nombre de la cookie|Duración|Finalidad|
|---|---|---|
|<b>visited</b>|90 días|Identifica si el Usuario ya ha utilizado el servicio.|
|<b>consent</b>|120 minutos|Identifica si el Usuario ha prestado el consentimiento a la Política de Privacidad y a los Términos y Condiciones de uso de ARShades.|
|<b>lang</b>|90 días|Almacena y recuerda el idioma preferido por el usuario entre las sesiones del navegador.|
...
## 8\. NATURALEZA DE LA APORTACIÓN DE LOS DATOS Y CONSECUENCIAS DE SU NO APORTACIÓN
...
*  **servidores seguros**;
*  **sistemas de gestión de accesos** para prevenir accesos no autorizados a sistemas y datos.
...
### Protocolo en caso de violación de la seguridad
...
*  **evaluará el nivel de riesgo** con arreglo al **artículo 33 del RGPD**. Evaluaremos toda posible violación conforme al artículo 33 del RGPD y notificaremos a la **autoridad de control** competente en un plazo de **72 horas** cuando así lo exija la ley aplicable;
*  **debido a la ausencia de datos personales de contacto**, no estamos en condiciones de **notificar directamente a los usuarios individuales**. Cuando así se requiera, emitiremos en su lugar un **aviso público** a través de nuestro sitio oficial u otros canales;
*  **mitigará y resolverá** el incidente en el menor tiempo posible, implementando, cuando sea necesario, medidas de salvaguardia adicionales.
...
* Solicitar la confirmación de si se está tratando o no sus datos personales.
* Obtener acceso a la información pertinente, tal como los fines, las categorías de datos tratados, los destinatarios o categorías de destinatarios, el período de conservación, etc.
...
* Solicitar la supresión de los datos personales cuando:
  * los datos ya no sean necesarios en relación con los fines para los que fueron recabados;
  * se revoque el consentimiento, cuando el tratamiento se base en el consentimiento;
...
* Solicitar la limitación del tratamiento cuando:
  ...
  * los datos sean necesarios para la formulación, el ejercicio o la defensa de reclamaciones, aunque el responsable ya no los necesite;
  * el interesado se oponga al tratamiento, en tanto se verifica la existencia de motivos legítimos.

### Derecho a la portabilidad de los datos

* Recibir sus datos personales en un formato estructurado, de uso común y de lectura mecánica.
* Solicitar la transmisión directa a otro responsable, cuando sea técnicamente posible.
...
### Interfaz de gestión del consentimiento
...
* visualizar el estado actual de su consentimiento;
* acceder a nuestra Política de Privacidad completa;
* revocar el consentimiento previamente prestado.
...
* el **Garante per la Protezione dei Dati Personali** italiano: **[www.garanteprivacy.it](http://www.garanteprivacy.it)**;
* otra **autoridad de control competente** en su país de residencia.
...
* modificaciones de nuestros **Servicios**;
* actualizaciones de la **tecnología**;
* nuevos **requisitos legales**;
* cambios internos en las **políticas**.
...
## Introducción a los Addenda Normativos
...
*  **derechos adicionales o distintos** respecto de los descritos en la Política principal;
*  **modalidades de ejercicio de dichos derechos**, incluidos contactos locales, procedimientos y plazos de respuesta;
*  **eventuales requisitos adicionales de consentimiento**;
*  **requisitos específicos de conservación de datos**;
*  **obligaciones locales de notificación en caso de violación de datos (data breach)**;
*  **reglas sobre las transferencias de datos**, incluidas las cláusulas contractuales tipo y los requisitos locales.
...
### Índice de los Addenda regionales y nacionales

 1. [Unión Europea / Espacio Económico Europeo / Reino Unido](#a-reino-unido-uk-gdpr--unión-europea-y-espacio-económico-europeo-ue-eee)
 2. [Suiza](#b-suiza-fadp--federal-act-on-data-protection)
 3. [Estados Unidos](#c-estados-unidos--addendum-usa)
 4. [Canadá](#d-canadá-pipeda--personal-information-protection-and-electronic-documents-act)
 5. [Australia y Nueva Zelanda](#e-australia-y-nueva-zelanda)
 6. [Región Asia-Pacífico](#f-región-asia-pacífico)
 7. [Brasil y América Latina](#g-brasil-y-américa-latina)
 8. [Japón](#h-japón-appi--act-on-the-protection-of-personal-information)
 9. [China](#i-china-pipl--personal-information-protection-law)
10. [Sudáfrica](#j-sudáfrica-popia--protection-of-personal-information-act)
11. [India](#k-india-dpdp--digital-personal-data-protection-act)
12. [Oriente Medio](#l-oriente-medio-emiratos-árabes-unidos--dubái--arabia-saudí--otros-países)
13. [Otros Países](#m-otros-países)

## A. REINO UNIDO (UK GDPR) / UNIÓN EUROPEA Y ESPACIO ECONÓMICO EUROPEO (UE/EEE)
...
*  **Usuarios UE/EEE**: la **autoridad de control en materia de protección de datos** del respectivo Estado miembro.
*  **Usuarios del Reino Unido**: la **Information Commissioner’s Office (ICO)** ([https://ico.org.uk/](https://ico.org.uk/)).
...
*  **Cláusulas Contractuales Tipo (CCT)** de la Comisión Europea para las transferencias desde la UE/EEE;
*  **CCT aprobadas por la ICO** para las transferencias desde el Reino Unido;
*  **garantías adicionales cuando sea necesario**, en línea con las directrices del European Data Protection Board (EDPB) y de la ICO.
...
## B. SUIZA (FADP – FEDERAL ACT ON DATA PROTECTION)
...
*  **acceder** a sus datos personales tratados por Spaarkly;
*  **solicitar la corrección** o la supresión de datos inexactos o innecesarios;
*  **oponerse al tratamiento de datos** con fines de **marketing directo**.
...
* al **Encargado Federal de Protección de Datos y Transparencia (FDPIC)**;
* a los **interesados**, cuando así lo exija la ley suiza.

### Transferencias internacionales de datos

Los datos personales de los usuarios suizos **no se transfieren fuera de Suiza**, salvo que:

* el país de destino sea considerado dotado de un **nivel adecuado de protección** por las autoridades suizas;
* se implementen **Cláusulas Contractuales Tipo (CCT)** aprobadas por la Comisión Europea para las transferencias hacia la UE/EEE;
* se adopten otras **garantías conformes al FADP suizo** para proteger los datos transferidos.

## C. ESTADOS UNIDOS — ADDENDUM USA
...
*  **Texas**: **Capture or Use of Biometric Identifier Act (CUBI)** y **Texas Data Privacy and Security Act (TDPSA)**;
*  **Washington**: ley sobre privacidad biométrica (**RCW 19.375**);
*  **otras leyes estatales aplicables en materia de privacidad**.
...
### Derechos y normativas específicos por estado

#### 1\. California (CCPA/CPRA)

Los residentes en California tienen derecho a:

*  **saber** qué categorías de datos personales recabamos;
*  **comprender** los fines del tratamiento;
*  **solicitar la supresión** de sus datos personales, con las excepciones permitidas por la ley;
*  **oponerse a la venta o la compartición** de sus datos, cuando resulte aplicable;
*  **no sufrir discriminación** por el ejercicio de sus derechos de privacidad.

#### 2\. Virginia, Colorado, Connecticut, Utah, Montana y Oregon
...
* derechos de **exclusión (opt-out)** respecto de la publicidad dirigida o la venta de datos personales, cuando resulte aplicable. Aunque ARShades no realiza dichas actividades, los residentes en Montana y Oregon pueden, no obstante, solicitar confirmación poniéndose en contacto con Spaarkly.

#### 3\. Illinois (BIPA), Texas (CUBI), Washington (RCW 19.375)

*  **Spaarkly no recaba datos biométricos** según la definición de dichas leyes.
* ARShades trata exclusivamente **puntos matemáticos de referencia facial (landmarks)** con fines de prueba virtual y, a través de AR PD Meter, de cálculo de la distancia pupilar, los cuales:
  *  **no pueden utilizarse para identificar unívocamente** a una persona;
  * en el caso del Virtual Try-On, se **tratan localmente en el dispositivo del usuario** y nunca se conservan;
  * en el caso de **AR PD Meter**, pueden transmitirse temporalmente, en calidad de datos técnicos derivados no utilizados para identificar al Usuario y no aptos, por sí solos, para identificarlo, al backend de ARShades situado en la Unión Europea, se utilizan exclusivamente para devolver el resultado de la medición y se **descartan tras su procesamiento**, sin conservarse en ningún momento;
  *  **no crean un identificador persistente** vinculado a una persona.

#### 4\. Otros estados de EE. UU.

* Algunos estados **aún no disponen** de leyes generales de privacidad.
* En tales casos, **Spaarkly** sigue los **principios generales descritos en la presente Política de Privacidad** y cumple cualquier normativa estatal aplicable.

### Cómo ejercer los derechos

Los residentes en EE. UU. pueden ponerse en contacto con nosotros en la dirección **[privacy@spaarkly.com](mailto:privacy@spaarkly.com)**, indicando su estado de residencia.
...
#### Información y consentimiento específicos para los estados con normativa biométrica
...
* cualquier dato de medición facial se trata en tiempo real y nunca se conserva más allá de la sesión inmediata;
* los datos técnicos derivados transmitidos temporalmente al backend de ARShades para AR PD Meter se utilizan únicamente para devolver el resultado de la medición y se descartan tras su procesamiento;
* los datos de sesión y del dispositivo se anonimizan y disocian en un plazo de 14 meses.
...
### Reglas sobre las transferencias de datos
...
### Renuncia a acciones colectivas y al juicio con jurado
...
## D. CANADÁ (PIPEDA — PERSONAL INFORMATION PROTECTION AND ELECTRONIC DOCUMENTS ACT)
...
### Cumplimiento del PIPEDA y de las leyes provinciales de privacidad

**Spaarkly opera en Canadá y se adhiere a los principios PIPEDA**. Su **actual modelo de tratamiento de datos** es el siguiente:

*  los **datos faciales** utilizados para el Virtual Try-On se tratan **localmente en el dispositivo** y no se conservan; en el caso de **AR PD Meter**, datos técnicos derivados, no utilizados para identificar al Usuario y no aptos, por sí solos, para identificarlo, pueden transmitirse temporalmente al backend de ARShades situado en la Unión Europea, se utilizan exclusivamente para devolver el resultado de la medición y se descartan tras su procesamiento;
*  **no se recaban datos biométricos o unívocamente identificativos**, ni nombres, datos de contacto o perfiles de usuario;
*  los **datos de sesión y del dispositivo** (incluida la dirección IP) se conservan en **servidores situados en la Unión Europea** y se anonimizan en un plazo de 14 meses; las eventuales fotos finales solicitadas por el Usuario desde dispositivos in-store se suprimen en un plazo de 24 horas. Ello puede conllevar una transferencia de dichos datos hacia la UE, con las garantías descritas en la sección “Transferencias internacionales” del presente Addendum.
...
### Derechos de los usuarios con arreglo al PIPEDA

Los usuarios en **Canadá** gozan de derechos análogos a los previstos por el **RGPD**, entre ellos:

*  **derecho de acceso**: solicitar una copia de sus datos personales e información sobre su uso;
*  **derecho de rectificación**: solicitar la corrección de datos inexactos o incompletos;
*  **derecho a revocar el consentimiento**: revocar en cualquier momento el consentimiento previamente prestado;
*  **derecho a impugnar el cumplimiento**: impugnar el cumplimiento por parte de una organización de los principios PIPEDA;
*  **derecho de recurso**: presentar una reclamación ante la autoridad competente en materia de protección de datos.
...
* los comisionados provinciales de privacidad en **la Columbia Británica, Alberta o Quebec**, cuando resulte aplicable.
...
*  **Spaarkly garantiza que los datos de sesión y del dispositivo se anonimicen en un plazo de 14 meses**, conforme a las mejores prácticas.
* Se adoptan sólidas **medidas técnicas y organizativas** para prevenir accesos no autorizados, fugas de datos o usos indebidos.

### Obligaciones de notificación en caso de data breach

* En caso de **violación de datos que presente un riesgo real de daño significativo**, Spaarkly notificará:
  * a la **Office of the Privacy Commissioner of Canada (OPC)**;
  * a los comisionados provinciales de privacidad, cuando así lo exija la ley provincial;
  * cuando la ley lo requiera, se publicará una **comunicación pública** en el sitio de Spaarkly o a través de otros canales apropiados.
*  **Dado que Spaarkly no recaba información de contacto de los usuarios, no es posible enviar notificaciones individuales**.

### Transferencias internacionales y garantía de cumplimiento
...
* garantizar el cumplimiento del **principio de responsabilidad proactiva (Accountability)** del PIPEDA en relación con las transferencias internacionales;
* implementar **Cláusulas Contractuales Tipo (CCT)** u otros mecanismos de transferencia jurídicamente reconocidos, cuando sea necesario;
* facilitar información clara y accesible sobre las potenciales transferencias transfronterizas y sobre los riesgos asociados.
...
*  **Australia**: **Privacy Act 1988 (Cth)**, incluidos los **Australian Privacy Principles (APPs)**, y **Privacy Amendment (Notifiable Data Breaches) Act 2017**;
*  **Nueva Zelanda**: **Privacy Act 2020**, incluidos los **Information Privacy Principles (IPPs)**, regulado por la **Office of the Privacy Commissioner (OPC)**.

### Cumplimiento de las leyes de privacidad australianas y neozelandesas
...
### Derechos de los usuarios con arreglo a las leyes de privacidad australianas y neozelandesas

Los usuarios en **Australia y Nueva Zelanda** tienen derechos de privacidad que incluyen:

*  **derecho de acceso**: solicitar acceso a sus datos personales en poder de una organización;
*  **derecho de corrección**: solicitar la corrección de datos inexactos, no actualizados, incompletos o engañosos;
*  **derecho de oposición**: oponerse a determinados tipos de tratamiento, en particular el marketing directo en Australia y los tratamientos susceptibles de causar un daño, molestia o perjuicio significativos en Nueva Zelanda;
*  **derecho de reclamación**: presentar una reclamación ante la autoridad de privacidad competente cuando consideren vulnerados sus derechos;
*  **derecho a remedios**: obtener remedios por infracciones de privacidad, incluidos la corrección, disculpas o indemnización, cuando resulte aplicable.
...
*  **Office of the Privacy Commissioner (OPC) de Nueva Zelanda** (https://www.privacy.org.nz/).
...
*  **Spaarkly garantiza que los datos de sesión y del dispositivo se anonimicen en un plazo de 14 meses**, conforme a las mejores prácticas.
* Se adoptan sólidas **medidas técnicas y organizativas** para prevenir accesos no autorizados, fugas de datos o usos indebidos, de conformidad con el APP 11 en Australia y el IPP 5 en Nueva Zelanda.

### Obligaciones de notificación en caso de data breach

* En caso de **violación de datos susceptible de determinar un daño grave** para los interesados, Spaarkly notificará:
  * a la **Office of the Australian Information Commissioner (OAIC)** con arreglo al régimen **Notifiable Data Breaches (NDB)**, completando la evaluación del incidente en un plazo de 30 días y procediendo a la notificación tan pronto como sea razonablemente posible;
  * a la **Office of the Privacy Commissioner (OPC) de Nueva Zelanda** tan pronto como sea posible, de conformidad con los requisitos obligatorios de notificación previstos por el Privacy Act 2020.
*  **Dado que Spaarkly no recaba información de contacto de los usuarios, no es posible enviar notificaciones individuales de forma directa**. Cuando la ley lo requiera, Spaarkly publicará una **comunicación pública** en su sitio web o a través de otros canales apropiados.
...
* garantizar el cumplimiento del **APP 8** y de la **Sección 16C del Australian Privacy Act** en materia de comunicaciones transfronterizas;
* implementar las garantías apropiadas exigidas por el **IPP 12 del New Zealand Privacy Act 2020** para las transferencias al extranjero;
* facilitar información clara a los usuarios sobre las potenciales transferencias transfronterizas y mantener la responsabilidad proactiva en materia de protección de datos.
...
*  **Singapur**: **Personal Data Protection Act (PDPA)** de 2012, modificado en 2020, aplicado por la **Personal Data Protection Commission (PDPC)**;
*  **Malasia**: **Personal Data Protection Act (PDPA)** de 2010, aplicado por el **Personal Data Protection Department (JPDP)**;
*  **Filipinas**: **Data Privacy Act (DPA)** de 2012, aplicado por la **National Privacy Commission (NPC)**;
*  **Indonesia**: **Personal Data Protection Law (PDP Law)** de 2022, inspirada en el RGPD;
*  **Tailandia**: **Personal Data Protection Act (PDPA)** de 2019, aplicado por el **Personal Data Protection Committee (PDPC)**;
*  **Corea del Sur**: **Personal Information Protection Act (PIPA)**, aplicado por la **Personal Information Protection Commission (PIPC)**;
* otras jurisdicciones con marcos normativos emergentes en materia de protección de datos.

### Cumplimiento de las leyes de protección de datos de Asia-Pacífico
...
### Derechos de los usuarios con arreglo a las leyes de privacidad de Asia-Pacífico
...
*  **derecho de acceso**: solicitar información sobre la recogida, el uso y la comunicación de los datos personales;
*  **derecho de corrección**: solicitar la corrección de datos personales inexactos o incompletos;
*  **derecho a revocar el consentimiento**: revocar el consentimiento previamente prestado;
*  **derecho a la portabilidad de los datos**: solicitar la transferencia de los datos a otra organización, en jurisdicciones como Singapur y Filipinas;
*  **derecho de supresión**: solicitar la supresión de los datos personales en condiciones específicas, según la jurisdicción;
*  **derecho de oposición**: oponerse al tratamiento para marketing directo u otros fines, según la jurisdicción.
...
*  **Personal Data Protection Commission (PDPC) de Singapur** (https://www.pdpc.gov.sg/);
*  **Personal Data Protection Department (JPDP) de Malasia** (https://www.pdp.gov.my/);
*  **National Privacy Commission (NPC) de Filipinas** (https://privacy.gov.ph/);
*  **Personal Data Protection Committee (PDPC) de Tailandia**;
*  **Personal Information Protection Commission (PIPC) de Corea del Sur**;
* otras autoridades nacionales competentes, cuando resulte aplicable.
...
*  **Spaarkly garantiza que los datos de sesión y del dispositivo se anonimicen en un plazo de 14 meses**, conforme a las mejores prácticas.
* Se adoptan sólidas **medidas técnicas y organizativas** para prevenir accesos no autorizados, fugas de datos o usos indebidos, incluidos el cifrado, los controles de acceso y las evaluaciones periódicas de seguridad.

### Obligaciones de notificación en caso de data breach

* En caso de **violación de datos susceptible de causar un daño a las personas**, Spaarkly notificará:
  * a la **autoridad competente en materia de protección de datos**, según los requisitos locales:
    *  **Singapur**: en un plazo de 3 días para las violaciones notificables;
    *  **Filipinas**: en un plazo de 72 horas;
    *  **Tailandia**: sin dilación indebida, en un plazo de 72 horas;
    *  **Corea del Sur**: sin dilación;
    * otras jurisdicciones según sus respectivos plazos.
*  **Dado que Spaarkly no recaba información de contacto de los usuarios, no es posible enviar notificaciones individuales de forma directa**. Cuando la ley lo requiera, Spaarkly publicará una **comunicación pública** en su sitio web o a través de otros canales apropiados.
...
* garantizar el cumplimiento de disposiciones específicas sobre transferencias, tales como:
  * la **obligación de limitación de las transferencias** del PDPA de Singapur y sus correspondientes requisitos para transferencias al extranjero;
  * las reglas del DPA de Filipinas sobre la compartición transfronteriza de datos;
  * la prohibición del PDPA de Malasia de transferencia hacia determinados países;
  * los requisitos del PIPA de Corea del Sur para las transferencias al extranjero;
* implementar mecanismos de transferencia jurídicamente reconocidos, tales como consentimiento, garantías contractuales, normas corporativas vinculantes o mecanismos de certificación;
* facilitar información clara a los usuarios sobre las potenciales transferencias transfronterizas y mantener la responsabilidad proactiva en materia de protección de datos.
...
*  **Brasil**: **Lei Geral de Proteção de Dados (LGPD)** de 2018, aplicada por la **Autoridade Nacional de Proteção de Dados (ANPD)**;
*  **México**: **Ley Federal de Protección de Datos Personales en Posesión de los Particulares (LFPDPPP)** de 2010, aplicada por el **Instituto Nacional de Transparencia, Acceso a la Información y Protección de Datos Personales (INAI)**;
*  **Argentina**: **Personal Data Protection Act (PDPA)**, ley n.º 25.326, aplicada por la **Agencia de Acceso a la Información Pública (AAIP)**;
*  **Colombia**: **Law 1581 of 2012** sobre el régimen general de protección de datos, aplicada por la **Superintendencia de Industria y Comercio (SIC)**;
*  **Chile**: **Law No. 19.628 on the Protection of Private Life**, con reformas normativas en curso;
*  **Uruguay**: **Law No. 18.331 on Personal Data Protection and Habeas Data Action**, aplicada por la **Unidad Reguladora y de Control de Datos Personales (URCDP)**;
* otras jurisdicciones con marcos normativos emergentes en materia de protección de datos.

### Cumplimiento de las leyes latinoamericanas de protección de datos
...
### Derechos de los usuarios con arreglo a las leyes de privacidad latinoamericanas
...
*  **derecho de confirmación y acceso** (**derechos ARCO**): confirmar la existencia de un tratamiento y acceder a los datos personales;
*  **derecho de rectificación** (**derechos ARCO**): corregir datos inexactos, incompletos o no actualizados;
*  **derecho de cancelación** (**derechos ARCO**): solicitar la supresión de datos innecesarios o excesivos;
*  **derecho de oposición** (**derechos ARCO**): oponerse a tratamientos ilícitos o no consentidos;
*  **derecho a la información**: recibir información clara sobre las actividades de tratamiento;
*  **derecho a la portabilidad de los datos**: solicitar la transferencia de los datos a otro proveedor de servicios, en particular con arreglo a la LGPD brasileña;
*  **derecho a revocar el consentimiento**: revocar en cualquier momento el consentimiento previamente prestado;
*  **derecho a la revisión de las decisiones automatizadas**: solicitar la revisión de decisiones adoptadas exclusivamente mediante tratamiento automatizado con arreglo a la LGPD.
...
*  **Autoridad Nacional de Protección de Datos de Brasil (ANPD)** (https://www.gov.br/anpd/);
*  **Instituto Nacional de Transparencia, Acceso a la Información y Protección de Datos Personales (INAI) de México** (https://home.inai.org.mx/);
*  **Agencia de Acceso a la Información Pública (AAIP) de Argentina** (https://www.argentina.gob.ar/aaip);
*  **Superintendencia de Industria y Comercio (SIC) de Colombia** (https://www.sic.gov.co/);
* otras autoridades nacionales competentes, cuando resulte aplicable.
...
*  **Spaarkly garantiza que los datos de sesión y del dispositivo se anonimicen en un plazo de 14 meses**, conforme a las mejores prácticas.
* Se adoptan sólidas **medidas técnicas y organizativas** para prevenir accesos no autorizados, fugas de datos o usos indebidos, según exigen las leyes latinoamericanas, tales como el artículo 46 de la LGPD brasileña y el artículo 19 de la LFPDPPP mexicana.

### Obligaciones de notificación en caso de data breach

* En caso de **violación de datos que pueda causar un riesgo o daño a los interesados**, Spaarkly notificará:
  * a la **autoridad competente en materia de protección de datos**, según los requisitos locales:
    *  **Brasil**: notificación a la ANPD en un plazo de 3 días hábiles desde el conocimiento del incidente, con arreglo a la Resolução CD/ANPD n.º 15/2024;
    *  **México**: notificación oportuna a los interesados tras la confirmación de la violación;
    * otras jurisdicciones según sus respectivos requisitos.
*  **Dado que Spaarkly no recaba información de contacto de los usuarios, no es posible enviar notificaciones individuales de forma directa**. Cuando la ley lo requiera, Spaarkly publicará una **comunicación pública** en su sitio web o a través de otros canales apropiados.
...
* garantizar el cumplimiento de disposiciones específicas sobre transferencias, tales como:
  * los requisitos de la **LGPD brasileña** para las transferencias internacionales (artículos 33 a 36);
  * los principios de la **LFPDPPP mexicana** para la compartición transfronteriza de datos;
  * el requisito argentino de **nivel adecuado** con arreglo a la PDPA;
  * los requisitos de la **SIC colombiana** para las transferencias transfronterizas;
* implementar mecanismos de transferencia jurídicamente reconocidos, tales como:
  * cláusulas contractuales tipo;
  * normas corporativas vinculantes;
  * mecanismos de certificación;
  * consentimiento específico a la transferencia;
...
## H. JAPÓN (APPI — ACT ON THE PROTECTION OF PERSONAL INFORMATION)
...
### Derechos de los usuarios con arreglo al APPI japonés

Los usuarios en **Japón** gozan de derechos específicos con arreglo al APPI, entre ellos:

*  **derecho de divulgación** (*Kaiji*): solicitar la divulgación de los datos personales en poder de un operador comercial;
*  **derecho de corrección** (*Seigō*): solicitar la corrección, integración o supresión de datos personales inexactos;
*  **derecho a la suspensión del uso/supresión** (*Riyō Teishi / Sakujo*): solicitar la suspensión del uso o la supresión de datos personales tratados en infracción de la ley o más allá de la finalidad especificada;
*  **derecho a la suspensión de la comunicación a terceros** (*Daisansha Teikyō no Teishi*): solicitar al operador que cese la comunicación de datos personales a terceros;
*  **derecho a una explicación** (*Setsumei*): recibir una explicación de las actividades de tratamiento relativas a los datos personales;
*  **derecho de reclamación** (*Kujō*): presentar una reclamación ante el operador o ante la PPC.
...
*  **Personal Information Protection Commission (PPC) de Japón** (https://www.ppc.go.jp/en/).
...
*  **Spaarkly garantiza que los datos de sesión y del dispositivo se anonimicen en un plazo de 14 meses**, conforme a las mejores prácticas.
*  **Spaarkly implementa medidas de seguridad completas** según exige el artículo 23 del APPI, entre ellas:
* controles de acceso y mecanismos de autenticación;
* cifrado de los datos en tránsito y en reposo;
* evaluaciones y actualizaciones periódicas de la seguridad;
* formación del personal en materia de protección de datos.

### Obligaciones de notificación en caso de data breach

* En caso de **pérdida de datos personales u otro incidente de seguridad** (*Jōhō Rōei Jiko*), Spaarkly:
  * efectuará una **notificación oportuna a la PPC** con arreglo al artículo 26 del APPI, cuando la violación alcance el umbral de notificación;
  * incluirá en la notificación los detalles del incidente, los tipos de datos afectados, la causa y las medidas correctivas;
  * cuando la ley lo requiera, publicará una **comunicación pública** en el sitio de Spaarkly o a través de otros canales apropiados, dado que **las notificaciones individuales directas no son posibles** en ausencia de datos de contacto recabados.
...
* garantizar el cumplimiento del artículo 28 del APPI en materia de transferencias internacionales, que exige:
  * el consentimiento previo de la persona para transferencias a terceros en países extranjeros; o bien
  * la garantía de que el tercero se encuentre en un país con estándares equivalentes de protección de datos; o bien
  * la garantía de que el tercero mantenga estándares equivalentes mediante acuerdos contractuales u otros medios;
* implementar mecanismos de transferencia apropiados, tales como:
  * cláusulas contractuales tipo;
  * normas corporativas vinculantes;
  * certificaciones reconocidas;
* facilitar información clara a los usuarios sobre las potenciales transferencias transfronterizas de conformidad con los requisitos del APPI.
...
*  los **datos faciales** utilizados para el Virtual Try-On se tratan **localmente en el dispositivo** y no se conservan; en el caso de **AR PD Meter**, datos técnicos derivados, no utilizados para identificar al Usuario y no aptos, por sí solos, para identificarlo, pueden transmitirse temporalmente al backend de ARShades situado en la Unión Europea, se utilizan exclusivamente para devolver el resultado de la medición y se descartan tras su procesamiento;
*  **ausencia de recogida de datos biométricos o sensibles**: Spaarkly no recaba identificadores biométricos, nombres reales, datos de contacto u otros datos unívocamente identificativos del usuario;
*  los **datos de sesión y del dispositivo** (incluida la dirección IP) se conservan en **servidores situados en la Unión Europea** y se anonimizan en un plazo de 14 meses.
...
### Derechos de los usuarios con arreglo a la PIPL
...
*  **derecho de rectificación**: solicitar la corrección de datos inexactos o incompletos;
*  **derecho de supresión**: solicitar la supresión de los datos personales en condiciones específicas;
*  **derecho a limitar u oponerse al tratamiento**: oponerse a determinadas actividades de tratamiento;
*  **derecho a revocar el consentimiento**: revocar en cualquier momento el consentimiento previamente prestado.

Asimismo, la **PIPL reconoce derechos que van más allá del RGPD**, entre ellos:

*  **derecho a “conocer y decidir”**: los usuarios tienen un control explícito sobre cómo se utilizan sus datos;
*  **derecho a una explicación de las decisiones automatizadas**: los usuarios pueden solicitar una explicación sobre cómo los sistemas automatizados, tales como las recomendaciones basadas en IA, inciden sobre ellos.
...
* a las **autoridades regulatorias chinas competentes**, cuando así lo exija la **PIPL**;
* cuando la ley lo requiera, se publicará una **comunicación pública** en el sitio de Spaarkly o a través de otros canales apropiados.
...
*  **realizar una evaluación de seguridad** con arreglo a las normas de la CAC, cuando se requiera;
*  **implementar Cláusulas Contractuales Tipo (CCT) aprobadas por la CAC** u otros mecanismos aprobados;
*  **obtener el consentimiento explícito del usuario** para eventuales transferencias transfronterizas, si se estima necesario.
...
## J. SUDÁFRICA (POPIA – PROTECTION OF PERSONAL INFORMATION ACT)
...
### Derechos de los usuarios con arreglo al POPIA

Los usuarios en **Sudáfrica** gozan de derechos similares a los previstos por el **RGPD**, entre ellos:

*  **derecho de acceso**: solicitar una copia de sus datos personales;
*  **derecho de rectificación**: solicitar la corrección de datos inexactos o incompletos;
*  **derecho de supresión**: solicitar la supresión de los datos personales en casos específicos;
*  **derecho a limitar u oponerse al tratamiento**: oponerse a determinadas actividades de tratamiento;
*  **derecho a revocar el consentimiento**: revocar en cualquier momento el consentimiento previamente prestado.

Los usuarios pueden ejercer sus derechos poniéndose en contacto con **privacy@spaarkly.com**. Si no están satisfechos con la respuesta de Spaarkly, pueden dirigirse al **Information Regulator of South Africa** ([https://inforegulator.org.za/](https://inforegulator.org.za/)).

### Conservación de datos y medidas de seguridad

El POPIA exige que los datos personales se **conserven únicamente durante el tiempo necesario** para la finalidad prevista.

*  **Spaarkly garantiza que los datos de sesión y del dispositivo se anonimicen en un plazo de 14 meses**.
* Se adoptan sólidas **medidas técnicas y organizativas** para prevenir accesos no autorizados, fugas de datos o usos indebidos.
...
* al **Information Regulator of South Africa**, cuando así lo exija el **POPIA**;
* cuando la ley lo requiera, se publicará una **comunicación pública** en el sitio de Spaarkly o a través de otros canales apropiados.
...
*  **garantizar que cualquier transferencia de datos sea conforme a la Sección 72 del POPIA**, que exige una protección adecuada;
*  **implementar Cláusulas Contractuales Tipo (CCT)** u otros mecanismos de transferencia jurídicamente reconocidos, cuando sea necesario;
*  **obtener el consentimiento explícito del usuario** para eventuales transferencias transfronterizas, en caso de que ello se convierta en un requisito legal.
...
### Derechos de los usuarios con arreglo al DPDP

Los usuarios en **India** gozan de derechos similares a los previstos por el **RGPD**, entre ellos:

*  **derecho de acceso**: solicitar un resumen de los datos personales tratados;
*  **derecho de rectificación**: solicitar la corrección de datos inexactos o incompletos;
*  **derecho de supresión**: solicitar la supresión de los datos personales en condiciones específicas;
*  **derecho a limitar u oponerse al tratamiento**: oponerse a determinadas actividades de tratamiento;
*  **derecho a nombrar un representante**: designar a otra persona para ejercer sus derechos en caso de fallecimiento o incapacidad.
...
*  **Spaarkly garantiza que los datos de sesión y del dispositivo se anonimicen en un plazo de 14 meses**, en línea con las mejores prácticas.
* Se adoptan sólidas **medidas técnicas y organizativas** para prevenir accesos no autorizados, fugas de datos o usos indebidos.

### Obligaciones de notificación en caso de data breach

* En caso de **violación de datos personales**, Spaarkly notificará:
  * al **Data Protection Board of India** y, según exige el **DPDP**, a los interesados afectados;
  * al no disponer de datos de contacto de los Usuarios, la comunicación a los interesados se efectuará mediante **comunicación pública** en el sitio de Spaarkly y, cuando sea posible, mediante aviso dentro del servicio, como medio disponible más eficaz.
...
*  **garantizar el cumplimiento de los requisitos DPDP en materia de localización y transferencia de datos**;
*  **implementar mecanismos de transferencia jurídicamente reconocidos**, tales como cláusulas contractuales aprobadas por el gobierno;
*  **obtener el consentimiento explícito del usuario** para eventuales transferencias transfronterizas, en caso de que ello se convierta en un requisito legal.
...
## L. ORIENTE MEDIO (EMIRATOS ÁRABES UNIDOS – Dubái – Arabia Saudí – Otros Países)

Los usuarios en **Oriente Medio** están protegidos por diversas leyes nacionales de protección de datos, entre ellas:

*  **Emiratos Árabes Unidos (UAE)**: **Federal Decree-Law No. 45 of 2021 on the Protection of Personal Data**;
*  **Dubai International Financial Centre (DIFC)**: **DIFC Data Protection Law No. 5 of 2020**;
*  **Arabia Saudí**: **Personal Data Protection Law (PDPL)**;
*  **otras normativas nacionales aplicables en materia de privacidad**.

### Cumplimiento de las leyes de privacidad de Oriente Medio
...
### Derechos de los usuarios con arreglo a las leyes de privacidad de Oriente Medio
...
* la **Saudi Data & Artificial Intelligence Authority (SDAIA)**, autoridad competente con arreglo a la Personal Data Protection Law (PDPL) saudí.
...
* En caso de **violación de datos que pueda causar daños significativos**, Spaarkly notificará:
  * a la **autoridad competente en materia de protección de datos de Oriente Medio**, cuando así lo exija la ley local;
  * cuando la ley lo requiera, se publicará una **comunicación pública** en el sitio de Spaarkly o a través de otros canales apropiados.
*  **Dado que Spaarkly no recaba información de contacto de los usuarios, no es posible enviar notificaciones individuales**.
...
*  **garantizar el cumplimiento de las leyes locales de protección de datos en materia de transferencias internacionales**;
*  **implementar mecanismos de transferencia jurídicamente reconocidos**, tales como Cláusulas Contractuales Tipo (CCT) o marcos aprobados por el gobierno;
*  **obtener el consentimiento explícito del usuario** para eventuales transferencias transfronterizas, en caso de que ello se convierta en un requisito legal.
...
### Cumplimiento de los estándares internacionales sobre privacidad
...
### Derechos de los usuarios en otros países
...
*  **acceder a sus datos personales** y solicitar una copia de ellos;
*  **solicitar correcciones** de datos inexactos o incompletos;
*  **solicitar la supresión** de los datos personales en condiciones específicas;
*  **oponerse a determinadas actividades de tratamiento**;
*  **revocar el consentimiento**, cuando resulte aplicable.
...
* Spaarkly garantiza que los datos de sesión y del dispositivo se anonimicen en un plazo de **14 meses**, en línea con las mejores prácticas.
* Se adoptan rigurosas medidas técnicas y organizativas para prevenir accesos no autorizados, fugas de datos o usos indebidos.
...
* A la autoridad competente en materia de protección de datos, cuando así lo exija la normativa local.
* Si la ley la obliga, publicará un aviso público en su sitio web o a través de otros canales apropiados.

Dado que Spaarkly **no recaba información de contacto de los usuarios**, no es posible enviar notificaciones individuales.

### Transferencias Internacionales de Datos y Garantías de Cumplimiento
...
* Garantizar el cumplimiento de las **leyes locales de protección de datos relativas a las transferencias internacionales**.
* Implementar **mecanismos de transferencia jurídicamente reconocidos**, tales como **Cláusulas Contractuales Tipo (CCT)** o marcos aprobados por el gobierno.
* Obtener el **consentimiento explícito de los usuarios** para eventuales transferencias transfronterizas, en caso de que ello se convierta en una obligación legal.

...
*Solutions ARShades* </br> *Dernière mise à jour : 06 juillet 2026*
...
*  **ARShades Virtual Try-On** (« ARShades VTO », « VTO », « Web VTO », « VTO App », « Applications et Services ») ;
...
*  **Données à caractère personnel** : toute information se rapportant à une personne physique identifiable, y compris l’adresse IP, l’e-mail et d’autres données fournies volontairement par l’utilisateur.
*  **Données de session** : informations collectées au cours d’une session utilisateur, telles que les horodatages d’interaction, les pages consultées et les statistiques d’utilisation. Elles sont conservées jusqu’à **14 mois** avant leur anonymisation.
*  **Données de l’appareil** : informations techniques relatives à l’appareil de l’utilisateur, notamment le **type d’appareil, le système d’exploitation, la version du navigateur et la langue préférée**. Elles sont utilisées aux fins d’optimisation et de sécurité du service.
*  **Données de géolocalisation** : sous réserve du consentement de l’utilisateur, ARShades peut collecter la position approximative fondée sur l’**adresse IP** ou, dans les applications autonomes, la **position GPS précise**, afin de fournir des services fondés sur la localisation. Les utilisateurs peuvent désactiver cette fonctionnalité à tout moment.
*  **Responsable du traitement** : Spaarkly s.r.l., qui détermine les finalités et les moyens du traitement des données à caractère personnel.
*  **Traitement** : toute opération effectuée sur des données à caractère personnel, y compris la **collecte, la conservation, l’anonymisation et l’effacement**.
*  **Cookies et technologies de traçage** : cookies essentiels nécessaires au fonctionnement du service et outils d’analyse facultatifs, lorsqu’ils sont activés par l’utilisateur. Aucun cookie de marketing n’est utilisé.
*  **Droits de la personne concernée** : les Utilisateurs peuvent **accéder à leurs données, les rectifier, les effacer ou en limiter** le traitement, conformément au RGPD, au CCPA et à des réglementations analogues. Les demandes peuvent être adressées à **privacy@spaarkly.com**.
*  **Transferts internationaux de données** : lorsque des données à caractère personnel sont transférées en dehors de l’**Espace économique européen (EEE)**, Spaarkly garantit la conformité au moyen de **Clauses Contractuelles Types (CCT)** ou de garanties équivalentes.
*  **ARShades VTO** : solution d’**essayage virtuel (virtual try-on, VTO)** permettant aux utilisateurs de visualiser la manière dont des lunettes s’adaptent à leur visage en **réalité augmentée (RA) en temps réel**. Elle fonctionne sur **appareils web et mobiles** sans conserver de données biométriques.
*  **ARShades VTO Explorer** : module d’essayage virtuel photographique et de catalogue augmenté permettant aux Utilisateurs de générer des aperçus réalistes et personnalisés de plusieurs produits de lunetterie à partir d’un nombre limité d’images acquises au cours de la session. VTO Explorer peut être intégré à des solutions ARShades web, mobiles, catalogues, miroirs ou à d’autres expériences en point de vente. Les images acquises sont traitées localement sur l’appareil de l’Utilisateur ou sur l’appareil utilisé pour l’expérience et ne sont pas téléversées automatiquement sur les serveurs de Spaarkly. Lorsque VTO Explorer est utilisé sur un appareil installé dans un point de vente, un showroom, un lieu d’événement ou tout autre lieu public, et que l’Utilisateur choisit d’obtenir, de télécharger ou de partager sur son propre appareil les photos finales, seules les photos finales sélectionnées par l’Utilisateur peuvent être temporairement téléversées sur les serveurs de Spaarkly, à seule fin de les mettre à la disposition de l’Utilisateur, et sont effacées selon les modalités décrites dans la présente Politique.
...
*  **Fourniture des Services VTO** : permettre à l’Utilisateur d’essayer virtuellement des montures de lunetterie, de tester des formes et des tailles et d’utiliser des outils tels que la mesure de la distance pupillaire (base juridique : exécution d’un contrat ou de mesures précontractuelles prises à la demande de la personne concernée, au sens de l’article 6, paragraphe 1, point b), du RGPD).
*  **Amélioration du service, analyse, sécurité et prévention de la fraude** : améliorer la qualité, la facilité d’utilisation, la compréhension analytique et la sécurité de nos Services, générer des statistiques anonymes sur l’utilisation et les performances des expériences ARShades, prévenir les usages illicites et la fraude et garantir l’intégrité des réseaux et des systèmes (base juridique : intérêt légitime, article 6, paragraphe 1, point f), du RGPD).
*  **Obligations légales** : satisfaire à des obligations légales ou à des injonctions des autorités compétentes en matière de conservation des données, de sécurité et d’autres exigences réglementaires (base juridique : obligation légale, article 6, paragraphe 1, point c), du RGPD).
*  **Consentement, le cas échéant** : lorsque le consentement est requis, par exemple pour l’accès à la caméra, pour l’acquisition des images nécessaires à l’utilisation du module VTO Explorer ou pour la conservation temporaire des photos finales sélectionnées par l’Utilisateur en vue de leur téléchargement ou de leur partage au moyen de fonctionnalités telles que « Shoot & Share » ou de fonctions de téléchargement équivalentes, le traitement sera fondé sur le consentement (article 6, paragraphe 1, point a), du RGPD), révocable à tout moment sans porter atteinte à la licéité du traitement effectué avant sa révocation.
...
* opère sur des points mathématiques anonymes communs à tous les visages ;
* ne permet pas de remonter des mesures à l’identité de personnes déterminées ;
* n’utilise ni ne conserve de données à des fins de reconnaissance faciale ;
* traite les données faciales du Virtual Try-On localement sur l’appareil de l’Utilisateur, sans conservation côté serveur ;
* pour AR PD Meter, utilise temporairement des données techniques dérivées sur le backend ARShades uniquement pour calculer et restituer le résultat PD, en les supprimant après traitement.
...
### Données de mesure faciale (non biométriques)
...
* longueur et largeur du nez ;
* hauteur des pommettes ;
* largeur du visage au niveau des pommettes ;
* largeur du visage au niveau de la bouche ;
* longueur du menton ;
...
* langue préférée ;
* marques et produits consultés ;
* dates et heures d’accès ;
* statistiques anonymes sur les interactions avec l’app VTO, par exemple si l’Utilisateur porte des lunettes.
...
*  **Géolocalisation précise** : sous réserve du consentement explicite, des applications autonomes ARShades déterminées peuvent collecter des coordonnées de géolocalisation précises depuis l’appareil afin de fournir des services ou des recommandations fondés sur la localisation.
*  **Position approximative** : en l’absence de consentement explicite à la position précise, nous pouvons déduire une position approximative sur la base de l’adresse IP.

La collecte des données de géolocalisation dans les applications autonomes est :

*  **facultative** : il est possible de refuser les autorisations de localisation sans porter atteinte aux fonctionnalités VTO principales ;
*  **fondée sur le consentement** : la géolocalisation précise n’est collectée que sous réserve du consentement explicite ;
*  **limitée aux finalités** : utilisée uniquement pour fournir des recommandations de lunetterie pertinentes ou des services fondés sur la localisation ;
*  **soumise à la même politique de conservation** : anonymisée dans un délai de 14 mois avec les autres données techniques.
...
* mémorisé localement par le navigateur pour de futures visites de la même application ;
* configuré de manière à être demandé à chaque fois ;
* accordé temporairement uniquement pour la session en cours.
...
* Les images acquises pour l’essayage virtuel, la personnalisation, la génération du catalogue, l’adaptation faciale, la segmentation, le positionnement du produit et le rendu sont traitées localement sur l’appareil sans transfert automatique vers les serveurs de Spaarkly.
* Dans les versions de VTO Mirror qui incluent le module **VTO Explorer**, telles que **Mirror Showroom**, les images acquises au cours de la phase de personnalisation sont utilisées localement pour générer des aperçus du catalogue augmenté et ne sont pas téléversées sur les serveurs de Spaarkly.
* Ce n’est que lorsque l’Utilisateur choisit activement d’obtenir, de télécharger ou de partager des photos finales le représentant portant les lunettes sélectionnées depuis un appareil installé dans un point de vente, un showroom, un lieu d’événement ou tout autre lieu public que ces photos finales sélectionnées peuvent être temporairement téléversées sur les serveurs de Spaarkly, à seule fin de les mettre à la disposition de l’Utilisateur sur son propre appareil.
* L’exploitant du point de vente n’a pas d’accès direct aux données ou aux images générées par les Utilisateurs, l’accès au logiciel étant réservé exclusivement à ARShades.
* ARShades s’engage à ne pas accéder aux données de l’Utilisateur, sauf lorsque cela est nécessaire à des activités déterminées de maintenance technique, toujours sans visualiser ni traiter les images acquises.
* Spaarkly ne communique pas les données des Utilisateurs à des tiers pour les finalités propres de ces derniers. Pour l’hébergement et la fourniture des services, Spaarkly peut faire appel à des fournisseurs qualifiés d’infrastructure cloud, dont les serveurs sont situés dans l’Union européenne, désignés sous-traitants au sens de l’article 28 du RGPD et liés par des accords de traitement des données appropriés. Les opérations de traitement sont réalisées exclusivement par le personnel autorisé de Spaarkly et par ces fournisseurs, dans les limites des instructions données.

### Effacement automatique et mesures de sécurité

* Les photos finales temporairement téléversées au moyen de **VTO Mirror**, de **VTO Explorer**, de « Shoot & Share » ou de fonctionnalités équivalentes de téléchargement/partage depuis des appareils installés dans des points de vente, showrooms, lieux d’événements ou autres lieux publics peuvent être effacées immédiatement de nos serveurs par les Utilisateurs après avoir été téléchargées sur leur propre appareil, lorsque cette option est disponible. Si les Utilisateurs n’effacent pas manuellement leurs photos, notre système les supprime automatiquement après **24 heures** au moyen d’un script dédié, sans intervention manuelle.
* Les données temporairement conservées sont **chiffrées au repos et en transit** afin d’en garantir la sécurité.
* Tous les accès aux appareils ARShades à des fins de maintenance technique sont consignés dans un **registre des accès**, conformément à l’**article 5, paragraphe 1, point f), du RGPD**.
* Le logiciel est configuré de manière à limiter l’accès aux données exclusivement au **personnel autorisé d’ARShades**.

### Rôle d’ARShades et du point de vente

*  **ARShades demeure l’unique responsable du traitement** des données générées au moyen de VTO Mirror.
* Le **point de vente ne traite pas les données des utilisateurs**, dès lors qu’il n’a accès ni aux données générées ni à la gestion du logiciel.
...
* activent des **fonctionnalités de base du site**, telles que la gestion de la session et la sécurité ;
*  **ne** suivent **pas** les utilisateurs sur différents sites web ;
...
|---|---|---|
|<b>visited</b>|90 jours|Identifie si l’Utilisateur a déjà utilisé le service.|
|<b>consent</b>|120 minutes|Identifie si l’Utilisateur a donné son consentement à la Politique de confidentialité et aux Conditions générales d’utilisation d’ARShades.|
|<b>lang</b>|90 jours|Enregistre et mémorise la langue préférée de l’utilisateur entre les sessions du navigateur.|
...
*  **des systèmes de gestion des accès** destinés à prévenir tout accès non autorisé aux systèmes et aux données.
...
*  **évaluera le niveau de risque** au sens de l’**article 33 du RGPD**. Nous évaluerons toute violation potentielle conformément à l’article 33 du RGPD et notifierons l’**autorité de contrôle** compétente dans un délai de **72 heures** lorsque la loi applicable l’exige ;
*  **en l’absence de données à caractère personnel de contact**, n’est **pas en mesure de notifier directement les utilisateurs individuels**. Lorsque cela est requis, nous publierons à la place un **avis public** au moyen de notre site officiel ou d’autres canaux ;
*  **atténuera et résoudra** l’incident dans les meilleurs délais, en mettant en œuvre, si nécessaire, des mesures de sauvegarde supplémentaires.
...
* Demander la confirmation qu’un traitement de leurs données à caractère personnel est ou non en cours.
* Obtenir l’accès aux informations pertinentes, telles que les finalités, les catégories de données traitées, les destinataires ou catégories de destinataires, la durée de conservation, etc.
...
* Demander l’effacement des données à caractère personnel si :
  * les données ne sont plus nécessaires au regard des finalités pour lesquelles elles ont été collectées ;
  * le consentement est retiré, lorsque le traitement est fondé sur le consentement ;
...
* Demander la limitation du traitement si :
  ...
  * le traitement est illicite, mais l’effacement est refusé ;
  * les données sont nécessaires à la constatation, à l’exercice ou à la défense d’un droit en justice, même si le responsable du traitement n’en a plus besoin ;
  * la personne concernée s’oppose au traitement, dans l’attente de la vérification des motifs légitimes.

### Droit à la portabilité des données

* Recevoir ses données à caractère personnel dans un format structuré, couramment utilisé et lisible par machine.
* Demander leur transmission directe à un autre responsable du traitement, lorsque cela est techniquement possible.
...
* Retirer le consentement **à tout moment** lorsque le traitement est fondé sur le consentement.
...
* consulter l’état actuel de son consentement ;
* accéder à notre Politique de confidentialité complète ;
* retirer le consentement précédemment donné.
...
* du **Garante per la Protezione dei Dati Personali** italien : **[www.garanteprivacy.it](http://www.garanteprivacy.it)** ;
* d’une autre **autorité de contrôle compétente** dans votre pays de résidence.
...
* des mises à jour de la **technologie** ;
* de nouvelles **exigences légales** ;
* des modifications internes des **politiques**.
...
*  les **droits supplémentaires ou différents** par rapport à ceux décrits dans la Politique principale ;
*  les **modalités d’exercice de ces droits**, y compris les contacts locaux, les procédures et les délais de réponse ;
*  les **éventuelles exigences supplémentaires en matière de consentement** ;
*  les **exigences spécifiques de conservation des données** ;
*  les **obligations locales de notification en cas de violation de données** ;
*  les **règles relatives aux transferts de données**, y compris les clauses contractuelles types et les exigences locales.
...
### Index des Addenda régionaux et nationaux
 ...
 1. [Union européenne / Espace économique européen / Royaume-Uni](#a-royaume-uni-uk-gdpr--union-européenne-et-espace-économique-européen-ue-eee)
 2. [Suisse](#b-suisse-fadp--federal-act-on-data-protection)
 3. [États-Unis](#c-états-unis--addendum-usa)
 4. [Canada](#d-canada-pipeda--personal-information-protection-and-electronic-documents-act)
 5. [Australie et Nouvelle-Zélande](#e-australie-et-nouvelle-zélande)
 6. [Région Asie-Pacifique](#f-région-asie-pacifique)
 7. [Brésil et Amérique latine](#g-brésil-et-amérique-latine)
 8. [Japon](#h-japon-appi--act-on-the-protection-of-personal-information)
 9. [Chine](#i-chine-pipl--personal-information-protection-law)
10. [Afrique du Sud](#j-afrique-du-sud-popia--protection-of-personal-information-act)
11. [Inde](#k-inde-dpdp--digital-personal-data-protection-act)
12. [Moyen-Orient](#l-moyen-orient-émirats-arabes-unis--dubaï--arabie-saoudite--autres-pays)
13. [Autres pays](#m-autres-pays)
...
*  **Utilisateurs UE/EEE** : l’**autorité de contrôle** de l’État membre concerné.
*  **Utilisateurs UK** : l’**Information Commissioner’s Office (ICO)** ([https://ico.org.uk/](https://ico.org.uk/)).
...
*  les **Clauses Contractuelles Types (CCT)** de la Commission européenne pour les transferts depuis l’UE/EEE ;
*  les **CCT approuvées par l’ICO** pour les transferts depuis le Royaume-Uni ;
*  des **garanties supplémentaires lorsque cela est nécessaire**, conformément aux lignes directrices de l’European Data Protection Board (EDPB) et de l’ICO.
...
*  d’**accéder** à leurs données à caractère personnel traitées par Spaarkly ;
*  de **demander la correction** ou l’effacement de données inexactes ou non nécessaires ;
*  de **s’opposer au traitement des données** à des fins de **marketing direct**.
...
* le **Préposé fédéral à la protection des données et à la transparence (FDPIC)** ;
* les **personnes concernées**, lorsque la loi suisse l’exige.

### Transferts internationaux de données

Les données à caractère personnel des utilisateurs suisses **ne sont pas transférées en dehors de la Suisse**, sauf si :

* le pays de destination est réputé disposer d’un **niveau de protection adéquat** par les autorités suisses ;
* des **Clauses Contractuelles Types (CCT)** approuvées par la Commission européenne sont mises en œuvre pour les transferts vers l’UE/EEE ;
* d’autres **garanties conformes au FADP suisse** sont adoptées pour protéger les données transférées.
...
*  **Texas** : **Capture or Use of Biometric Identifier Act (CUBI)** et **Texas Data Privacy and Security Act (TDPSA)** ;
*  **Washington** : loi sur la vie privée biométrique (**RCW 19.375**) ;
*  **autres lois étatiques applicables en matière de vie privée**.
...
*  de **savoir** quelles catégories de données à caractère personnel nous collectons ;
*  de **comprendre** les finalités du traitement ;
*  de **demander l’effacement** de leurs données à caractère personnel, sous réserve des exceptions autorisées par la loi ;
*  de **s’opposer à la vente ou au partage** de leurs données, le cas échéant ;
*  de **ne pas subir de discrimination** en raison de l’exercice de leurs droits en matière de vie privée.
...
* des droits d’**accès, de rectification et d’effacement** ;
* des droits d’**opt-out** à l’égard de la publicité ciblée ou de la vente de données à caractère personnel, le cas échéant. Bien qu’ARShades n’exerce pas de telles activités, les résidents du Montana et de l’Oregon peuvent néanmoins demander confirmation en contactant Spaarkly.

#### 3\. Illinois (BIPA), Texas (CUBI), Washington (RCW 19.375)

*  **Spaarkly ne collecte pas de données biométriques** telles que définies par ces lois.
* ARShades traite exclusivement des **points mathématiques de repère faciaux** à des fins d’essayage virtuel et, au moyen d’AR PD Meter, de calcul de la distance pupillaire, lesquels :
  *  **ne peuvent pas être utilisés pour identifier de manière unique** une personne ;
  * pour le Virtual Try-On, sont **traités localement sur l’appareil de l’utilisateur** et jamais conservés ;
  * pour **AR PD Meter**, peuvent être transmis temporairement, en tant que données techniques dérivées non rattachables à l’identité de l’Utilisateur, au backend ARShades situé dans l’Union européenne, utilisés exclusivement pour restituer le résultat de la mesure et **supprimés après traitement**, sans jamais être conservés ;
  *  **ne créent pas d’identifiant persistant** rattaché à un individu.

#### 4\. Autres États des États-Unis

* Certains États **ne disposent pas encore** de lois générales sur la vie privée.
* En pareils cas, **Spaarkly** suit les **principes généraux décrits dans la présente Politique de confidentialité** et se conforme à toute réglementation étatique applicable.

### Comment exercer ses droits

Les résidents des États-Unis peuvent nous contacter à l’adresse **[privacy@spaarkly.com](mailto:privacy@spaarkly.com)**, en précisant leur État de résidence.
...
* toute donnée de mesure faciale est traitée en temps réel et n’est jamais conservée au-delà de la session immédiate ;
* les données techniques dérivées transmises temporairement au backend ARShades pour AR PD Meter sont utilisées uniquement pour restituer le résultat de la mesure et supprimées après traitement ;
* les données de session et de l’appareil sont anonymisées et dissociées dans un délai de 14 mois.
...
*  les **données faciales** utilisées pour le Virtual Try-On sont traitées **localement sur l’appareil** et ne sont pas conservées ; pour **AR PD Meter**, des données techniques dérivées, non rattachables à l’identité de l’Utilisateur, peuvent être transmises temporairement au backend ARShades situé dans l’Union européenne, utilisées exclusivement pour restituer le résultat de la mesure et supprimées après traitement ;
*  **aucune donnée biométrique ou identifiant unique** n’est collecté, pas plus que de noms, coordonnées ou profils d’utilisateur ;
*  les **données de session et de l’appareil** (y compris l’adresse IP) sont conservées sur des **serveurs situés dans l’Union européenne** et anonymisées dans un délai de 14 mois ; les éventuelles photos finales demandées par l’Utilisateur depuis des appareils en point de vente sont effacées dans un délai de 24 heures. Cela peut entraîner un transfert de ces données vers l’UE, avec les garanties décrites dans la section « Transferts internationaux » du présent Addendum.
...
*  le **droit d’accès** : demander une copie de leurs données à caractère personnel et des informations sur leur utilisation ;
*  le **droit de rectification** : demander la correction de données inexactes ou incomplètes ;
*  le **droit de retirer le consentement** : retirer à tout moment le consentement précédemment donné ;
*  le **droit de contester la conformité** : contester la conformité d’une organisation aux principes du PIPEDA ;
*  le **droit de recours** : introduire une réclamation auprès de l’autorité compétente en matière de protection des données.
...
*  à l’**Office of the Privacy Commissioner of Canada (OPC)** (https://www.priv.gc.ca/en/) ;
* aux commissaires provinciaux à la protection de la vie privée de la **Colombie-Britannique, de l’Alberta ou du Québec**, le cas échéant.
...
*  **Spaarkly garantit que les données de session et de l’appareil sont anonymisées dans un délai de 14 mois**, conformément aux meilleures pratiques.
* Des **mesures techniques et organisationnelles** robustes sont mises en œuvre pour prévenir tout accès non autorisé, toute fuite de données ou tout usage abusif.

### Obligations de notification en cas de violation de données

* En cas de **violation de données présentant un risque réel de préjudice grave**, Spaarkly notifiera :
  * l’**Office of the Privacy Commissioner of Canada (OPC)** ;
  * les commissaires provinciaux à la protection de la vie privée, lorsque la loi provinciale l’exige ;
  * lorsque la loi l’exige, une **communication publique** sera publiée sur le site de Spaarkly ou par d’autres canaux appropriés.
...
* garantir la conformité au **principe de responsabilité (Accountability)** du PIPEDA en matière de transferts internationaux ;
* mettre en œuvre des **Clauses Contractuelles Types (CCT)** ou d’autres mécanismes de transfert juridiquement reconnus, lorsque cela est nécessaire ;
* fournir des informations claires et accessibles sur les éventuels transferts transfrontaliers et les risques y afférents.
...
*  **Australie** : **Privacy Act 1988 (Cth)**, y compris les **Australian Privacy Principles (APPs)**, et **Privacy Amendment (Notifiable Data Breaches) Act 2017** ;
*  **Nouvelle-Zélande** : **Privacy Act 2020**, y compris les **Information Privacy Principles (IPPs)**, sous le contrôle de l’**Office of the Privacy Commissioner (OPC)**.
...
*  le **droit d’accès** : demander l’accès à leurs données à caractère personnel détenues par une organisation ;
*  le **droit de correction** : demander la correction de données inexactes, obsolètes, incomplètes ou trompeuses ;
*  le **droit d’opposition** : s’opposer à certains types de traitement, en particulier le marketing direct en Australie et les traitements susceptibles de causer un préjudice, un désagrément ou un dommage significatifs en Nouvelle-Zélande ;
*  le **droit de réclamation** : introduire une réclamation auprès de l’autorité compétente en matière de vie privée s’ils estiment que leurs droits ont été violés ;
*  le **droit à des réparations** : obtenir réparation pour les atteintes à la vie privée, notamment correction, excuses ou indemnisation, le cas échéant.
...
*  à l’**Office of the Australian Information Commissioner (OAIC)** (https://www.oaic.gov.au/) ;
*  à l’**Office of the Privacy Commissioner (OPC) de Nouvelle-Zélande** (https://www.privacy.org.nz/).
...
*  **Spaarkly garantit que les données de session et de l’appareil sont anonymisées dans un délai de 14 mois**, conformément aux meilleures pratiques.
* Des **mesures techniques et organisationnelles** robustes sont mises en œuvre pour prévenir tout accès non autorisé, toute fuite de données ou tout usage abusif, conformément à l’APP 11 en Australie et à l’IPP 5 en Nouvelle-Zélande.

### Obligations de notification en cas de violation de données

* En cas de **violation de données susceptible d’entraîner un préjudice grave** pour les personnes concernées, Spaarkly notifiera :
  * l’**Office of the Australian Information Commissioner (OAIC)** au titre du régime **Notifiable Data Breaches (NDB)**, en achevant l’évaluation de l’incident dans un délai de 30 jours et en procédant à la notification dès que cela est raisonnablement possible ;
  * l’**Office of the Privacy Commissioner (OPC) de Nouvelle-Zélande** dans les meilleurs délais, conformément aux exigences de notification obligatoire prévues par le Privacy Act 2020.
*  **Dès lors que Spaarkly ne collecte pas les coordonnées de contact des utilisateurs, il n’est pas possible d’adresser directement des notifications individuelles**. Lorsque la loi l’exige, Spaarkly publiera une **communication publique** sur son site web ou par d’autres canaux appropriés.
...
* garantir la conformité à l’**APP 8** et à la **Section 16C de l’Australian Privacy Act** en matière de communications transfrontalières ;
* mettre en œuvre les garanties appropriées requises par l’**IPP 12 du New Zealand Privacy Act 2020** pour les transferts vers l’étranger ;
* fournir aux utilisateurs des informations claires sur les éventuels transferts transfrontaliers et maintenir la responsabilité en matière de protection des données.
...
*  **Singapour** : **Personal Data Protection Act (PDPA)** de 2012, tel que modifié en 2020, appliqué par la **Personal Data Protection Commission (PDPC)** ;
*  **Malaisie** : **Personal Data Protection Act (PDPA)** de 2010, appliqué par le **Personal Data Protection Department (JPDP)** ;
*  **Philippines** : **Data Privacy Act (DPA)** de 2012, appliqué par la **National Privacy Commission (NPC)** ;
*  **Indonésie** : **Personal Data Protection Law (PDP Law)** de 2022, inspirée du RGPD ;
*  **Thaïlande** : **Personal Data Protection Act (PDPA)** de 2019, appliqué par le **Personal Data Protection Committee (PDPC)** ;
*  **Corée du Sud** : **Personal Information Protection Act (PIPA)**, appliqué par la **Personal Information Protection Commission (PIPC)** ;
* d’autres juridictions dotées de cadres réglementaires émergents en matière de protection des données.
...
*  le **droit d’accès** : demander des informations sur la collecte, l’utilisation et la communication des données à caractère personnel ;
*  le **droit de correction** : demander la correction de données à caractère personnel inexactes ou incomplètes ;
*  le **droit de retrait du consentement** : retirer le consentement précédemment donné ;
*  le **droit à la portabilité des données** : demander le transfert des données vers une autre organisation, dans des juridictions telles que Singapour et les Philippines ;
*  le **droit à l’effacement** : demander l’effacement des données à caractère personnel dans des conditions spécifiques, selon la juridiction ;
*  le **droit d’opposition** : s’opposer au traitement à des fins de marketing direct ou à d’autres finalités, selon la juridiction.
...
*  **Personal Data Protection Commission (PDPC) de Singapour** (https://www.pdpc.gov.sg/) ;
*  **Personal Data Protection Department (JPDP) de Malaisie** (https://www.pdp.gov.my/) ;
*  **National Privacy Commission (NPC) des Philippines** (https://privacy.gov.ph/) ;
*  **Personal Data Protection Committee (PDPC) de Thaïlande** ;
*  **Personal Information Protection Commission (PIPC) de Corée du Sud** ;
* d’autres autorités nationales compétentes, le cas échéant.
...
*  **Spaarkly garantit que les données de session et de l’appareil sont anonymisées dans un délai de 14 mois**, conformément aux meilleures pratiques.
* Des **mesures techniques et organisationnelles** robustes sont mises en œuvre pour prévenir tout accès non autorisé, toute fuite de données ou tout usage abusif, y compris le chiffrement, les contrôles d’accès et des évaluations périodiques de la sécurité.

### Obligations de notification en cas de violation de données

* En cas de **violation de données susceptible de causer un préjudice aux individus**, Spaarkly notifiera :
  * l’**autorité compétente en matière de protection des données**, selon les exigences locales :
    *  **Singapour** : dans un délai de 3 jours pour les violations à notifier ;
    *  **Philippines** : dans un délai de 72 heures ;
    *  **Thaïlande** : sans retard injustifié, dans un délai de 72 heures ;
    *  **Corée du Sud** : sans retard ;
    * les autres juridictions selon leurs délais respectifs.
*  **Dès lors que Spaarkly ne collecte pas les coordonnées de contact des utilisateurs, il n’est pas possible d’adresser directement des notifications individuelles**. Lorsque la loi l’exige, Spaarkly publiera une **communication publique** sur son site web ou par d’autres canaux appropriés.
...
* garantir la conformité à des dispositions spécifiques relatives aux transferts, telles que :
  * l’**obligation de limitation des transferts** du PDPA de Singapour et ses exigences relatives aux transferts vers l’étranger ;
  * les règles du DPA des Philippines relatives au partage transfrontalier des données ;
  * l’interdiction faite par le PDPA de Malaisie de transférer vers certains pays ;
  * les exigences du PIPA de Corée du Sud relatives aux transferts vers l’étranger ;
* mettre en œuvre des mécanismes de transfert juridiquement reconnus, tels que le consentement, des garanties contractuelles, des règles d’entreprise contraignantes ou des mécanismes de certification ;
* fournir aux utilisateurs des informations claires sur les éventuels transferts transfrontaliers et maintenir la responsabilité en matière de protection des données.
...
*  **Brésil** : **Lei Geral de Proteção de Dados (LGPD)** de 2018, appliquée par l’**Autoridade Nacional de Proteção de Dados (ANPD)** ;
*  **Mexique** : **Ley Federal de Protección de Datos Personales en Posesión de los Particulares (LFPDPPP)** de 2010, appliquée par l’**Instituto Nacional de Transparencia, Acceso a la Información y Protección de Datos Personales (INAI)** ;
*  **Argentine** : **Personal Data Protection Act (PDPA)**, loi n° 25.326, appliquée par l’**Agencia de Acceso a la Información Pública (AAIP)** ;
*  **Colombie** : **Law 1581 of 2012** sur le régime général de protection des données, appliquée par la **Superintendencia de Industria y Comercio (SIC)** ;
*  **Chili** : **Law No. 19.628 on the Protection of Private Life**, avec des réformes réglementaires en cours ;
*  **Uruguay** : **Law No. 18.331 on Personal Data Protection and Habeas Data Action**, appliquée par l’**Unidad Reguladora y de Control de Datos Personales (URCDP)** ;
* d’autres juridictions dotées de cadres réglementaires émergents en matière de protection des données.
...
*  le **droit de confirmation et d’accès** (**droits ARCO**) : confirmer l’existence d’un traitement et accéder aux données à caractère personnel ;
*  le **droit de rectification** (**droits ARCO**) : corriger des données inexactes, incomplètes ou obsolètes ;
*  le **droit d’effacement** (**droits ARCO**) : demander l’effacement de données non nécessaires ou excessives ;
*  le **droit d’opposition** (**droits ARCO**) : s’opposer aux traitements illicites ou non consentis ;
*  le **droit à l’information** : recevoir des informations claires sur les activités de traitement ;
*  le **droit à la portabilité des données** : demander le transfert des données vers un autre fournisseur de services, en particulier au titre de la LGPD brésilienne ;
*  le **droit de retirer le consentement** : retirer à tout moment le consentement précédemment donné ;
*  le **droit à la révision des décisions automatisées** : demander la révision de décisions prises exclusivement au moyen d’un traitement automatisé au titre de la LGPD.
...
*  **Autorité nationale de protection des données du Brésil (ANPD)** (https://www.gov.br/anpd/) ;
*  **Instituto Nacional de Transparencia, Acceso a la Información y Protección de Datos Personales (INAI) du Mexique** (https://home.inai.org.mx/) ;
*  **Agencia de Acceso a la Información Pública (AAIP) de l’Argentine** (https://www.argentina.gob.ar/aaip) ;
*  **Superintendencia de Industria y Comercio (SIC) de la Colombie** (https://www.sic.gov.co/) ;
* d’autres autorités nationales compétentes, le cas échéant.
...
*  **Spaarkly garantit que les données de session et de l’appareil sont anonymisées dans un délai de 14 mois**, conformément aux meilleures pratiques.
* Des **mesures techniques et organisationnelles** robustes sont mises en œuvre pour prévenir tout accès non autorisé, toute fuite de données ou tout usage abusif, comme l’exigent les lois latino-américaines, telles que l’article 46 de la LGPD brésilienne et l’article 19 de la LFPDPPP mexicaine.

### Obligations de notification en cas de violation de données

* En cas de **violation de données susceptible de causer un risque ou un préjudice aux personnes concernées**, Spaarkly notifiera :
  * l’**autorité compétente en matière de protection des données**, selon les exigences locales :
    *  **Brésil** : notification à l’ANPD dans un délai de 3 jours ouvrables à compter de la connaissance de l’incident, au titre de la Resolução CD/ANPD n° 15/2024 ;
    *  **Mexique** : notification en temps utile aux personnes concernées après confirmation de la violation ;
    * les autres juridictions selon leurs exigences respectives.
*  **Dès lors que Spaarkly ne collecte pas les coordonnées de contact des utilisateurs, il n’est pas possible d’adresser directement des notifications individuelles**. Lorsque la loi l’exige, Spaarkly publiera une **communication publique** sur son site web ou par d’autres canaux appropriés.
...
* garantir la conformité à des dispositions spécifiques relatives aux transferts, telles que :
  * les exigences de la **LGPD brésilienne** en matière de transferts internationaux (articles 33 à 36) ;
  * les principes de la **LFPDPPP mexicaine** relatifs au partage transfrontalier des données ;
  * l’exigence argentine de **niveau adéquat** au titre de la PDPA ;
  * les exigences de la **SIC colombienne** relatives aux transferts transfrontaliers ;
* mettre en œuvre des mécanismes de transfert juridiquement reconnus, tels que :
  * des clauses contractuelles types ;
  * des règles d’entreprise contraignantes ;
  * des mécanismes de certification ;
  * un consentement spécifique au transfert ;
...
*  le **droit de divulgation** (*Kaiji*) : demander la divulgation des données à caractère personnel détenues par un opérateur commercial ;
*  le **droit de correction** (*Seigō*) : demander la correction, le complément ou l’effacement de données à caractère personnel inexactes ;
*  le **droit à la suspension de l’utilisation/à l’effacement** (*Riyō Teishi / Sakujo*) : demander la suspension de l’utilisation ou l’effacement de données à caractère personnel traitées en violation de la loi ou au-delà de la finalité spécifiée ;
*  le **droit à la suspension de la communication à des tiers** (*Daisansha Teikyō no Teishi*) : demander à l’opérateur de cesser la communication de données à caractère personnel à des tiers ;
*  le **droit à une explication** (*Setsumei*) : recevoir une explication des activités de traitement relatives aux données à caractère personnel ;
*  le **droit de réclamation** (*Kujō*) : introduire une réclamation auprès de l’opérateur ou de la PPC.
...
*  **Personal Information Protection Commission (PPC) du Japon** (https://www.ppc.go.jp/en/).
...
*  **Spaarkly garantit que les données de session et de l’appareil sont anonymisées dans un délai de 14 mois**, conformément aux meilleures pratiques.
*  **Spaarkly met en œuvre des mesures de sécurité complètes** telles qu’exigées par l’art. 23 de l’APPI, dont :
* les contrôles d’accès et les mécanismes d’authentification ;
* le chiffrement des données en transit et au repos ;
* des évaluations et mises à jour périodiques de la sécurité ;
* la formation du personnel en matière de protection des données.

### Obligations de notification en cas de violation de données

* En cas de **perte de données à caractère personnel ou d’autre incident de sécurité** (*Jōhō Rōei Jiko*), Spaarkly :
  * procédera à un **signalement en temps utile à la PPC** au titre de l’art. 26 de l’APPI, lorsque la violation atteint le seuil de notification ;
  * inclura dans la notification les détails de l’incident, les types de données concernés, la cause et les mesures correctives ;
  * lorsque la loi l’exige, publiera une **communication publique** sur le site de Spaarkly ou par d’autres canaux appropriés, dès lors que **les notifications individuelles directes ne sont pas possibles** en l’absence de données de contact collectées.
...
* garantir la conformité à l’art. 28 de l’APPI en matière de transferts internationaux, lequel exige :
  * le consentement préalable de l’individu pour les transferts à des tiers dans des pays étrangers ; ou
  * la garantie que le tiers se trouve dans un pays doté de normes équivalentes de protection des données ; ou
  * la garantie que le tiers maintient des normes équivalentes au moyen d’accords contractuels ou d’autres moyens ;
* mettre en œuvre des mécanismes de transfert appropriés, tels que :
  * des clauses contractuelles types ;
  * des règles d’entreprise contraignantes ;
  * des certifications reconnues ;
* fournir aux utilisateurs des informations claires sur les éventuels transferts transfrontaliers conformément aux exigences de l’APPI.
...
*  les **données faciales** utilisées pour le Virtual Try-On sont traitées **localement sur l’appareil** et ne sont pas conservées ; pour **AR PD Meter**, des données techniques dérivées, non rattachables à l’identité de l’Utilisateur, peuvent être transmises temporairement au backend ARShades situé dans l’Union européenne, utilisées exclusivement pour restituer le résultat de la mesure et supprimées après traitement ;
*  **absence de collecte de données biométriques ou sensibles** : Spaarkly ne collecte pas d’identifiants biométriques, de noms réels, de coordonnées ou d’autres données identifiant l’utilisateur de manière unique ;
*  les **données de session et de l’appareil** (y compris l’adresse IP) sont conservées sur des **serveurs situés dans l’Union européenne** et anonymisées dans un délai de 14 mois.
...
*  le **droit d’accès** : demander une copie de leurs données à caractère personnel ;
*  le **droit de rectification** : demander la correction de données inexactes ou incomplètes ;
*  le **droit d’effacement** : demander l’effacement des données à caractère personnel dans des conditions spécifiques ;
*  le **droit de limiter le traitement ou de s’y opposer** : s’opposer à certaines activités de traitement ;
*  le **droit de retirer le consentement** : retirer à tout moment le consentement précédemment donné.

En outre, la **PIPL reconnaît des droits qui vont au-delà du RGPD**, notamment :

*  le **droit de « connaître et de décider »** : les utilisateurs disposent d’un contrôle explicite sur la manière dont leurs données sont utilisées ;
*  le **droit à une explication des décisions automatisées** : les utilisateurs peuvent demander une explication de la manière dont des systèmes automatisés, tels que des recommandations fondées sur l’IA, ont une incidence sur eux.
...
* les **autorités réglementaires chinoises compétentes**, lorsque la **PIPL** l’exige ;
* lorsque la loi l’exige, une **communication publique** sera publiée sur le site de Spaarkly ou par d’autres canaux appropriés.
...
*  **réaliser une évaluation de sécurité** au titre des règles de la CAC, lorsqu’elle est requise ;
*  **mettre en œuvre des Clauses Contractuelles Types (CCT) approuvées par la CAC** ou d’autres mécanismes approuvés ;
*  **obtenir le consentement explicite de l’utilisateur** pour d’éventuels transferts transfrontaliers, si cela est jugé nécessaire.
...
*  le **droit d’accès** : demander une copie de leurs données à caractère personnel ;
*  le **droit de rectification** : demander la correction de données inexactes ou incomplètes ;
*  le **droit d’effacement** : demander l’effacement des données à caractère personnel dans des cas spécifiques ;
*  le **droit de limiter le traitement ou de s’y opposer** : s’opposer à certaines activités de traitement ;
*  le **droit de retirer le consentement** : retirer à tout moment le consentement précédemment donné.

Les utilisateurs peuvent exercer leurs droits en contactant **privacy@spaarkly.com**. S’ils ne sont pas satisfaits de la réponse de Spaarkly, ils peuvent s’adresser à l’**Information Regulator of South Africa** ([https://inforegulator.org.za/](https://inforegulator.org.za/)).
...
*  **Spaarkly garantit que les données de session et de l’appareil sont anonymisées dans un délai de 14 mois**.
* Des **mesures techniques et organisationnelles** robustes sont mises en œuvre pour prévenir tout accès non autorisé, toute fuite de données ou tout usage abusif.
...
* l’**Information Regulator of South Africa**, lorsque le **POPIA** l’exige ;
* lorsque la loi l’exige, une **communication publique** sera publiée sur le site de Spaarkly ou par d’autres canaux appropriés.
...
*  **garantir que tout transfert de données est conforme à la Section 72 du POPIA**, qui exige une protection adéquate ;
*  **mettre en œuvre des Clauses Contractuelles Types (CCT)** ou d’autres mécanismes de transfert juridiquement reconnus, lorsque cela est nécessaire ;
*  **obtenir le consentement explicite de l’utilisateur** pour d’éventuels transferts transfrontaliers, si cela devenait une exigence légale.
...
*  le **droit d’accès** : demander un récapitulatif des données à caractère personnel traitées ;
*  le **droit de rectification** : demander la correction de données inexactes ou incomplètes ;
*  le **droit à l’effacement** : demander l’effacement des données à caractère personnel dans des conditions spécifiques ;
*  le **droit de limiter le traitement ou de s’y opposer** : s’opposer à certaines activités de traitement ;
*  le **droit de désigner un représentant** : désigner une autre personne pour exercer ses droits en cas de décès ou d’incapacité.
...
* En cas de **violation de données à caractère personnel**, Spaarkly notifiera :
  * le **Data Protection Board of India** et, comme l’exige le **DPDP**, les personnes concernées ;
  * ne disposant pas des coordonnées de contact des Utilisateurs, la communication aux personnes concernées sera effectuée au moyen d’une **communication publique** sur le site de Spaarkly et, lorsque cela est possible, d’un avis au sein du service, en tant que moyen disponible le plus efficace.
...
*  **garantir la conformité aux exigences du DPDP en matière de localisation et de transfert des données** ;
*  **mettre en œuvre des mécanismes de transfert juridiquement reconnus**, tels que des clauses contractuelles approuvées par le gouvernement ;
*  **obtenir le consentement explicite de l’utilisateur** pour d’éventuels transferts transfrontaliers, si cela devenait une exigence légale.
...
*  **Émirats arabes unis (UAE)** : **Federal Decree-Law No. 45 of 2021 on the Protection of Personal Data** ;
*  **Dubai International Financial Centre (DIFC)** : **DIFC Data Protection Law No. 5 of 2020** ;
*  **Arabie Saoudite** : **Personal Data Protection Law (PDPL)** ;
*  **autres réglementations nationales applicables en matière de vie privée**.
...
*  le **droit de rectification** : demander la correction de données inexactes ou incomplètes ;
*  le **droit à l’effacement** : demander l’effacement des données à caractère personnel dans des conditions spécifiques ;
*  le **droit d’opposition** : s’opposer à certains types de traitement ;
*  le **droit de retirer le consentement** : retirer à tout moment le consentement précédemment donné.
...
*  à l’**UAE Data Office** ;
*  au **DIFC Commissioner of Data Protection** (https://www.difc.ae/business/regulations/data-protection/) ;
*  à la **Saudi Data & Artificial Intelligence Authority (SDAIA)**, autorité compétente au titre de la Personal Data Protection Law (PDPL) saoudienne.
...
* En cas de **violation de données susceptible de causer des préjudices significatifs**, Spaarkly notifiera :
  * l’**autorité compétente du Moyen-Orient en matière de protection des données**, lorsque la loi locale l’exige ;
  * lorsque la loi l’exige, une **communication publique** sera publiée sur le site de Spaarkly ou par d’autres canaux appropriés.
*  **Dès lors que Spaarkly ne collecte pas les coordonnées de contact des utilisateurs, il n’est pas possible d’adresser des notifications individuelles**.
...
*  **garantir la conformité aux lois locales sur la protection des données en matière de transferts internationaux** ;
*  **mettre en œuvre des mécanismes de transfert juridiquement reconnus**, tels que des Clauses Contractuelles Types (CCT) ou des cadres approuvés par le gouvernement ;
*  **obtenir le consentement explicite de l’utilisateur** pour d’éventuels transferts transfrontaliers, si cela devenait une exigence légale.
...
*  d’**accéder à leurs données à caractère personnel** et d’en demander une copie ;
*  de **demander la correction** de données inexactes ou incomplètes ;
*  de **demander l’effacement** des données à caractère personnel dans des conditions spécifiques ;
*  de **s’opposer à certaines activités de traitement** ;
*  de **retirer leur consentement**, le cas échéant.
...
* Spaarkly garantit que les données de session et de l’appareil sont anonymisées dans un délai de **14 mois**, conformément aux meilleures pratiques.
* Des mesures techniques et organisationnelles rigoureuses sont mises en œuvre pour prévenir tout accès non autorisé, toute fuite de données ou tout usage abusif.

### Obligations de notification en cas de violation de données

En cas de violation de données susceptible de causer un préjudice significatif, Spaarkly notifiera :

* l’autorité compétente en matière de protection des données, lorsque la réglementation locale l’exige.
* Si la loi l’y oblige, elle publiera un avis public sur son site web ou par d’autres canaux appropriés.
...
* Garantir le respect des **lois locales sur la protection des données relatives aux transferts internationaux**.
* Mettre en œuvre des **mécanismes de transfert juridiquement reconnus**, tels que des **Clauses Contractuelles Types (CCT)** ou des cadres approuvés par le gouvernement.
* Obtenir le **consentement explicite des utilisateurs** pour d’éventuels transferts transfrontaliers, si cela devenait une obligation légale.

...
1.7 **"Privacy Policy"** refers to the ARShades Privacy Policy available at [https://spaarkly-srl.github.io/ARS_legal/privacy-policy/en/](https://spaarkly-srl.github.io/ARS_legal/privacy-policy/en/).
...
5.4 You agree not to:
   - copy, reproduce, distribute, modify, create derivative works from, publicly display or publicly perform any part of the Services or their Content;
   - decompile, disassemble, reverse engineer or otherwise attempt to discover the source code or underlying algorithms of the Services, except to the extent such restriction is prohibited by applicable law;
   - extract, download, scrape or copy the 3D Models or any other content displayed through the Services;
   - remove, circumvent or bypass any technological protection measures;
   - use the Services for any commercial purpose, including developing competing products or services.
...
7.2 You shall not:
   ...
   - use the Services in a way that violates the privacy or other rights of third parties;
   - attempt to gain unauthorised access to any part of the Services or to systems or networks connected to them.
